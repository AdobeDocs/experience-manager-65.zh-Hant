...
此功能會在時間軸上顯示資產的活動記錄。 如果您在[!DNL Adobe Experience Manager Assets]中執行下列任一資產相關作業，活動串流功能會更新時間軸以反映活動。
