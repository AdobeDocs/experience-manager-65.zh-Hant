...
|---|---|---|
| 創意用戶從 [!DNL Experience Manager]，開啟並使用它們，編輯和上載更改 [!DNL Experience Manager]，以及將新檔案上載到 [!DNL Experience Manager]，不離開 [!DNL Creative Cloud] 。 | [Adobe Asset Link](https://helpx.adobe.com/tw/enterprise/using/adobe-asset-link.html) | [!DNL Adobe Photoshop]、[!DNL Adobe Illustrator] 和 [!DNL Adobe InDesign]。 |
