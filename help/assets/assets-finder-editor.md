...
1. 選擇&#x200B;**Geometrixx Asset Editor**，然後按一下&#x200B;**Create**。 會建立新頁面，並在&#x200B;**Websites**&#x200B;標籤中列出該頁面。
...
若要自訂資產編輯器頁面，請使用sidekick中的元素。 從&#x200B;**Geometrixx Press Center**&#x200B;存取的「資產編輯器」頁面是以此範本為基礎的頁面自訂版本：
