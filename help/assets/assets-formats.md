...
| 格式 | 儲存 | 元資料管理 | 元資料提取 | 縮略圖生成 | 編輯 | 元資料寫回 | 分析 |
| ------------ | :------: | :-----------------: | :-----------------: | :------------------: | :------: | :----------------: | :------: |
| PNG | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| GIF | ✓ | ✓ | ✓ | ✓ | ✓ | - | ✓ |
| TIFF | ✓ | ✓ | ✓ | ✓ | - | ✓ | ✓ |
...
| 格式 | 儲存 | [元資料管理](metadata.md) | 全文<br> 提取 | [元資料提取](metadata.md) | 縮略圖<br> 代 | [子集提取](managing-linked-subassets.md) | [元資料寫回](xmp-writeback.md) | [連線資產](use-assets-across-connected-assets-instances.md) |
|---|---|---|---|---|---|---|---|---|
...
| EPS | <ul><li>應用程式/後指令碼</li><li>應用程式/eps</li><li>應用程式/x-eps</li><li>影像/eps</li><li>影像/x-eps</li></ul> |  |  |
