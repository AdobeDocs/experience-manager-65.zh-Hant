...
* Experience Manager也提供更進階的方式來調整影像品質，例如在擷取時套用銳利化影像。 若是進階使用案例，其中有多種選項可調整及最佳化演算結果，[Adobe Professional Services](https://business.adobe.com/tw/customers/consulting-services/main.html)可協助您使用自訂的insight及最佳實務。
