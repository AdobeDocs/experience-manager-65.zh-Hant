...
Adobe Scene7 Publishing System和Image Server中的 [影像銳利化最佳範例白皮書](/help/assets/assets/s7_sharpening_images.pdf) ，也適用於AEM。
...
* 銳利化遮色片( `&op_USM`)-銳利化遮色片是業界標準的銳利化濾鏡。 最佳實務是依照下列准則，使用銳利化遮色片銳利化影像。 遮色片銳利化可讓您控制下列三個參數：
   ...
   * `&op_sharpen=`金額，半徑，閾值
      ...
      * **[!UICONTROL 閾值]** （0-255，效果的敏感度。）
      ...
      最佳實務白皮 [書「在Adobe Scene7 Publishing System和Image Server上銳利化影像」](/help/assets/assets/s7_sharpening_images.pdf)。
...
### JPEG壓縮的最佳範例(`&qlt=`) {#best-practices-for-jpeg-compression-qlt}
