...
## Publish資料夾至Brand Portal {#publish-folders-to-brand-portal-1}

1. 在AEM Assets介面中，暫留在所需的資料夾上，並從快速動作中選取&#x200B;**Publish**&#x200B;選項。
...
1. **現在發佈資料夾**
   ...
   * 在工具列中選取&#x200B;**快速發佈**。然後從功能表中選取&#x200B;**Publish到Brand Portal**。

   * 在工具列中選取&#x200B;**管理出版物**。

   1. 從&#x200B;**動作**&#x200B;選取&#x200B;**Publish到Brand Portal**，從&#x200B;**排程**&#x200B;選取&#x200B;**立即**，然後按一下&#x200B;**下一步**
   ...
   **稍後發佈資料夾**
   ...
   1. 從&#x200B;**動作**&#x200B;選取&#x200B;**Publish到Brand Portal**，從&#x200B;**排程**&#x200B;選取&#x200B;**稍後**。
