...
>[!IMPORTANT]
>
>您可以使用Feature Pack以Experience Manager方式，自行將資產從Dynamic Media Classic移轉至Dynamic Media - Scene7模式。 您也可以使用Dynamic Media Classic的FTP功能大量移轉資產。 但是，Adobe *not*&#x200B;由於所涉的複雜性，建議您使用其中一種方法。
>
...
1. AdobeExperience Manager企業客戶服務提供您FTP憑證和Feature Pack 18912的存取權。
