...
1. 捲動至您需要變更的屬性，例如「色彩管理屬性」區 **[!UICONTROL 域中的屬性]** 。
   ...
   * **[!UICONTROL 顏色轉換渲染方式]** -指定渲染方式。 Acceptable values are: **[!UICONTROL perceptual]**, **[!UICONTROL relative colometric]**, **[!UICONTROL saturation]**, **[!UICONTROL absolute colometric.]** Adobe建議 **[!UICONTROL 以相對]]**為預設值。
...
1. 在AEM中，點選AEM標誌以存取全域導覽主控台，然後點選「工具>一般> CRXDE **[!UICONTROL Lite」。]**
