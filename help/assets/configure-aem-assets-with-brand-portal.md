...
下載AEM之後，如需設定AEM Author執行個體的指示，請參閱[部署和維護](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/implementing/deploying/deploying/deploy#default-local-install)。
