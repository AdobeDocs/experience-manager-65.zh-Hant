...
2. 其中之一：
   ...
   * 選擇&#x200B;[**查看屬性**&#x200B;以開啟對話框](/help/assets/manage-assets.md#editing-properties)。 開啟以供檢視後，您也可以編輯。
...
3. **Basic**&#x200B;頁簽提供了可查看或編輯的選項：
   ...
   * **說明**
   * **標記**
      * [](/help/sites-authoring/tags.md) 標籤在組織片段時特別強大，因為片段可用於內容分類和分類。標籤可用來尋找內容（依標籤）並套用大量作業。
