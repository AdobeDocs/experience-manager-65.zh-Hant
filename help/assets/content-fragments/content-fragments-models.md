...
1. **新增欄位的方式**
   ...
   * 將欄位新增至模型後，右側面板會顯示可針對該特定資料類型定義的&#x200B;**屬性**。 您可以在此定義該欄位的必要項目。
      ...
      * 鍵入&#x200B;**欄位標籤**&#x200B;將自動完成&#x200B;**屬性名稱** — 如果為空，然後可手動更新。
         ...
         >[!CAUTION]
         手動更新資料類型的屬性&#x200B;**屬性名稱**&#x200B;時，請注意名稱只能包含拉丁字元、數字和底線「_」作為特殊字元。
...
* **屬性名稱**
   ...
   手動更新資料類型的此屬性時，請注意名稱&#x200B;**必須**&#x200B;僅包含&#x200B;**&#x200B;拉丁字元、數字和底線「_」作為特殊字元。
...
>[!NOTE]
此機制類似於在頁面的進階屬性中允許頁面範本](/help/sites-authoring/templates.md#allowing-a-template-author)及其子項。[
