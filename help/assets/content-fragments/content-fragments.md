...
Adobe Experience Manager(AEM)內容片段可讓您設計、建立、組織及[發佈頁面無關的內容](/help/sites-authoring/content-fragments.md)。 它們可讓您準備內容，以便在多個位置／多個通道中使用。
...
>
>如需詳細資訊，請參閱](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/content-fragments/understand-content-fragments-and-experience-fragments.html)中的「瞭解內容片段和體AEM驗片段」。[
