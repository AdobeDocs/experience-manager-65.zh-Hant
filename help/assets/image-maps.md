...
1. 執行下列任一項作業以開啟就 **[!UICONTROL 地影像編輯器]**:
   ...
   * 使用快速動作，按一 **[!UICONTROL 下]** 「卡片」檢視中資產上顯示的「編 **[!UICONTROL 輯」圖示]** 。 在「清單」檢視中，選取資產，然後按一下工具列 **中的** 「編輯」圖示。

      >[!NOTE]
      >
      >「清單」檢視中不提供「快速 **[!UICONTROL 動作]** 」。

   * 在「資 **[!UICONTROL 訊卡]** 」或「清 **[!UICONTROL 單」檢視中，選取資產，然後按一下工具列上的]** 「編輯 **** 」圖示。
   * 按一下資 **[!UICONTROL 產頁面]** 中的「編輯」圖示。

      ![chlimage_1-420](assets/chlimage_1-420.png)

1. 若要插入影像地圖，請按一下工 **[!UICONTROL 具列中的「啟動地圖]** 」圖示。
...
1. 按一下「 **[!UICONTROL 確認]** 」圖示，然後按一下工具列中的「完成 **** 」圖示以儲存變更。

   ![chlimage_1-424](assets/chlimage_1-424.png)

   若要刪除影像地圖，請按一下作用點，然後按一下「刪 **[!UICONTROL 除]** 」圖示。
...
1. 若要檢視影像地圖，請導覽至資產詳細資料頁面，並將游標暫留在影像上。
   ...
   如果啟用「動態媒體」選項，請導覽至「資產」編輯器，然後按一下「 **[!UICONTROL Map]** 」圖示以檢視所有套用的影像地圖。
