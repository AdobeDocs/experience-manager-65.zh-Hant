...
1. 在Experience Manager作為Cloud Service時，點選「 **[!UICONTROL 工具>資產> CDN失效」。]**
...
| *輸入的URL無效。* | 如果&#x200B;**[!UICONTROL CDN失效 — 確認]**&#x200B;頁面中沒有URL，且您點選&#x200B;**[!UICONTROL 提交。]** |
