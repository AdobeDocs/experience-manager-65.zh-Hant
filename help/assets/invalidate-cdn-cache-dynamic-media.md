...
1. 在「 **[!UICONTROL CDN失效——確認]** 」頁面上，在「 **[!UICONTROL URL]** 」清單方塊中，您會看到一或多個由您先前建立的「CDN失效範本」產生的URL清單，以及您剛新增的資產。
...
| *未輸入任何URL，因此無效。* | 發生於「 **[!UICONTROL CDN失效——確認」頁面中沒有URL]** ，而您點選「送 **[!UICONTROL 出」。]** |
