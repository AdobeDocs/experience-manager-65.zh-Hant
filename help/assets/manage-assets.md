...
1. 若要檢視資產的使用情況統計資料，請按一下「 **[!UICONTROL 前瞻分析]** 」標籤。
   ...
   * 最近使用資產的創意解決方案
   ...
   如需詳細資訊，請參 [閱資產分析](/help/assets/asset-insights.md)。
...
>[!NOTE]
>
>在「系 [列」控制台](/help/assets/manage-collections.md#navigating-the-collections-console),「全 **[!UICONTROL 部顯示]** 」清單提供僅檢視注釋和工作流程的選項。 此外，時間軸只會針對控制台中列出的頂層系列顯示。 如果您在任何系列中導覽，則不會顯示它。
...
1. 執行下列任一項作業：
   ...
   * 若要列印特定的註解和檢閱狀態，請開啟 [時間軸](/help/assets/manage-assets.md#timeline) ，然後移至步驟3。
...
1. 使用 ![右上角的選項](assets/do-not-localize/download.png) ，下載PDF的「下 ![載」選項或在PDF](assets/do-not-localize/print.png) 上的PDF列印選項。
   ...
   要修改渲染的PDF檔案的外觀，例如注釋和狀態的字型顏色、大小和樣式、背景顏色，請從「配置管理器」(Configuration Manager)開啟「注釋 **[!UICONTROL PDF」(]** Annotation PDF)配置，並修改所需的選項。 例如，要更改批准狀態的顯示顏色，請修改相應欄位中的顏色代碼。 有關更改批注的字型顏色的資訊，請參 [閱注釋](/help/assets/manage-assets.md#annotating)。
...
如需系列 [管理的詳細資訊](/help/assets/manage-collections.md) ，請參閱「管理系列」。
