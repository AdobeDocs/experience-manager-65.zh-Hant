...
1. 將資產拖曳至「 **[!UICONTROL Drop in Collection]** 」區域。 或者，按一下工 **[!UICONTROL 具列中的]** 「至系列」圖示。
...
1. 在「資產」使用者介面中，選取資產，然後按一下工 **[!UICONTROL 具列中的「收集]** 」圖示。
...
1. 從「系列」控制台中，選取系列，然後從工具列按一 **[!UICONTROL 下]** 「屬性」圖示。
1. 在「系列 **[!UICONTROL 中繼資料]** 」頁面中，從「基本」和「進階」標籤檢視系 **[!UICONTROL 列中繼資]** 料 **** 。
1. 視需要修改中繼資料，然後按一下工 **[!UICONTROL 具列中的「儲存並關閉]** 」以儲存變更。
...
1. 從工 **[!UICONTROL 具列按一下「儲存並關閉]** 」，然後關閉確認對話方塊以完成程式。
...
1. 選取系列，然後按一下工具 **[!UICONTROL 列中的]** 「設定」圖示。 或者，從系列 **[!UICONTROL 縮圖]** ，使用「設定」快速動作。
...
1. 從「系列」控制台中，選取一或多個系列，然後按一下工具列中的刪除圖示。
...
1. In the dialog, click **[!UICONTROL Proceed]**. 工作流程會在系列中的所有資產上執行。
