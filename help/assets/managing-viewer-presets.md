...
您可以點選「**[!UICONTROL 工具]**（槌子圖示）> **[!UICONTROL 資產]** > **[!UICONTROL 檢視器預設集]**」，在AEM中新增、編輯、刪除、發佈、取消發佈和預覽檢視器預設集。
...
AEM從&#x200B;**[!UICONTROL Detail View]** > **[!UICONTROL Viewers]**&#x200B;檢視資產時，會顯示各種檢視器預設集。 您可以增加或減少顯示的檢視器數量。
...
不過，若要傳送&#x200B;*具有檢視器預設集的資產，檢視器預設集也必須發佈。*&#x200B;所有檢視器預設集都必須啟動&#x200B;*並發佈*，才能取得資產的URL或內嵌程式碼。 您必須啟動並發佈動態媒體隨附的所有現成可用的檢視器預設集。您建立和新增的自訂檢視器預設集會自動啟動，但也必須發佈。
...
1. 在Experience Manager的左上角，點選AEM標誌，然後在左側導軌中，點選「**[!UICONTROL Tools]**（槌子圖示）> **[!UICONTROL Asset]** > **[!UICONTROL Viewer Presets]**」。
