...
中繼資料是指與資料有關的資料。 就此而言，資料是指您的數位資產，例如影像。 中繼資料是進行高效率資產管理的關鍵所在。
...
更多中繼資料可協助您進一步將資產分類，並隨著數位資訊量成長，提供相關實用資訊。 您可以僅根據檔案名稱管理數百個檔案。 然而，此方法並不能調整規模。隨著相關人數和管理的資產數量增加，此方法尚嫌不足。
