...
1. [建立混合媒體集](#creating-mixed-media-sets)。
   ...
   若要建立混合媒體集，請從「資產」頁面中選取&#x200B;**[!UICONTROL 建立]** > **[!UICONTROL 混合媒體集]**，然後命名該集，選擇資產，然後選擇影像的顯示順序。
...
1. [預覽混合媒體集](#previewing-mixed-media-sets)。
   ...
   選取「混合媒體集」，即可預覽。 選取縮圖圖示，以便在選取的檢視器中檢查您的混合媒體集。 您可以從&#x200B;**[!UICONTROL 檢視器]**&#x200B;選單中選擇不同的檢視器，該選單可從左側導軌下拉式選單中取得。
...
1. 選取「資產選擇器」，以選取您要納入混合媒體集的資產。 選擇它們，然後選擇&#x200B;**[!UICONTROL Select]**。
...
1. 在混合媒體集編輯器中，執行下列任一操作：
   ...
   * 若要依資產名稱的遞增或遞減順序排序，請在左側面板中選取「**[!UICONTROL 資產]**」（圖示）。 在&#x200B;**[!UICONTROL Assets]**&#x200B;標題的右側，選取向上或向下插入號圖示。
      ...
      >[!NOTE]
      >
      >* 若要刪除整個混合媒體集，請從任何檢視模式（例如&#x200B;**[!UICONTROL 卡片檢視]**&#x200B;或&#x200B;**[!UICONTROL 欄檢視]**）導覽至混合媒體集。 將滑鼠指標暫留在資產上，並選取核取標籤圖示，以便您加以選取。 在鍵盤上按&#x200B;**[!UICONTROL Backspace]**，或在工具欄上選擇&#x200B;**[!UICONTROL More]**（三個點），然後選擇&#x200B;**[!UICONTROL Delete]**。
         >
         >
      * 您可以導覽至混合媒體集，然後按一下左側邊欄中的&#x200B;**[!UICONTROL 設定成員]**，以編輯混合媒體集中的資產。 選取個別資產上的&#x200B;**[!UICONTROL 鉛筆]**&#x200B;圖示，以便在編輯視窗中開啟它。
...
1. 完成編輯時，選擇&#x200B;**[!UICONTROL Save]**。
   ...
   >[!NOTE]
   >
   >* 若要編輯混合媒體集中的資產 — 導覽至混合媒體集。 點選（不要選取）設定，使其在「Experience Manager設定預覽」頁面中開啟。 在左側欄中，選取向下插入號以開啟下拉式清單，然後選取&#x200B;**[!UICONTROL 設定成員]**。 在「設定成員」頁面中，暫留在資產上，然後選取「**[!UICONTROL 編輯]**」（鉛筆圖示）以開啟編輯頁面。
      >
      >
   * 若要刪除整個混合媒體集 — 從任何檢視模式（例如卡片檢視或欄檢視），導覽至混合媒體集。 暫留在集合上，然後選取&#x200B;**選取**（勾選圖示）。 在鍵盤上按&#x200B;**[!UICONTROL Backspace]**，或選擇&#x200B;**[!UICONTROL More]**（三個點的列），然後選擇&#x200B;**[!UICONTROL Delete]**。
