...
如果您使用 [!DNL Experience Manager] 在Adobe托管服務(AMS)上，如果您計畫處理大量大型PSD或PSB檔案，請聯繫Adobe客戶支援。 與Adobe客戶支援代表合作，為您的AMS部署實施這些最佳做法，並為Adobe的專有格式選擇盡可能最佳的工具和型號。 [!DNL Experience Manager] 可能無法處理超過30000 x 23000像素的高解析度PSB檔案。
