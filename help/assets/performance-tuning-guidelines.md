...
>[!CAUTION]
>
>如果ImageMagick使用所有可用磁碟空間，錯誤配置可能會使伺服器不穩定。 使用ImageMagick處理大型檔案所需的策略更改可能會影響 [!DNL Experience Manager] 效能。 如需詳細資訊，請參 [閱安裝和設定ImageMagick](/help/assets/best-practices-for-imagemagick.md)。
