...
1. 選取即時副本資產或資料夾。 按一下 **[!UICONTROL 屬性]** （從工具列）。 或者，使用鍵盤快速鍵 `p`.
1. 按一下「 **[!UICONTROL 即時複製來源」]**。按一下 **[!UICONTROL 轉出]** （從工具列）。
...
1. 在此控制面板中，從即時複製資料夾選取即時複製資產。從工具列按一下所需的動作。可用的操作有 **[!UICONTROL 同步]**、重置 **[!UICONTROL 、]**&#x200B;掛起 ****&#x200B;和 ****&#x200B;分離。您可以對與所選來源資料夾處於即時關係的任何數量的即時副本資料夾中的任何資產快速啟動這些操作。
