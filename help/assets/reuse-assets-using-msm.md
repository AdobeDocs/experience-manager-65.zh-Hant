...
若要將MSM用於[!DNL Assets]，請至少安裝[!DNL Experience Manager] 6.5 Service Pack 1。 如需詳細資訊，請參閱[最新Service Pack](/help/release-notes/sp-release-notes.md)發行說明。
...
|---|---|---|
|  參考欄 | 已選擇源時，快速同步。 | 請參閱來源](#refrailsource)的「參考」邊欄的「快速動作」[ |
