...
資料夾層 **[!UICONTROL 級的「動態媒體發佈模式]** 」選項一律預設為「動態媒體設定」中的「發佈資產 **[!UICONTROL 」設定]** 中的值 ****。 但是，本主題中的下列步驟將顯示如何在資料夾級別手動更改此預設值（如以下步驟所述）以覆蓋 **** 動態媒體配置值。

無論您是依賴 **[!UICONTROL Dynamic Configuration]** 、 **[!UICONTROL Dynamic Publish mode]**&#x200B;級別中設定的 **[!UICONTROL Assets值，在資料夾級別中設定的]** Dynamic Publish mode值，您仍然能夠立即選擇AdimetEdiaProDimedia Oplisign Chost Pron Prod Prod Prosimed Ad Adobe Prosimed Propritys. Pros ************。 例如，您可以在啟動時將 **[!UICONTROL Dynamic Media Configuration中的]** Publish **[!UICONTROL Assets值設為]** Opin Activation **[!UICONTROL ，但是在資料夾層級將]********** Dynamic Media PublishMode值設為Oracle Selective Publish Applizing，反之亦然，依此類推。
...
|同步模式 |說明 |
| — | — |
|繼承 **[!UICONTROL 的]** |資料夾上沒有明確的同步值；而是會從其上級資料夾或動態媒體配置中設定的預設模式繼承同步 **[!UICONTROL 值]**。 「繼承」的詳 **[!UICONTROL 細狀態]** ，通過工具提示顯示。 |
|將 **[!UICONTROL 此資料夾子樹中的所有內容同步到動態媒體]** |若要發佈至動態媒體，資產必須同步至動態媒體。 選取此選項，會在此子樹狀結構中包含所有資產，以同步至動態媒體。 資料夾特定設定會覆寫動態媒體設定中的 **[!UICONTROL 預設設定]**。 |
|從 **[!UICONTROL 動態媒體同步中排除此資料夾子樹中的所有內容]** |排除此子樹狀結構中的所有資產，使其無法同步至動態媒體。 |
...
|動作 |說明 |
| — | — |
|發 **[!UICONTROL 布]** （至AEM） |選取這個選項，將資產發佈至AEM以進行安全預覽。 |
|發 **[!UICONTROL 布至動態媒體]** |選取此選項，將資產發佈至動態媒體，以便在公用網域中傳送，或者您可以使用智慧型裁切或動態轉譯等功能。<br>只有在資料夾屬性中 **[!UICONTROL 的「動態媒體發佈]** 」模式設定為「 **[!UICONTROL 選擇性發佈]** 」時，此選項才可用。 |
1. 在「 **[!UICONTROL 排程]**」下方，設定發佈的時間。
|排程 |說明 |
| — | — |
|立 **[!UICONTROL 即]** |選擇立即發佈資產。 |
|稍後 **[!UICONTROL 版本]** |選擇以在特定日期和時間發佈資產。 |
...
|動作 |說明 |
| — | — |
|取 **[!UICONTROL 消發佈]** （從AEM） |選取這個選項，從AEM取消發佈資產。 |
|從 **[!UICONTROL 動態媒體取消發佈]** |選取此選項，從動態媒體取消發佈資產。<br>只有在資料夾屬性中 **[!UICONTROL 的「動態媒體發佈]** 」模式設定為「 **[!UICONTROL 選擇性發佈]** 」時，此選項才可用。  |
1. 在「 **[!UICONTROL 排程]**」下，設定取消啟動的時間。
|排程 |說明 |
| — | — |
|立 **[!UICONTROL 即]** |選擇以立即取消發佈資產。 |
|稍後 **[!UICONTROL 版本]** |選擇以取消發佈特定日期和時間的資產。 |
1. 在「管理出版物」頁面的右上 **[!UICONTROL 角]** ，點選「下 **[!UICONTROL 一步」]**。
1. 在「管 **[!UICONTROL 理出版物——範圍]** 」頁中，執行下列任一操作：
   * 選取一或多個要從取消發佈移除的資產。
   * 在「管理出版物——範圍」頁面的右上 **[!UICONTROL 角，點選「從動態媒體取消發佈]****[!UICONTROL 」或「取]** 消發佈」 ****。
1. 點選「 **[!UICONTROL 確定]**」。
...
|快速發佈選項 |它的功能 |
| — | — |
|發佈至AEM |將選取的資產立即發佈至AEM。 |
|發佈至品牌入口網站 |將選取的資產立即發佈至 **[!UICONTROL 品牌入口網站]**。<br>只有在您的AEM Assets例項已設定品牌入口網站時， **[!UICONTROL 才能使用此選項]** 。 |
|發佈至動態媒體 |將選取的資產立即發佈至動態媒體。<br>資產必須已同步至動態媒體。 如有必要，請確定 **[!UICONTROL 資料夾屬性中的「同步模式]** 」已設定為「將此資料夾子樹中的所有內容同步到動態媒體」 ****。 |
1. 點選「 **[!UICONTROL 確定]**」，然後點 **[!UICONTROL 選「關閉」]**。
...
1. 在「管理出版物——選項」頁面的右上 **[!UICONTROL 角，點選]** 「下一 **[!UICONTROL 步」]**。
