...
1. 在 **[!UICONTROL 同步模式]** 從下拉式清單中選取下列其中一項：
   ...
   | 同步模式 | 說明 |
   | --- | --- |
   | **[!UICONTROL 已繼承]** | 資料夾上沒有明確的同步值；而是會繼承其父資料夾之一的同步值，或是中設定的預設模式。 **[!UICONTROL Dynamic Media設定]**. 的詳細狀態 **[!UICONTROL 已繼承]** 以工具提示的方式顯示。 |
...
1. 在 **[!UICONTROL Dynamic Media發佈模式]** 從下拉式清單中選取一個選項。 此 **[!UICONTROL Dynamic Media發佈模式]** 選項一律預設為在中設定的值 **[!UICONTROL Dynamic Media設定]**. 不過，您可以手動覆寫此預設值 **[!UICONTROL Dynamic Media設定]** 使用下列其中一個選項來獲得value。
   ...
   | **[!UICONTROL 啟動時]** | 將資產上傳至此資料夾時，您必須先明確發佈資產，才能提供URL/內嵌連結。 此選項僅與Experience Manager發佈繫結。<br>此選項為 *not* 若您選取，則可用 **[!UICONTROL 從Dynamic Media同步處理中排除此資料夾子樹狀結構中的所有專案]** 在 **[!UICONTROL 同步模式]** 在上一步中。 |
   | **[!UICONTROL 選擇性發佈]** | 資產會發佈至您選擇的Experience Manager或Dynamic Media，以便在公共網域中傳送。 這兩種發佈方法彼此互斥。 也就是說，您可以將資產發佈至DMS7，以使用智慧型裁切或動態轉譯等功能。 或者，您也可以將資產獨家發佈到Experience Manager以進行安全預覽；這些相同的資產為 *not* 發佈至DMS7以在公共網域中傳送。 如果您選取「 」，則無法使用此選項 **[!UICONTROL 從Dynamic Media同步處理中排除此資料夾子樹狀結構中的所有專案]** 在 **[!UICONTROL 同步模式]** 在上一步中。 |
...
1. 在 **[!UICONTROL 管理發布 — 選項]** 頁面，底下 **[!UICONTROL 動作]**，選取您想要的啟動型別。
   ...
   | **[!UICONTROL 發佈至 Dynamic Media]** | 選取此選項，您就可以將資產發佈到Dynamic Media以在公共網域中傳送，或者也可以使用智慧型裁切或動態轉譯等功能。<br>此選項僅在以下情況下可用： **[!UICONTROL Dynamic Media發佈模式]** 設為 **[!UICONTROL 選擇性發佈]** 在資料夾的屬性中。 |
...
1. 下 **[!UICONTROL 排程]**，設定發佈時間。
   ...
   | **[!UICONTROL 稍後]** | 選取此選項可在特定日期和時間發佈資產。 |
...
1. 在 **[!UICONTROL 管理發布 — 選項]** 頁面，底下 **[!UICONTROL 動作]**，選取您想要的停用型別。
   ...
   | **[!UICONTROL 從 Dynamic Media 取消發佈]** | 如果要從Dynamic Media取消發佈資產，請選取此選項。<br>此選項僅在以下情況下可用： **[!UICONTROL Dynamic Media發佈模式]** 設為 **[!UICONTROL 選擇性發佈]** 在資料夾的屬性中。 |
...
1. 下 **[!UICONTROL 排程]**，設定停用的時間。
   ...
   | **[!UICONTROL 稍後]** | 選取此選項可在特定日期和時間取消發佈資產。 |
...
1. 從下列選項中選取一個： **[!UICONTROL 快速發佈]** 功能表清單。
   ...
   | 發佈至 Brand Portal 網站 | 立即將選取的資產發佈至 **[!UICONTROL Brand Portal]**.<br>只有在您的Experience Manager Assets執行個體具備以下條件時，才能使用此選項 **[!UICONTROL Brand Portal]** 已設定。 |
   | 發佈至 Dynamic Media | 立即將選取的資產發佈至Dynamic Media。<br>資產必須同步至Dynamic Media。 如有必要，請確定 **[!UICONTROL 同步模式]** 在資料夾中，屬性已設為 **[!UICONTROL 將此資料夾子樹狀結構中的所有專案同步至Dynamic Media]**. |
...
1. 於 **[!UICONTROL 管理發布 — 選項]** 頁面中，選取所需的動作。
   ...
   | 從 Dynamic Media 取消發佈 | 立即或啟動時 | 不會從Experience Manager或Dynamic Media取消發佈，或兩者同時取消發佈。 |
...
1. （選用）在 **[!UICONTROL 管理發布 — 範圍]** 頁面，檢閱 **[!UICONTROL 發佈目標]** 欄中選取的資產。
   ...
   | Dynamic Media設定中的發佈資產設定 | 選取的動作 | 發佈目標 |
   | --- | --- | --- |
