---
title: 迴轉集
description: 瞭解如何在Dynamic Media中建立迴轉集，以模擬實際轉動物件的動作，進而從任何角度檢視物件，讓您檢視詳細資訊。
...
迴轉集可模擬360度的觀賞體驗。 Dynamic Media提供單軸迴轉集，檢視器可在此旋轉專案。 此外，使用者只要按幾下滑鼠即可隨意縮放及平移任何檢視。 如此一來，使用者可以從特定觀點更密切地檢查專案。
...
本節說明如何在Experience Manager中建立迴轉集。
