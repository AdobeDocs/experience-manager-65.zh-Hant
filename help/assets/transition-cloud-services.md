...
[!DNL Adobe Experience Manager] 允許您使用您選擇的翻譯提供商提供的基於雲的翻譯服務，以確保根據您的要求翻譯您的資產。
...
1. 在工具欄中，按一下 **[!UICONTROL 屬性]** 顯示 **[!UICONTROL 資料夾屬性]** 的子菜單。
...
1. 從包管理器安裝連接器。
1. 按一下 [!DNL Experience Manager] 標識，並導航到 **[!UICONTROL 工具]** > **[!UICONTROL 部署]** > **[!UICONTROL Cloud Services]**。
