...
# 在網頁{#using-page-tracker-and-embed-code-in-web-pages}中使用頁面追蹤器和內嵌程式碼

頁面追蹤器是一段JavaScript程式碼，您會加入協力廠商網站的程式碼中，以讓Adobe Analytics擷取這些網站上[!DNL Adobe Experience Manager Assets]周圍的使用資料。
