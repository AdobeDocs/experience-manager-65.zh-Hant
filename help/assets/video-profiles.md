...
視訊智慧型裁切功能（視訊描述檔提供的選用功能）是運用Adobe AI中人工智慧的強大功能。 它會自動偵測並裁切您上傳之任何最適化視訊或漸進式視訊中的焦點，無論大小。
...
Adobe AI限製為9000個畫面。 也就是說，30 FPS時需要5分鐘。 如果您的視訊具有較高的FPS，則支援的最大視訊持續時間會減少。 例如，60 FPS視訊必須長達兩分半鐘，Adobe AI和智慧型裁切才會支援。
