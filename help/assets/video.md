...
另請參閱[關於動態媒體- Scene7模式](/help/assets/video.md#about-video-thumbnails-in-dynamic-media-scene-mode)中的視訊縮圖。
...
1. 在CRXDE Lite頁面的左上角附近，點選&#x200B;**[!UICONTROL 「全部儲存」，然後點選左上角的「上一頁」圖示以返回AEM。]**
