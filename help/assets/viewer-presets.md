...
如果您是管理員，需要管理、建立、排序和刪除查看器預設集，請參閱[管理查看器預設集](managing-viewer-presets.md)。

另請參閱[發佈檢視器預設集](managing-viewer-presets.md#publishing-viewer-presets)。

根據您使用的發佈模式，您可能不需要發佈檢視器預設集。
查看器預設集的任何問題，請參閱[疑難排解Dynamic Media - Scene7](troubleshoot-dms7.md#viewers)。
...
1. 從左窗格選取檢視器，將其套用至資產，如右窗格所示。 您也可以[複製URL以與其他使用者共用](linking-urls-to-yourwebapplication.md)。
