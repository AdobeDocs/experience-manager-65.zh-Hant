...
>[!NOTE]
>
> 當您使用公司Proxy伺服器時，請在[!UICONTROL Apache HTTP元件Proxy設定PID]中加入[!DNL workfront]，以便[!UICONTROL 增強型Workfront聯結器]識別它。 必要的PID格式為： `org.apache.http.proxyconfigurator~workfront`。
