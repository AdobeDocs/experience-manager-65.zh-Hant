...
| 功能 | 說明 | [!DNL Workfront] 和 [!DNL Assets Essentials] | [!DNL Workfront for Experience Manager enhanced connector] |
|----|----|----|-----|
...
| 在Workfront中自動建立連結的AEM資料夾 | 使用物件狀態在Workfront中自動建立連結的AEM資料夾。 根據WorkfrontPortfolio、方案和專案自動組織AEM資料夾。 | 否 | ✓ |
...
| 在Workfront中自動建立檔案自訂Forms | 使用AEM工作流程將自訂表單附加至Workfront檔案、工作和問題。 | 否 | ✓ |
...
| AEM中繼資料更新為新版本 | 可進行AEM中的設定，以判斷Workfront中新版本的資產是否也會隨對其中繼資料所做的任何變更推送。 | 否 | ✓ |
...
| 在Workfront物件上設定狀態 | 使用AEM工作流程，根據可設定條件設定Workfront物件狀態 | 否 | ✓ |
| 將資產發佈至AEM發佈環境或Brand Portal | 為Workfront使用者提供自動將連結資產發佈至AEM發佈環境或Brand Portal的選項。 | 否 | ✓ |
