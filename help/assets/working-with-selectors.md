...
1. 選取&#x200B;**[!UICONTROL 產品選取器]**&#x200B;圖示（放大鏡），並導覽至目錄中的產品。
   ...
   選擇&#x200B;**[!UICONTROL 排序依據]**&#x200B;以更改Experience Manager按最新到最舊或最舊到最新排序。
...
1. 在&#x200B;**[!UICONTROL 預覽]**&#x200B;模式中，您可以選取熱點或影像地圖，並查看快速檢視的外觀。
...
1. 選取&#x200B;**[!UICONTROL 網站選取器]**&#x200B;圖示（含放大鏡的資料夾），並導覽至您Experience Manager網站中要連結熱點或影像地圖的頁面。
...
1. 在&#x200B;**[!UICONTROL 預覽]**&#x200B;模式中，如果選擇熱點或影像映射，則導航到指定的Experience Manager網站頁。
