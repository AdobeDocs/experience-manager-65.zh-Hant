---
title: 電子商務概觀
description: AEM一般電子商務是作為標準安裝的一部分提供，為您提供電子商務架構的完整功能。
...
| 可用性 | 是：<br> - SAP Commerce Cloud (擴充功能已更新，以支援AEM 6.4和Hybris 5 （預設），並保持與Hybris 4 <br>- Salesforce Commerce Cloud的相容性（聯結器開放來源以支援AEM 6.4） | 是，透過GitHub的開放原始碼。<br> Adobe Commerce (支援2.3.2 （預設）並與2.3.1相容)。 |
| 使用時機 | 有限的使用案例：針對小型案例，視需要匯入靜態目錄 | 大部分使用案例中偏好的解決方案 |


## 部署其他實作 {#deploying-other-implementations}

若為AEM和Adobe Commerce，請參閱[&#128279;](/help/commerce/cif/integrating/magento.md)使用[AEM](/help/commerce/cif/introduction.md)的Adobe Commerce和Commerce integration framework整合。
