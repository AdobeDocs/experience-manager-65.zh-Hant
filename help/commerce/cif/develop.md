...
>[!NOTE]
>
>下列指示可協助您使用適用於AEM 6.5的CIF，設定AEM Commerce的本機AEM開發環境)。 如果您使用AEM as a Cloud Service，請參閱[AEM Commerce as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html?lang=zh-Hant)檔案。
