---
title: 《 2019AEM年內容與商業發佈說明》
description: 《 2019AEM年內容與商業發佈說明》
...
* GraphQL查詢定制簡化。 這使開發人員能夠用較少的代碼定制CIF核心元件。
...
* 基於React的客戶端結帳和Mini Cart，使用GraphQL支援完整的基本購物之旅。
...
* 多儲存/站點功能，允許在多個站點結構上使用CIF核心元件AEM，並使基礎的GraphQL客戶端實現能夠連接到不同的Adobe Commerce儲存/儲存視圖。

* GraphQL快取通過HTTPGET為某些GraphQL查詢啟用，以縮短響應時間。
