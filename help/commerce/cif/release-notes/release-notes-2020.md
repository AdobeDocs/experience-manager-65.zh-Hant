...
* 擴充產品詳細資料和產品清單頁面，以自動填入從Adobe Commerce管理員UI中設定的SEO中繼資料（例如標題、中繼說明、中繼關鍵字）
...
* 開發人員可以設定產品轉盤、相關產品和精選類別清單元件的HTML標籤，以遵循SEO最佳作法。
...
* 支援Adobe Commerce 2.3.5結構的查詢。

* 「搜尋頁面」和「產品清單頁面」新增了「分面搜尋」支援，可讓購物者根據「產品刻面」來篩選搜尋結果。

* 新增OSGi服務，針對SEO目的自訂PDP/PLP URL。 如需詳細資訊，請參閱 [檔案](https://github.com/adobe/aem-core-cif-components/wiki/configuration).
