---
title: AEM內容與Commerce 2023年發行說明
description: Adobe Experience Manager內容和Commerce 2023年發行說明。
...
| 元件 | 版本 | 詳細資訊 |
|:-------|:-------:|-----------------------------------------------------------------------------------------------------------:|
| CIF 核心元件 | 2.12.4 | [GitHub](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-2.12.4) |
...
| 元件 | 版本 | 詳細資訊 |
|:-------|:-------:|--------------------------------------------------------------------------------------------------------------:|
| CIF 核心元件 | 2.12.2 | [GitHub](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-2.12.2) |
