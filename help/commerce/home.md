...
description: 瞭解如何使用和管AEM理內容和商業，以及我們有關整合和如何開始使用Storefront的有益文AEM章。
...
瞭解如何使用和管AEM理內容和商業，以及我們有關整合和如何開始使用Storefront的有益文AEM章。

>[!NOTE]
>
>有AEM關具有as a Cloud Service的內AEM容和商業 [內AEM容和商務](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html)。

## 主要商業條目 {#key-articles}

* [商AEM務](/help/commerce/cif/introduction.md)
...
| [螢幕使用手冊](https://experienceleague.adobe.com/docs/experience-manager-screens/user-guide/aem-screens-introduction.html) | 瞭解數字標牌解決方案，以發佈動態和互動式數字型驗。 |
