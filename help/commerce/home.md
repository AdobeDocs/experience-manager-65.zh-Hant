...
description: 瞭解如何使用及管理AEM內容與商務，包含我們有關整合的實用文章，以及如何開始使用AEM Storefront。
...
瞭解如何使用及管理AEM內容與商務，包含我們有關整合的實用文章，以及如何開始使用AEM Storefront。

>[!NOTE]
>
>如需使用AEMas a Cloud Service的AEM內容與商務，請參閱 [AEM內容與商務](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html).

## 商業重要文章 {#key-articles}

* [AEM Commerce簡介](/help/commerce/cif/introduction.md)
