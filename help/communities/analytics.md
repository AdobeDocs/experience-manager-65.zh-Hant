...
`Marketing Cloud Org Id`可在[社區站點建立](/help/communities/sites-console.md#enablement)時或更後通過[修改](/help/communities/sites-console.md#modifying-site-properties)社區站點屬性來輸入。
