...
自AEM 6.3起，金鑰資料會儲存在檔案系統中，不再儲存在存放庫中。
...
>[!CAUTION]
>
>如果已設定了另一個以加密金鑰為基礎的安全性功能，則複製加密金鑰可能會損壞設定。 如需協助， [聯絡客戶服務](https://helpx.adobe.com/tw/marketing-cloud/contact-support.html).
