...
* 安裝最新的[AEM 6.5 Updates](#aem64updates)。
...
預設情況下，`AEM Communities Publisher Configuration` OSGi配置配置選中了&#x200B;**`Primary Publisher`**&#x200B;複選框，這樣發佈群中的所有發佈實例都將自標識為主實例。
...
* 在作者上訪問複製控制台
   ...
   * 從全域導覽：**工具、部署、複製、Agent on author**
...
例如，
   ...
   * 貼上先前複製的2個檔案
   * 如果目標AEM實例當前正在運行，則必須[刷新Granite Crypto bundle](#refresh-the-granite-crypto-bundle)。
