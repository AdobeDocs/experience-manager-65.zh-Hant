...
+ 安裝及設定AEM Forms {#install-aem-forms}
   ...
   + 在JEE上安裝AEM Forms {#jee-installation}
      ...
      + [在JEE上使用JBoss整套工具安裝和部署AEM Forms](https://www.adobe.com/go/learn_aemforms_installTurnkey_65)
      ...
      + [在JEE for WebSphere上安裝和部署Adobe Experience Manager表單](https://www.adobe.com/go/learn_aemforms_installWebSphere_65)
   ...
   + 設定 AEM Forms {#configure-aem-forms}
      ...
      + [配置Microsoft SharePoint的連接器](https://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
...
+ 升級AEM Forms {#upgrade-aem-forms}
   ...
   + 在JEE上升級AEM Forms {#aem-forms-jee-upgrade}
      ...
      + [Adobe Experience Manager Forms on JEE升級檢查清單與規劃](https://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
      + [升級至JEE版AEM 6.5表單](using/upgrade-forms-jee.md)
      + [升級至JEE上的Adobe Experience Manager Forms for JBoss](https://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [升級至JEE上的AEM Forms，以便使用JBoss Tunkly](https://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [升級至Adobe Experience Manager Forms on JEE for WebSphere](https://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
      + [升級至JEE上的Adobe Experience Manager Forms for WebLogic](https://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [設計人員指令碼基本知識](https://www.adobe.com/go/learn_aemforms_scriptingBasics_65)
...
+ JEE版AEM Forms的管理員說明 {#administrator-help}
   ...
   + 管理端點 {#manage-endpoints}
      ...
      + [配置oAuth2.0驗證](/help/forms/using/oauth2-support-for-mail-service.md)
...
+ 疑難排解 {#troubleshooting}
   ...
   + [無法在Google Chrome、Firefox、Microsoft Edge、Microsoft Internet Explorer或Apple Safari中開啟以XFA為基礎的PDF forms](/help/forms/using/xfa-based-forms-in-chrome-firefox-ie-internet-explorter-safari-edge.md)
   + [無法還原CRX儲存庫](/help/forms/using/restore-crx-repository.md)
   + [安裝AEM 6.5.15.0 Service Pack後，服務無法使用錯誤](/help/forms/using/aem-service-pack-installation-solution.md)
   + [AEM Forms JEE 6.5.15.0 Service Pack在JBoss Linux環境上安裝問題](/help/forms/using/linux-jboss-installation-issue-on-sp15.md)
