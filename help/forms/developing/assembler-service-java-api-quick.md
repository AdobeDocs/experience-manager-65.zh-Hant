---
title: 組合器服務Java&amp；trade； API QuickStart(SOAP)
description: 瞭解如何使用組合器服務Java&amp；trade； API QuickStart (SOAP)組合、分解及動態建立PDF檔案。
contentOwner: admin
...
[快速入門(SOAP模式)：使用Java API彙編加密的PDF檔案](assembler-service-java-api-quick.md#quick-start-soap-mode-assembling-an-encrypted-pdf-document-using-the-java-api)
...
下列Java程式碼範例將兩個名為&#x200B;*map.pdf*&#x200B;和&#x200B;*directions.pdf*&#x200B;的PDF來原始檔合併為單一PDF檔案。 單一PDF檔案的名稱為&#x200B;*AssemblerResultPDF.pdf*。 DDX檔案的名稱為&#x200B;*shell.xml*。 (請參閱[以程式設計方式組合PDF檔案](/help/forms/developing/assembling-pdf-documents.md#programmatically-assembling-pdf-documents)。)
...
以下Java程式碼範例將名為&#x200B;*AssemblerResultPDF.pdf*&#x200B;的PDF檔案拆解。 請注意，DDX檔案的名稱為&#x200B;*shell_disassemble.xml*。 每個已拆解的PDF檔案都命名為`ResultPDF[Number].pdf`。 亦即，第一個拆解的PDF檔名為&#x200B;*ResultPDF1.pdf。*&#x200B;如需此程式碼範例中使用之&#x200B;*shell_disassemble.xml* DDX檔案的相關資訊，請參閱[以程式設計方式解組PDF檔案](/help/forms/developing/assembling-pdf-documents.md#programmatically-disassembling-pdf-documents)。
...
## 快速入門(SOAP模式)：使用Java API彙編加密的PDF檔案 {#quick-start-soap-mode-assembling-an-encrypted-pdf-document-using-the-java-api}
...
下列Java程式碼範例會判斷輸入PDF檔案是否符合PDF/A規範。 傳遞至Assembler服務的輸入PDF檔名為&#x200B;*Loan.pdf*。 DDX檔案的名稱為shell_PDFA.xml。 從Assembler服務傳回並指定輸入PDF檔案是否符合PDF/A標準的XML檔案，會儲存為名為result.xml的XML檔案。 如需此程式碼範例中所使用&#x200B;*shell_PDFA.xml* DDX檔案的相關資訊，請參閱[判斷檔案是否符合PDF/A — 規範](/help/forms/developing/assembling-pdf-documents.md#determining-whether-documents-are-pdf-a-compliant)。
...
以下Java程式碼範例會組合包含書籤的PDF檔案。 DDX檔案的名稱為&#x200B;*bookmarkDDX.xml*。 書籤XML檔案的名稱描述要新增至PDF檔案的書籤，其名稱為bookmarks.xml。 結果PDF檔案會儲存為名為AssemblerResultBookmarks.pdf的PDF檔案。 (請參閱[組合含書籤的PDF檔案](/help/forms/developing/assembling-pdf-documents.md#assembling-pdf-documents-with-bookmarks)。)
...
下列Java程式碼範例會動態建立可解散PDF檔案的DDX檔案。 會針對輸入PDF檔案中的每個1級書籤建立新的PDF檔案。 此程式碼範例包含兩個使用者定義的方法：
...
以下Java程式碼範例會建立PDF投資組合。 PDF產品組合已儲存為名為&#x200B;*AssemblerResultPortfolio.pdf*&#x200B;的PDF檔案。 (請參閱[組裝PDFPortfolio](/help/forms/developing/assembling-pdf-documents.md#assembling-pdf-portfolios)。)
...
>[!NOTE]
>
>`PDFUtility`只能編輯那些使用Acrobat標示為要編輯的PDF。
