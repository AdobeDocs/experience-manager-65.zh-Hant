...
seo-title: Distiller Service Java API快速入門(SOAP)
description: Distiller Service Java API快速入門(SOAP)
...
以下代碼示例將名為&#x200B;*Loan.ps*&#x200B;的PostScript檔案轉換為名為&#x200B;*Loan.pdf*&#x200B;的PDF檔案。 （請參閱[將PostScript轉換為PDF文檔](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents)。）
