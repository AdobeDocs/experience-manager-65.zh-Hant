...
下列程式碼範例會轉換名為 *Loan.ps* PDF檔案，稱為 *Loan.pdf*. (請參閱 [將PostScript轉換為PDF文檔](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents).)
