...
下列程式碼範例會將名為 *Loan.ps* 的PostScript檔案轉換為名 *為Loan.pdf的PDF檔案*。 (請參 [閱將PostScript轉換為PDF檔案](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents))。
