...
seo-title: 檔案安全性服務JavaAPI快速入門(SOAP)
description: 檔案安全性服務JavaAPI快速入門(SOAP)
...
# 文檔安全服務Java API快速入門(SOAP){#document-security-service-javaapi-quick-start-soap}
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-creating-a-policy-using-the-java-api}建立策略

以下Java代碼示例建立名為&#x200B;*允許複製*&#x200B;的新策略。 添加策略的策略集名為&#x200B;*全局策略集*。 預設存在此策略集。 （請參閱[建立策略](/help/forms/developing/protecting-documents-policies.md#creating-policies)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-modifying-a-policy-using-the-java-api}修改策略

以下Java代碼示例通過將離線租用期設定為40天來修改名為&#x200B;*允許複製*&#x200B;的策略。 （請參閱[修改策略](/help/forms/developing/protecting-documents-policies.md#modifying-policies)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-deleting-a-policy-using-the-java-api}刪除策略

以下Java代碼示例刪除名為&#x200B;*允許複製*&#x200B;的策略。 （請參閱[刪除策略](/help/forms/developing/protecting-documents-policies.md#deleting-policies)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-applying-a-policy-to-a-pdf-document-using-the-java-api}將策略應用到PDF文檔

以下Java代碼示例將名為&#x200B;*允許複製*&#x200B;的策略應用到名為&#x200B;*Loan.pdf*&#x200B;的PDF文檔。 添加策略的策略集名為&#x200B;*全局策略集*。 受策略保護的文檔將另存為名為*PolicyProtectedLoanDoc.pdf的PDF檔案。 *（請參閱[將原則套用至PDF檔案](/help/forms/developing/protecting-documents-policies.md#applying-policies-to-pdf-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-removing-a-policy-from-a-pdf-document-using-the-java-api}從PDF文檔中刪除策略

以下代碼示例從名為&#x200B;*PolicyProtectedLoanDoc.pdf*&#x200B;的PDF文檔中刪除策略。 無抵押的PDF檔案會儲存為&#x200B;*unProtectedLoan.pdf*。 （請參閱[從PDF文檔中刪除策略](/help/forms/developing/protecting-documents-policies.md#removing-policies-from-pdf-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-revoking-a-document-using-the-java-api}撤消文檔

以下Java代碼示例撤消名為&#x200B;*PolicyProtectedLoanDoc.pdf*&#x200B;的受策略保護的文檔。 修訂的PDF文檔位於以下URL位置`https://'[server]:[port]'/RightsManagement/UpdatedLoan.pdf`。 （請參閱[撤消對文檔的訪問](/help/forms/developing/protecting-documents-policies.md#revoking-access-to-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-inspecting-policy-protected-pdf-documents-using-the-java-api}檢查受原則保護的PDF文檔

以下Java代碼示例檢查名為&#x200B;*PolicyProtectedLoanDoc.pd* f的受策略保護的PDF文檔。（請參閱[檢查受原則保護的PDF文檔](/help/forms/developing/protecting-documents-policies.md#inspecting-policy-protected-pdf-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-reinstating-access-to-a-revoked-document-using-the-java-api}恢復對已撤銷文檔的訪問

以下Java代碼示例重新將對名為&#x200B;*PolicyProtectedLoanDoc.pdf*&#x200B;的已撤銷PDF文檔的訪問權重置為。 （請參閱[恢復對已撤銷文檔的訪問](/help/forms/developing/protecting-documents-policies.md#reinstating-access-to-revoked-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-creating-a-pdf-watermark-using-the-java-api}建立PDF浮水印

以下Java代碼示例將建立名為「示例PDF水印」的新PDF水印。 此水印包含單個元素（請參閱[建立水印](/help/forms/developing/protecting-documents-policies.md#creating-watermarks)）。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-creating-a-text-watermark-using-the-java-api}建立文本水印

以下Java代碼示例將建立名為&#x200B;*示例文本水印*&#x200B;的新文本水印。 此浮水印包含單一元素。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-modifying-a-text-watermark-using-the-java-api}修改文本水印
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-modifying-a-watermark-using-the-java-api}修改水印

以下Java代碼示例修改名為&#x200B;*Conditial*&#x200B;的水印，方法是將`opacity`屬性的值修改為80。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-searching-for-events-using-the-java-api}搜索事件
...
## 快速入門(SOAP):使用Java API {#quick-start-soap-applying-a-policy-to-a-word-document-using-the-java-api}將策略應用到Word文檔

以下Java代碼示例將名為&#x200B;*允許複製*&#x200B;的策略應用到名為&#x200B;*Loan.doc*&#x200B;的Word文檔。 添加策略的策略集名為&#x200B;*全局策略集*。 受策略保護的文檔將另存為名為*PolicyProtectedLoanDoc.doc的DOC檔案。 *（請參閱[將原則套用至PDF檔案](/help/forms/developing/protecting-documents-policies.md#applying-policies-to-pdf-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-removing-a-policy-from-a-word-document-using-the-java-api}從Word文檔中刪除策略

下面的代碼示例從名為&#x200B;*PolicyProtectedLoanDoc.doc*&#x200B;的Word文檔中刪除策略。 無保護的Word文檔保存為&#x200B;*unProtectedLoan.doc*。 （請參閱[從Word文檔中刪除策略](/help/forms/developing/protecting-documents-policies.md#removing-policies-from-word-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-creating-an-abstract-policy-using-the-java-api}建立抽象策略
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-modifying-an-abstract-policy-using-the-java-api}修改抽象策略
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-deleting-an-abstract-policy-using-the-java-api}刪除抽象策略
...
## 快速入門（SOAP模式）:Protect使用Java API {#quick-start-soap-mode-protect-a-pdf-in-statement-workflow-for-an-existing-user-using-the-java-api}的現有使用者在陳述式中的PDF工作流程
...
## 快速入門（SOAP模式）:Protect使用Java API {#quick-start-soap-mode-protect-a-pdf-in-statement-workflow-for-a-new-user-using-the-java-api}為新使用者在陳述式中傳送PDF
