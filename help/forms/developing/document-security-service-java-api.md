...
以下Java代碼示例建立一個名為&#x200B;*允許複製*&#x200B;的新策略。 添加策略的策略集名為&#x200B;*全局策略集*。 預設情況下，此策略集存在。 （請參閱[建立策略](/help/forms/developing/protecting-documents-policies.md#creating-policies)。）
...
以下Java代碼示例通過將離線租用期間設定為40天來修改名為&#x200B;*允許複製*&#x200B;的策略。 （請參閱[修改策略](/help/forms/developing/protecting-documents-policies.md#modifying-policies)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-applying-a-policy-to-a-pdf-document-using-the-java-api}將原則套用至PDF檔案

以下Java代碼示例將名為&#x200B;*允許複製*&#x200B;的策略應用到名為&#x200B;*Loan.pdf*&#x200B;的PDF文檔。 添加策略的策略集名為&#x200B;*全局策略集*。 受原則保護的檔案會儲存為名為*PolicyProtectedLoanDoc.pdf的PDF檔案。 *（請參閱[將原則套用至PDF檔案](/help/forms/developing/protecting-documents-policies.md#applying-policies-to-pdf-documents)）。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-removing-a-policy-from-a-pdf-document-using-the-java-api}從PDF檔案移除原則

下列程式碼範例會從名為&#x200B;*PolicyProtectedLoanDoc.pdf*&#x200B;的PDF檔案中移除原則。 無擔保的PDF檔案會儲存為&#x200B;*unProtectedLoan.pdf*。 （請參閱[從PDF檔案移除原則](/help/forms/developing/protecting-documents-policies.md#removing-policies-from-pdf-documents)）。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-revoking-a-document-using-the-java-api}廢止檔案

以下Java代碼示例廢止名為&#x200B;*PolicyProtectedLoanDoc.pdf*&#x200B;的受原則保護檔案。 修訂後的PDF檔案位於以下URL位置`https://'[server]:[port]'/RightsManagement/UpdatedLoan.pdf`。 （請參閱[廢止檔案存取權](/help/forms/developing/protecting-documents-policies.md#revoking-access-to-documents)）。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-inspecting-policy-protected-pdf-documents-using-the-java-api}檢查受原則保護的PDF檔案

以下Java代碼示例檢查名為&#x200B;*PolicyProtectedLoanDoc.pd* f的受原則保護PDF文檔。（請參閱[檢查受原則保護的PDF檔案](/help/forms/developing/protecting-documents-policies.md#inspecting-policy-protected-pdf-documents)）。
...
下列Java程式碼範例會重新啟用對名為&#x200B;*PolicyProtectedLoanDoc.pdf*&#x200B;之已撤銷PDF檔案的存取權。 （請參閱[恢復對已撤銷文檔的訪問](/help/forms/developing/protecting-documents-policies.md#reinstating-access-to-revoked-documents)。）
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-creating-a-text-watermark-using-the-java-api}建立文字浮水印

以下Java代碼示例建立名為&#x200B;*示例文本水印*&#x200B;的新文本水印。 此浮水印包含單一元素。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-modifying-a-text-watermark-using-the-java-api}修改文字浮水印
...
## 快速啟動（SOAP模式）:使用Java API {#quick-start-soap-mode-modifying-a-watermark-using-the-java-api}修改水印

以下Java代碼示例通過將`opacity`屬性的值修改為80來修改名為&#x200B;*Confidential*&#x200B;的水印。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-searching-for-events-using-the-java-api}搜尋事件
...
## 快速入門(SOAP):使用Java API {#quick-start-soap-applying-a-policy-to-a-word-document-using-the-java-api}將原則套用至Word檔案

以下Java代碼示例將名為&#x200B;*允許複製*&#x200B;的策略應用到名為&#x200B;*Loan.doc*&#x200B;的Word文檔。 添加策略的策略集名為&#x200B;*全局策略集*。 受原則保護的檔案會儲存為名為*PolicyProtectedLoanDoc.doc的DOC檔案。 *（請參閱[將原則套用至PDF檔案](/help/forms/developing/protecting-documents-policies.md#applying-policies-to-pdf-documents)）。
...
## 快速入門（SOAP模式）:使用Java API {#quick-start-soap-mode-removing-a-policy-from-a-word-document-using-the-java-api}從Word檔案移除原則

以下代碼示例從名為&#x200B;*PolicyProtectedLoanDoc.doc*&#x200B;的Word文檔中刪除策略。 無擔保的Word檔案會儲存為&#x200B;*unProtectedLoan.doc*。 （請參閱[從Word檔案移除原則](/help/forms/developing/protecting-documents-policies.md#removing-policies-from-word-documents)）。
