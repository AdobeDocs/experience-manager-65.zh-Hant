---
title: 端點登入Java&amp；trade； API QuickStart(SOAP)
description: 瞭解如何使用Java&amp；trade； API新增EJB、SOAP、Watched資料夾、電子郵件端點及遠端端點等端點，以及編輯、移除和擷取端點。
contentOwner: admin
...
[快速入門：使用Java新增EJB端點](endpoint-registry-java-api-quick.md#quickstart-adding-an-ejb-endpoint-using-the-java-api)

[快速入門：使用Java新增SOAP端點](endpoint-registry-java-api-quick.md#quickstart-adding-a-soap-endpoint-using-the-java-api)

[快速入門：使用Java新增Watched資料夾端點](endpoint-registry-java-api-quick.md#quickstart-adding-a-watched-folder-endpoint-using-the-java-api)

[快速入門：使用Java新增電子郵件端點](endpoint-registry-java-api-quick.md#quickstart-adding-an-email-endpoint-using-the-java-api)

[快速入門：使用Java新增遠端端點](endpoint-registry-java-api-quick.md#quickstart-adding-a-remoting-endpoint-using-the-java-api)

[快速入門：使用Java新增TaskManager端點](endpoint-registry-java-api-quick.md#quickstart-adding-a-taskmanager-endpoint-using-the-java-api)

[QuickStart：使用Java修改端點](endpoint-registry-java-api-quick.md#quickstart-modifying-an-endpoint-using-the-java-api)

[QuickStart：使用Java移除端點](endpoint-registry-java-api-quick.md#quickstart-removing-an-endpoint-using-the-java-api)

[快速入門：使用Java擷取端點聯結器資訊](endpoint-registry-java-api-quick.md#quickstart-retrieving-endpoint-connector-information-using-the-java-api)

AEM Forms作業可使用AEM Forms強型別API執行，且連線模式應設定為SOAP。

>[!NOTE]
>
>使用AEM表單進行程式設計的快速入門是以Forms為基礎，如果您使用其他作業系統(例如UNIX®)，請將Windows特定路徑取代為適用作業系統支援的路徑。 同樣地，如果您使用其他J2EE應用程式伺服器，請確定您指定有效的連線屬性。 請參閱[設定連線內容](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties)。
...
下列Java™程式碼範例將EJB端點新增至名為&#x200B;*MyApplication/EncryptDocument*&#x200B;的服務。 （請參閱[新增EJB端點](/help/forms/developing/programmatically-endpoints.md#adding-ejb-endpoints)。）
...
下列Java™程式碼範例將SOAP端點新增至名為&#x200B;*MyApplication/EncryptDocument*&#x200B;的服務。 (請參閱[新增SOAP端點](/help/forms/developing/programmatically-endpoints.md#adding-soap-endpoints)。)
...
下列Java™程式碼範例將Watched資料夾端點新增至名為&#x200B;*MyApplication/EncryptDocument*&#x200B;的服務。 （請參閱[新增Watched資料夾端點](/help/forms/developing/programmatically-endpoints.md#adding-watched-folder-endpoints)。）
...
下列Java™程式碼範例將電子郵件端點新增至名為&#x200B;*MyApplication/EncryptDocumen* t的服務。（請參閱[新增電子郵件端點](/help/forms/developing/programmatically-endpoints.md#adding-email-endpoints)。）

>[!NOTE]
>
>在您的專案中加入EmailEndpointConfigConstants.java檔案，以便編譯和執行下列快速入門。 （請參閱[電子郵件組態值常數檔案](/help/forms/developing/programmatically-endpoints.md#email-configuration-values-constant-file)。）
...
下列Java™程式碼範例將Remoting端點新增至名為&#x200B;*MyApplication/EncryptDocument*&#x200B;的服務。 （請參閱[新增遠端端點](/help/forms/developing/programmatically-endpoints.md#adding-remoting-endpoints)。）
...
下列Java™程式碼範例將TaskManager端點新增至名為&#x200B;*MyApplication/EncryptDocument*&#x200B;的服務。 請注意，類別名稱為&#x200B;*EncryptProcess*。 （請參閱[新增TaskManager端點](/help/forms/developing/programmatically-endpoints.md#adding-taskmanager-endpoints)。）
...
以下Java™程式碼範例會修改Watched資料夾端點。 端點適用於&#x200B;*MyApplication/EncryptDocument*&#x200B;處理序。 觀察資料夾已變更為`C:\NewWatchedFolder`。 （請參閱[修改端點](/help/forms/developing/programmatically-endpoints.md#modifying-endpoints)。）
...
下列Java™程式碼會從名為&#x200B;*MyApplication/EncryptDocument*&#x200B;的服務移除EJB端點。 （請參閱[移除端點](/help/forms/developing/programmatically-endpoints.md#removing-endpoints)。）
...
下列Java™程式碼會擷取Watched資料夾端點的相關資訊。 擷取並顯示有關每個組態值的資訊。 此程式碼清單會指定每個組態值是必要值還是選用值。 此外，還會顯示每個組態值的名稱和值。 （請參閱[擷取端點聯結器資訊](/help/forms/developing/programmatically-endpoints.md#retrieving-endpoint-connector-information)。）
