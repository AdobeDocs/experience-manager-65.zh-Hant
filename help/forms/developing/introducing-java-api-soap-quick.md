...
[快速入門(SOAP模式)：使用Java™ API](/help/forms/developing/forms-service-api-quick-starts.md#quick-start-soap-mode-passing-documents-to-the-forms-service-using-the-java-api)將檔案傳遞至Forms服務(叫用Forms和檔案管理服務)
...
>[!NOTE]
>
>大部分的Web服務快速入門都是以C#撰寫並使用.NET Framework。 不過，您可以建立使用者端應用程式邏輯，以便能夠在支援SOAP標準的任何開發環境中叫用AEM Forms服務。 (請參閱[使用Web服務叫用AEM Forms](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-web-services)。)
