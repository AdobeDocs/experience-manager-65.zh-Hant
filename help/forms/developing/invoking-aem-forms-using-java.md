...
>[!NOTE]
>
>如果您在使用AEM Forms使用者端程式庫檔案（例如`adobe-livecycle-client.jar`）時遇到問題，請檢查[AEM Forms Hotfix](/help/release-notes/aem-forms-hotfix.md)頁面，檢視Hotfix是否提供該檔案的更新版本。 如果出現提示，請在專案的類別路徑中使用更新的檔案。
