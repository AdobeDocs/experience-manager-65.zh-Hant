...
title: 在用戶端轉換表單
seo-title: 在用戶端轉換表單
description: 使用Acrobat或Adobe Reader的用戶端轉譯功能，最佳化PDF內容的傳送並改善Forms服務處理網路負載的能力
seo-description: 使用Acrobat或Adobe Reader的用戶端轉譯功能，最佳化PDF內容的傳送並改善Forms服務處理網路負載的能力
