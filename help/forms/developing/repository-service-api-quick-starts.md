...
description: 使用AEM Forms資料檔案庫服務可建立資料夾、編寫資源、列出資源、讀取資源、更新資源、搜索資源、建立資源間關係、鎖定資源、管理訪問控制清單和刪除資源。
...
以下快速啟動可用於AEM Forms資料庫服務。

[快速啟動（SOAP模式）:使用Java API建立資料夾](repository-service-api-quick-starts.md#quick-start-soap-mode-creating-a-folder-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API編寫資源](repository-service-api-quick-starts.md#quick-start-soap-mode-writing-a-resource-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API列出資源](repository-service-api-quick-starts.md#quick-start-soap-mode-listing-resources-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API讀取資源](repository-service-api-quick-starts.md#quick-start-soap-mode-reading-a-resource-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API更新資源](repository-service-api-quick-starts.md#quick-start-soap-mode-updating-a-resource-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API搜索資源](repository-service-api-quick-starts.md#quick-start-soap-mode-searching-for-resources-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API建立資源之間的關係](repository-service-api-quick-starts.md#quick-start-soap-mode-creating-relationships-between-resources-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API鎖定資源](repository-service-api-quick-starts.md#quick-start-soap-mode-locking-a-resource-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API管理訪問控制清單](repository-service-api-quick-starts.md#quick-start-soap-mode-managing-access-control-lists-using-the-java-api)

[快速啟動（SOAP模式）:使用Java API刪除資源](repository-service-api-quick-starts.md#quick-start-soap-mode-deleting-a-resource-using-the-java-api)

AEM Forms操作可以使用AEM Forms強類型API執行，連接模式應設定為SOAP

**應用程式/表單應用程式**

大多數AEM Forms儲存庫服務快速啟動與名為 `Applications/FormsApplication,` 如下圖所示。

資料夾FormsFolder是AEM Forms儲存庫中的一個位置。 例如，可以以寫程式方式將此資料夾添加到 `Applications/FormsApplication`。 (請參閱 [快速啟動（SOAP模式）:使用Java API建立資料夾](repository-service-api-quick-starts.md#quick-start-soap-mode-creating-a-folder-using-the-java-api)。)
...
>[!NOTE]
>
>您可以使用Web瀏覽器瀏覽AEM Forms儲存庫。 要瀏覽儲存庫，請在Web瀏覽器中輸入以下URL `https://[server name]:[server port]/repository`。 可以使用Web瀏覽器驗證快速啟動結果。 例如，如果向AEM Forms儲存庫添加內容，則可以在Web瀏覽器中查看內容。

>[!NOTE]
>
>預設情況下，Applications/FormsApplication不存在。 要跟隨快速啟動，請使用Workbench建立此應用程式。 有關使用Workbench建立應用程式的資訊，請參閱 [流程設計入門](https://www.adobe.com/go/learn_aemforms_workbench_65)。

## 快速啟動（SOAP模式）:使用Java API建立資料夾 {#quick-start-soap-mode-creating-a-folder-using-the-java-api}

以下Java代碼示例建立名為 *表單資料夾* 在以下位置 `/Applications/FormsApplication/1.0/`。 (請參閱 [建立資料夾](/help/forms/developing/aem-forms-repository.md#creating-folders)。)
...
## 快速啟動（SOAP模式）:使用Java API編寫資源 {#quick-start-soap-mode-writing-a-resource-using-the-java-api}

以下Java代碼示例寫入名為 *loan.xdp* 的下界。 資源將添加到 `/Applications/FormsApplication/1.0/FormsFolder` 位置。 (請參閱 [編寫資源](/help/forms/developing/aem-forms-repository.md#writing-resources)。)
...
## 快速啟動（SOAP模式）:使用Java API列出資源 {#quick-start-soap-mode-listing-resources-using-the-java-api}

以下Java代碼示例列出了位於 `Applications/FormsApplication/1.0/FormsFolder`。 (請參閱 [列出資源](/help/forms/developing/aem-forms-repository.md#listing-resources)。)
...
## 快速啟動（SOAP模式）:使用Java API讀取資源 {#quick-start-soap-mode-reading-a-resource-using-the-java-api}

以下Java代碼示例讀取名為 *Loan.xdp* 的下界。 XDP檔案位於 `/Applications/FormsApplication/1.0/FormsFolder/`。 (請參閱 [讀取資源](/help/forms/developing/aem-forms-repository.md#reading-resources)。)
...
## 快速啟動（SOAP模式）:使用Java API更新資源 {#quick-start-soap-mode-updating-a-resource-using-the-java-api}

以下Java代碼示例更新 `/Applications/FormsApplication/1.0/FormsFolder` 修改其說明。 (請參閱 [更新資源](/help/forms/developing/aem-forms-repository.md#updating-resources)。)
...
## 快速啟動（SOAP模式）:使用Java API搜索資源 {#quick-start-soap-mode-searching-for-resources-using-the-java-api}

以下Java代碼示例在中搜索Loan.xdp `Applications/FormsApplication/1.0/FormsFolder`。 (請參閱 [搜索資源](/help/forms/developing/aem-forms-repository.md#searching-for-resources)。)
...
## 快速啟動（SOAP模式）:使用Java API建立資源之間的關係 {#quick-start-soap-mode-creating-relationships-between-resources-using-the-java-api}

下面的Java代碼示例在AEM Forms儲存庫中建立兩個資源之間的關係。 (請參閱 [建立資源關係](/help/forms/developing/aem-forms-repository.md#creating-resource-relationships)。)
...
## 快速啟動（SOAP模式）:使用Java API鎖定資源 {#quick-start-soap-mode-locking-a-resource-using-the-java-api}

以下Java代碼示例鎖定/Applications/FormsApplication/1.0/FormsFolder/Loan.xdp。 (請參閱 [鎖定資源](/help/forms/developing/aem-forms-repository.md#locking-resources)。)
...
## 快速啟動（SOAP模式）:使用Java API管理訪問控制清單 {#quick-start-soap-mode-managing-access-control-lists-using-the-java-api}

下面的Java代碼示例在儲存庫中讀取並建立訪問控制清單(ACL)。
...
## 快速啟動（SOAP模式）:使用Java API刪除資源 {#quick-start-soap-mode-deleting-a-resource-using-the-java-api}

以下Java代碼示例從中刪除Loan.xdp `Applications/FormsApplication/1.0/FormsFolder`。 如果此XDP檔案不在此資料夾中，則會引發異常。 (請參閱 [刪除資源](/help/forms/developing/aem-forms-repository.md#deleting-resources)。)
