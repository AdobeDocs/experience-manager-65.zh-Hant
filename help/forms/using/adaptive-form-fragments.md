...
在編輯模式中，您可以從AEM sidekick拖放任何最適化表單元件至片段。 有關最適化表單元件的資訊，請參見[製作最適化表單的簡介](../../forms/using/introduction-forms-authoring.md)。
...
1. 按一下「AEM Forms UI」工具列中的「**選擇**」，然後選取最適化的表單片段。 工具列顯示您可以對所選自適應表單片段執行的下列操作。
