...
description: 不能將這些保留字用作自適應表單中的標識符。
...
# 自適應表單關鍵字 {#adaptive-forms-keywords}

自適應表單關鍵字是預定義的保留標識符，對自適應表單具有特殊意義。 不能在自適應表單中將這些關鍵字用作標識符。 下表列出了所有為自適應表單保留標識符的關鍵字。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>shortDescription（簡短描述）</p> </td>
  ...
  <tr>
   <td><p>實例管理器</p> </td>
   <td><p>完成後消息</p> </td>
   <td><p>是FirstPart</p> </td>
  </tr>
  <tr>
   <td><p>實例索引</p> </td>
   <td><p>完成SuccessScript</p> </td>
   <td><p>當前ActivePart</p> </td>
  </tr>
  <tr>
   <td><p>摘要</p> </td>
   <td><p>完成FailureScript</p> </td>
   <td><p>節名稱</p> </td>
  </tr>
  <tr>
   <td><p>提交密碼</p> </td>
  ...
  <tr>
   <td><p>獲取的FromService</p> </td>
   <td><p>可重複面板ID</p> </td>
   <td><p>getSelectedIndex</p> </td>
  </tr>
  <tr>
   <td><p>可重複的PanelPath</p> </td>
...
除上面列出的關鍵字外，請避免使用與 [自適應表單JavaScript API](https://adobe.com/go/learn_aemforms_javascript_api_63)。
