...
# 管理證書轉換清單{#managing-certificate-revocationlists}
...
1. 在「別名」框中，鍵入CRL的標識符。
1. 按一下「瀏覽」查找CRL，然後按一下「確定」。

## 導出CRL {#export-a-crl}

1. 在管理控制台中，按一下「設定」>「信任儲存管理」>「證書吊銷清單」。
1. 按一下要導出的CRL的別名，然後按一下導出。
1. 按照導出CRL的指示。 CRL以Base64編碼導出。
1. 按一下「確定」。

## 刪除CRL {#delete-a-crl}

1. 在管理控制台中，按一下「設定」>「信任儲存管理」>「證書吊銷清單」。
1. 選中要刪除的CRL的複選框，按一下「刪除」，然後按一下「確定」。
