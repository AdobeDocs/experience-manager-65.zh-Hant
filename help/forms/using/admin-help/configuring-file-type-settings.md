...
可自訂對各種檔案型別的支援。 (請參閱[使用AEM表單程式設計](https://www.adobe.com/go/learn_lc_programming_11)中的[新增對其他原生檔案格式的支援](https://help.adobe.com/zh_TW/AEMForms/6.1/ProgramLC/WS624e3cba99b79e12e69a9941333732bac8-7756.2.html)。)
