...
* 指定預設使用的檔案型別設定(請參閱 [匯入和匯出PDF產生器組態檔](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md))
...
**[!UICONTROL 將指定的樣式轉換為書籤]**：轉換您在中定義的樣式 **[!UICONTROL 包含層級的樣式]** PDF檔案中書籤的欄位。
