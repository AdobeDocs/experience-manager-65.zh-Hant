...
1. 請填妥下列章節中的必要資訊：
   ...
   [Microsoft Visio設定（僅限Windows）](/help/forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-1354428557)
...
**** 可搜尋影像（完全）:確保文字可供搜尋和選取。 此選項會保留原始影像，並在其上放置不可見的文字圖層。 建議用於需要原始影像最高真實度的情況。
