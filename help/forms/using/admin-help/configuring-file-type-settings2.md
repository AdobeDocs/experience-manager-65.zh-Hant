...
這些選項決定了AutoCAD檔案的轉換方式。 有關訪問這些選項的說明，請參閱[建立或編輯檔案類型設定](/help/forms/using/admin-help/configuring-file-type-settings2.md#create-or-edit-file-type-settings)。
...
這些選項決定了如何轉換OpenOffice檔案。 有關訪問這些選項的說明，請參閱[建立或編輯檔案類型設定](/help/forms/using/admin-help/configuring-file-type-settings2.md#create-or-edit-file-type-settings)。
