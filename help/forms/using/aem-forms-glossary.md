...
[自適應表單](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/creating-adaptive-form)

動態、回應式表單，可根據使用者的裝置和輸入調整版面和簡報，提升各種平台的使用者體驗。 包括條件式邏輯、動態資料繫結和規則型行為。

## 自適應表單版本設定

[自適應表單版本設定](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/adaptive-forms-core-components/add-versioning-reviews-comments)
...
[AEM Forms檔案服務6.5](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/use-document-services/overview-aem-document-services)
...
| **組合器服務** | 合併、重新排列、驗證及擴充PDF和XDP檔案。 | [組合器服務檔案](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/use-document-services/assembler-service) |
| **ConvertPDF服務** | 將PDF檔案轉換為PostScript或影像格式，例如PNG、JPEG或TIFF。 | [ConvertPDF服務檔案](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/use-document-services/using-convertpdf-service) |
...
| **DocAssurance服務** | 加密、解密、數位簽署及套用PDF的檔案安全性原則。 | [DocAssurance服務檔案](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/use-document-services/overview-aem-document-services#doc-assurance-service) |
...
[製作執行個體](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[文件片段](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/letters-correspondences/lists)
...
[表單轉譯和提交前端](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
...
[JCR (Java Content Repository)](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr)

在AEM中儲存內容、設定和中繼資料的階層式標準型存放庫，可支援結構化和非結構化資料儲存。

## 字母

[字母](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/letters-correspondences/create-letter#create-a-letter-template)
...
[發佈執行個體](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[草寫簽名](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-components-to-an-adaptive-form/signing-forms-using-scribble)

AEM Forms中的一項功能，可讓使用者使用滑鼠或觸控式裝置，直接在表單上繪製簽名，以電子方式簽署表單。

## AEM Forms中的提交動作

[AEM Forms中的提交動作](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/configuring-submit-actions)
...
[XDP （XML資料包）](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65/content/forms/manage-administer-aem-forms/get-xdp-pdf-documents-aem)
