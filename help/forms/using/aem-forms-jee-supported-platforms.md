...
* 新安裝不支援IBM DB2。 僅AEM 6.5 Forms的現有客戶才支援此功能。
...
<table>
 <tbody>
  ...
  <tr>
   <td>Microsoft Windows Server 2016（64位）（已過時）</td>
   <td>答：支援</td>
   <td>服務包和重要更新</td>
  </tr>
  <tr>
...
* AEM Forms on JEE根據我們的[第三方軟體支援政策](../../forms/using/aem-forms-jee-supported-platforms.md#p-third-party-patch-support-policy-p)支援各種第三方軟體。
...
* 有關已移除或已更新的平台的清單，請參閱[AEM 6.5 Forms新功能摘要](../../forms/using/whats-new.md)文檔。
...
<table>
 <tbody>
  ...
  <tr>
   <td><a href="https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html">Acrobat 2020 classic tracklatest</a> 版本</td>
   <td>XPS，影像格式(BMP、GIF、JPEG、JPG、TIF、TIFF、PNG、JPF、JPX、JP2、J2K、J2C、JPC)、HTML、HTM、DWG、DXF和DWF</td>
  </tr>
  <tr>
   <td><a href="https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html">Acrobat 2017 classic tracklatest</a> 版本（已過時）</td>
   <td>XPS，影像格式(BMP、GIF、JPEG、JPG、TIF、TIFF、PNG、JPF、JPX、JP2、J2K、J2C、JPC)、HTML、HTM、DWG、DXF和DWF</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Microsoft® Office Visio 2016（已廢止）<br /> </td>
   <td>VSD、VSDX</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Microsoft® Publisher 2016（已廢止）<br /> </td>
   <td>PUB</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Microsoft® Project 2016（已廢止）<br /> </td>
   <td>MPP</td>
  </tr>
  <tr>
...
>此外：
>
>* PDF產生器需要32位元版本的[Acrobat 2020傳統追蹤版本20.004.30006](https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html)才能執行轉換。
...
* [JEE部署上單伺服器AEM Forms的系統需求](https://www.adobe.com/go/learn_aemforms_sysreq_single_63)
...
<table>
 <tbody>
  ...
  <tr>
   <td>Microsoft® Windows® 2016伺服器（待定）</td>
   <td>服務包和重要更新</td>
  </tr>
 </tbody>
</table>

* 要安裝的磁碟空間：僅適用於Workbench的1.7 GB，在單一驅動器上為2.7 GB，以完整安裝Workbench、Designer和示常式式集400 MB用於臨時安裝目錄 — 200 MB用於用戶臨時目錄，200 MB用於Windows臨時目錄。 如果所有這些位置都駐留在單個驅動器上，則安裝期間必須有1.5 GB的可用空間。 安裝完成後，將刪除複製到臨時目錄的檔案。
...
| **平台** | **支援的裝置** |
|---|---|
| Apple iOS | 運行iOS 12及更高版本的iPhone、iPad、iPad Air和iPad mini。 |
...
JEE版AEM Forms的協力廠商軟體需求記錄在其各自產品檔案的「系統需求」一節中。 所有檔案皆可從[https://adobe.com/go/learn_aemforms_documentation_65](https://adobe.com/go/learn_aemforms_documentation_65)存取。
...
2021年9月2日發行的AEM Forms 6.5.10.0版將下列平台標示為已過時：
...
>[!NOTE]
>
>標示為[已廢止的平台，在AEM Forms 6.5 Service Pack 15(6.5.15.0)發行](https://helpx.adobe.com/support/programs/eol-matrix.html)之前都不受支援。
