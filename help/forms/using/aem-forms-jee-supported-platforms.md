...
<table>
 <tbody>
  ...
  <tr>
   <td>L:有限支援</td>
   <td>Adobe在符合特定必要條件後，即可提供此設定的完整支援和維護。 並非所有功能都可在設定中使用。 聯絡Adobe企業支援，了解必要條件並提出支援要求。<br /> </td>
  </tr>
 </tbody>
</table>
...
<table>
 <tbody>
  ...
  <tr>
   <td>IBM® J9 Virtual Machine（版本編號2.9、JRE 1.8.0）<br /> </td>
   <td>答：支援</td>
   <td>次要版本和更新</td>
  </tr>
 </tbody>
...
1. JEE上的AEM Forms不支援MySQL的IBM® WebSphere®。
...
<table>
 <tbody>
  ...
  <tr>
   <td>IBM Content Manager伺服器</td>
   <td>8.5 Fix Pack 2</td>
  </tr>
  <tr>
   <td>IBM Content Manager用戶端</td>
   <td>8.5 </td>
  </tr>
  <tr>
...
>[!NOTE]
>
> 標示為 [已棄用，直到AEM Forms 6.5 Service Pack 15(6.5.15.0)版本為止](https://helpx.adobe.com/support/programs/eol-matrix.html).
