...
**修補程式安裝程式准則**：使用修補程式安裝程式進行更新時，必須確認基礎完整安裝程式版本不超過兩個發行版本舊。 例如，在安裝Service Pack 6.5.23.0期間，請確定基礎完整安裝程式版本為6.5.18.0或6.5.12.0。

- **修補程式升級支援**：您可以使用修補程式安裝程式，將舊版Service Pack升級至新版（例如，從6.5.18.0升級至6.5.23.0），只要新版Service Pack支援目標平台（OS、JDK、應用程式伺服器等）即可。
