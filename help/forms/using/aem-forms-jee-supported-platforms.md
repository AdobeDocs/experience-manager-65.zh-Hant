...
Adobe已在JEE上發行包含AEM 6.5.23.0 Forms Service Pack 23 (6.5.23.0)的[完整安裝程式](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=zh-Hant)以及修補程式安裝程式。 完整版安裝程式支援新平台，而修補程式安裝程式僅包含錯誤修正。

如果您正在執行全新安裝或計畫在JEE環境中使用AEM 6.5.23.0 Forms的最新軟體，Adobe建議使用2025年6月6日發行的JEE上的[AEM 6.5.23.0 Forms完整安裝程式](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=zh-Hant)，而非2023年8月31日發行的AEM 6.5.18 Forms安裝程式或2019年4月8日發行的AEM 6.5.12 Forms安裝程式。
...
>[!NOTE]
>
>- 如需支援伺服器平台的例外狀況完整清單，請參閱[支援伺服器平台的例外狀況](#exceptions-to-supported-server-platforms)。
...
- **完整安裝程式的升級支援**：每六個AEM Service Pack版本都會發行完整安裝程式。 例如，已發行包含6.5.12.0和6.5.18.0 SP版本的完整安裝程式。 AEM Forms僅允許從最後兩個完整安裝程式直接升級。 例如，AEM Forms僅能協助您從前兩個完整安裝程式（即6.5.18.0和6.5.12.0）直接升級至版本6.5.23.0。 如果您需要從舊版升級，可以使用多重躍點升級，先移至支援的完整安裝程式版本，然後再移至最新版本。

- **棄用**：每個完整的安裝程式版本都會更新平台支援。 平台矩陣中標示為過時的任何軟體，在後續發行版本或軟體終止支援時，都可從支援的平台中移除。
...
- **修補程式更新准則**：使用修補程式安裝程式進行更新時，必須確認基礎完整安裝程式版本是否超過兩個發行版本舊。 例如，在安裝Service Pack 6.5.23.0期間，請確定基礎完整安裝程式版本為6.5.18.0或6.5.12.0。
...
<tbody>
 ...
 <tr>
  <td>® J9虛擬機器器（版本編號2.9、JRE 1.8.0） IBM® JDK SR6-FP26<br /> </td>
  <td>A：支援</td>
  <td>次要版本和更新</td>
 </tr>
 <tr>
  <td>® JAVA1.8.0_291（版本編號8.0.6.30）<br /> </td>
  <td>A：支援</td>
  <td>次要版本和更新</td>
 </tr>
</tbody>
...
<tbody>
 ...
 <tr>
  <td><p>® SQL Server 2019 （已棄用） </p> </td>
  <td><p>存放庫微核心</p> </td>
  <td><p>支援</p> </td>
 </tr>
 <tr>
  <td><p>® SQL Server 2022 </p> </td>
  <td><p>存放庫微核心</p> </td>
  <td><p>支援</p> </td>
 </tr>
 <tr>
...
- 全新安裝不支援® DB2®。 僅支援現有客戶升級至AEM 6.5 Forms。
...
@@ -242,187 +206,150 @@ Adobe Experience Manager Forms需要Java™虛擬機器器才能執行，
...
<tbody>
 <tr>
  ...
  <tr>
  <td>MySQL</td>
  <td><p>MySQL Connector/J 5.7 （已棄用）</p> </td>
 ...
 <tr>
  <td>® SQL Server<br /> </td>
  <td><p>® SQL Server JDBC驅動程式8.2.2 <br /> </p> <p>sqljdbc8.jar （已棄用） </p> </td>
  <td><p>從®網站下載。</p> </td>
 </tr>
 <tr>
  <td>® SQL Server<br /> </td>
  <td><p>® SQL Server JDBC驅動程式12.10.0 <br /> </p> <p>sqljdbc12.10.0.jar</p> </td>
  <td><p>從®網站下載。</p> </td>
 </tr>
 <tr>
  <td>Oracle</td>
...
<tbody>
 ...
 <tr>
  <td>® WebSphere® Application Server 9.0.0.10 <sup>[1] [4]</sup><br /> </td>
  <td>A：支援</td>
  <td>Service Pack和重要更新</td>
 </tr>
 <tr>
...
<tbody>
 <tr>
  ...
  <tr>
  <td>® Windows Server 2019 （64位元）（已棄用）</td>
  <td>A：支援</td>
  <td>Service Pack和重要更新</td>
 </tr>
    <tr>
  <td>® Windows Server 2022 （64位元）</td>
  <td>A：支援</td>
  <td>Service Pack和重要更新</td>
 </tr>
 <tr>
...
1. [!DNL Microsoft® Windows Server 2019]不支援[!DNL MySQL 5.7]，[!DNL JBoss® EAP 7.1]，[!DNL Microsoft® Windows Server 2019]不支援[!DNL Experience Manager Forms Service Pack 6.5.10.0 and later]的turnkey安裝。 (CQDOC-18312)
...
@@ -449,274 +376,219 @@此外，選擇Adobe AEM的軟體時，請考量下列幾點
...
<tbody>
 ...
 <tr>
  <td>® Active Directory 2016 （已棄用）</td>
  <td>維護版本和修正套件</td>
 </tr>
 <tr>
  <td>® Active Directory 2022</td>
  <td>維護版本和修正套件</td>
 </tr>
 <tr>
  <td><p>® Tivoli Directory Server 6.4</p> </td>
  <td><p>功能套件和暫時修正</p> </td>
 </tr>
</tbody>
</table>
...
>- PDF Generator需要支援的32位元Windows建置版本Adobe Acrobat Pro DC （持續追蹤，最新版本），以進行Acrobat驅動的原生轉換，以及32位元Microsoft® Office Professional Plus，以進行Microsoft® Windows上的Office轉換。 透過功能限制授權(FRL)或您的Acrobat企業部署程式來啟用Adobe；請參閱檔案服務安裝文章中的[安裝Adobe Acrobat Pro DC](install-configure-document-services.md#install-adobe-acrobat-pro-dc)。
...
- [JEE部署中單一伺服器AEM Forms的系統需求](https://www.adobe.com/go/learn_aemforms_sysreq_single_65_tw)
- [JEE部署上叢集AEM Forms的系統需求](https://www.adobe.com/go/learn_aemforms_sysreq_cluster_65_tw)
...
<tbody>
 ...
 <tr>
  <td>Adobe Acrobat Pro DC （連續追蹤，最新版本）</td>
  <td>最新版本，如<a href="https://helpx.adobe.com/tw/acrobat/release-note/release-notes-acrobat-reader.html">Acrobat和Reader發行說明</a><br />中所述 </td>
 </tr>
 </tbody>
</table>
...
>[!NOTE]
>
>AEM Forms不支援Adobe Acrobat 2020 （傳統路線）。 請改用Adobe Acrobat Pro DC （連續追蹤，最新版本）。
>
...
<tbody>
 ...
 <tr>
  <td>® Windows® 2019 Server （已棄用）</td>
  <td>Service Pack和重要更新</td>
 </tr>
 <tr>
  <td>® Windows® 2022 Server</td>
  <td>Service Pack和重要更新</td>
 </tr>
</tbody>
</table>
...
| Google Android™ | ™ 5.1及更高版本。 AEM Forms應用程式已通過7英吋和10英吋Samsung Galaxy平板電腦及熱門智慧型手機的認證。 |
| ® Windows | ®執行Microsoft® Windows 10作業系統的Surface裝置、平板電腦、筆記型電腦和桌上型電腦。 |
...
| Adobe Acrobat Pro DC （持續追蹤，最新版本） for PDF Generator和相關檔案服務 | Adobe Acrobat 2020 （傳統路線） | JBoss® Enterprise Application Platform (EAP) 7.4.10 |
...
| -------------- | --------------- | ------------------- |
| MongoDB Enterprise 7.0 | MongoDB Enterprise 5.0 | MongoDB Enterprise 6.0 |
| MYSQL 8.4 | SUSE® Linux® Enterprise Server 12 （64位元） | MYSQL 8.0.27 |
| ® SQL Server 2022 | Centos 7 | ® SQL Server 2019 |
| ® SQL Server JDBC驅動程式12.10.0 | Red Hat® Enterprise Linux® 7 （核心4.x） （64位元） | ® SQL Server JDBC驅動程式8.2 |
| Red Hat® Enterprise Linux® 9 （核心5.x） （64位元） | | Red Hat® Enterprise Linux® 8 （核心4.x） （64位元） |
| 適用於PDF Generator的Adobe Acrobat 2020 （傳統路線）和相關檔案服務 | | ® Office 2019 |
...
| 新增的支援 | 移除的支援 | 已棄用的支援 |
| -------------- | --------------- | ------------------- |
| MongoDB Enterprise 4.4 | Windows Server 2016 （64位元） | ® Windows Server 2019 （64位元） |
| Oracle WebLogic Server 14c | MongoDB Enterprise 4.0 | ® Active Directory 2016 |
| My SQL JDBC聯結器8 | Oracle Database 12c版本2 (12.2.0.1.0) |  |
| Active Directory 2022 | MySQL 5.7.35 |  |
| ® Windows Server 2022 （64位元） | ® SQL Server 2016 |  |
|  | JBoss® EAP 7.1.4 |  |
|  | My SQL JDBC聯結器5.1.44 |  |
|  | ® SQL Server JDBC驅動程式6.2.1.0 |  |
|  | ® SQL Server JDBC驅動程式6.2.2.0 |  |
|  | 適用於SQL Server的® JDBC驅動程式8.x |  |
|  | ® Sharepoint 2016 |  |
|  | ® Office 2016 |  |
|  | ® Office Visio 2016 |  |
|  | ® Publisher 2016 |  |
...
| 新增的支援 | 移除的支援 | 已棄用的支援 |
| -------------- | --------------- | ------------------- |
|  | ® J9虛擬機器器（版本編號2.8、JRE 1.8.0） | MongoDB Enterprise 4.0 |
|  | Oracle Database 12c版本1 | MongoDB Enterprise 4.2 |
|  | Oracle資料庫18c | ® DB2® 11.1 |
|  | Oracle Unified Directory (OUD) 11g發行版本2 | Oracle Database 12c發行版本2 |
|  | ®蓮花多米諾9.0 | MySQL 5.7.35 |
|  | ® FileNet 5.2 | ® SQL Server JDBC驅動程式6.2.1.0 |
|  | Adobe Flash Player | JBoss® Enterprise Application Platform (EAP) 7.1.4 |
|  | | ® Content Manager Server 8.5 Fix Pack 2 |
|  | | ® Content Manager Client 8.5 |
|  | | ® SQL Server 2016 |
|  | | ® Windows Server 2016 |
...
| 新增的支援 | 移除的支援 | 已棄用的支援 |
| -------------- | --------------- | ------------------- |
| 適用於應用程式伺服器JBoss® EAP 7.4的Oracle Java™ SE 11 （64位元） SDK。 | | Adobe Acrobat 2017 |
