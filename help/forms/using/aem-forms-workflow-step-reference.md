...
* **** 參與者選擇器：當在「指派選項」欄位中 **選取「動態對使用者或群組** 」選項時，此選項即可用。 您可以使用ECMAScript或服務來動態選取使用者或群組。 如需詳細資訊，請 [參閱動態指派工作流程和](https://helpx.adobe.com/experience-manager/kb/HowToAssignAWorkflowDynamicallyToParticipants.html)[建立自訂Adobe Experience Manager動態參與者步驟。](https://helpx.adobe.com/experience-manager/using/dynamic-steps.html)
