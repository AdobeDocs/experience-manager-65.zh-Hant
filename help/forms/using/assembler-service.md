...
您可以使用「組合器」服務，將兩個或多個PDF檔案組合成單一PDF檔案或PDFPortfolio。 您也可以將輔助導覽或增強安全性的功能套用至PDF檔案。 以下是一些組合 PDF 文件的方法：
...
使用DDX和Assembler服務呼叫其他LiveC週期服務可簡化您的程式圖。 這甚至可以減少您自訂工作流程所花費的精力。 (另請參閱
