...
1. 轉到AEMWeb控制台 `https://server:host/system/console/configMgr`。
...
您已配置資料源。 接下來，您可以建立表單資料模型，或者如果您已經建立了沒有資料源的表單資料模型，則可以將其與您配置的資料源關聯。 請參閱 [建立表單資料模型](/help/forms/using/create-form-data-models.md) 的雙曲餘切值。
