...
如需表單資料整合與表單資料模型的詳細資訊，請參閱[AEM Forms Data Integration](https://helpx.adobe.com/experience-manager/6-3/forms/using/data-integration.html)。
...
您可以設定不同類型的資料來源以建立表單資料模型。 在本教程中，您將配置已配置並填入示例資料的MySQL資料庫。 如需其他支援資料來源的詳細資訊以及如何設定這些資料來源，請參閱[AEM Forms Data Integration](https://helpx.adobe.com/experience-manager/6-3/forms/using/data-integration.html)。
...
1. 將MySQL資料庫的JDBC驅動程式作為OSGi包安裝：
   ...
   1. 點選&#x200B;**選擇檔案**&#x200B;以瀏覽並選擇MySQL JDBC驅動程式OSGi包。 選擇&#x200B;**啟動Bundle**&#x200B;和&#x200B;**刷新包**，然後按一下&#x200B;**安裝**&#x200B;或&#x200B;**更新**。 確保Oracle Corporation的MySQL JDBC驅動程式處於活動狀態。 已安裝驅動程式。
...
AEM Forms提供直覺式使用者介面，讓您從設定的資料來源建立表單資料模式[l。 ](https://helpx.adobe.com/experience-manager/6-3/forms/using/data-integration.html#main-pars_header_1524967585)您可以在表單資料模型中使用多個資料來源。 在本教程中，您將使用MySQL作為資料源。
...
1. 在AEM作者例項上，導覽至&#x200B;**Forms** > **Data Integrations**。 預設URL為[https://localhost:4502/aem/forms.html/content/dam/formsanddocuments-fdm](https://localhost:4502/aem/forms.html/content/dam/formsanddocuments-fdm)。
...
1. 在數學表達式中，分別選擇&#x200B;**callcharges**&#x200B;和&#x200B;**confcallcharges**&#x200B;作為第一和第二對象。 選擇&#x200B;**plus**&#x200B;作為運算子。 在數學運算式中點選並點選「延伸運算式」****&#x200B;以新增&#x200B;**smscharges**、**internetcharges**、**roamingnational**、**roamingintnl**&#x200B;和&#x200B;**vas&lt;a111/>對象。**
