...
如果您選取「 **[!UICONTROL 使用列印為網頁頻道的主版」選項]** ，您可以選取下列任一種模式來產生網頁頻道：
      ...
      * **[!UICONTROL 手動組織]**: 選取此模式，即可使用「資料來源」標籤中的主版內容，手動選取列印渠道元素並將其新 **[!UICONTROL 增至Web]** 頻道。 如需詳細資訊，請參 [閱選取列印頻道元素以建立網頁頻道內容](#selectprintchannelelements)。
...
* **取消繼承：** [取消目標區域](#cancelinheritance) 內元件的繼承，以進行編輯。
