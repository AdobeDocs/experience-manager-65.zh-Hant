...
1. 在屬性瀏覽器中選擇Ultramarine-Accessible主題，然後點選&#x200B;**[!UICONTROL Save]**&#x200B;圖示。
...
1. 按一下側欄中的&#x200B;**[!UICONTROL 輔助功能]**&#x200B;以選擇所需的輔助功能選項。
...
### 3.提供影像{#provide-text-equivalents-for-images}的等效文字
...
### 4.提供足夠的顏色對比{#provide-sufficient-color-contrast}
...
1. 在預覽模式中開啟最適化表單。
1. 按一下書籤化ANDI工具圖示。 ANDI工具會分析最適化表單並顯示協助工具問題。 如需如何使用工具的詳細資訊，請參閱[ANDI的檔案](https://www.ssa.gov/accessibility/andi/help/howtouse.html)。
1. 檢閱並修正ANDI回報的問題。