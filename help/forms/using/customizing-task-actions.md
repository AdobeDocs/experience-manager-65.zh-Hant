...
title: 自定義任務操作
seo-title: 自定義任務操作
description: 您可以自訂任務動作的外觀、僅使用動作的影像，以及自訂路由動作中使用的影像。
seo-description: 您可以自訂任務動作的外觀、僅使用動作的影像，以及自訂路由動作中使用的影像。
...
>[!NOTE]
>
>為「任務」清單和「任務詳細資訊」操作添加不同的樣式，以顯示不同解析度的影像或影像。 例如，若要變更「鎖定」動作：
