...
1. 點選網站頁面中的內嵌AEM Forms容器元件，然後點選 ![settings_icon](assets/settings_icon.png) 於動作列上。 此 **[!UICONTROL 編輯AEM Forms容器]** 對話方塊開啟。
...
* 在編輯模式中，從網站頁面內點選最適化表單或互動式通訊，然後點選 **[!UICONTROL 在新視窗中編輯]**. 原始表單會以您可以修改的編輯模式開啟。
