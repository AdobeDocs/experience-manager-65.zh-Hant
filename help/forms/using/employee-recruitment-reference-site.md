...
>[!NOTE]
>
>We.Finance和We.Gov參考網站都提供員工招聘使用案例。 逐步瀏覽中使用的範例、影像和說明使用We.Finance參考網站。 不過，您也可以使用We.Gov執行這些使用案例並檢視工件。 若要這麼做，請在上述URL中將&#x200B;**we-finance**&#x200B;取代為&#x200B;**we-gov**。
...
#### 我們為員工招聘貼文面試工作流{#we-finance-employee-recruiting-post-interview-workflow}提供資金
...
We.Finance首頁和職業頁面是AEM Sites頁面。 職業頁面內嵌調適性表單，使用可重複的面板來使用服務擷取工作空缺，並將其列在頁面上。 您可以在`https://[authorHost]:[authorPort]/editor.html/content/forms/af/we-finance/employee/recruitment/jobs.html`查看最適化表單。

### 親自查看{#see-it-yourself}

前往`https://[publishHost]:[publishPort]/content/we-finance/global/en.html`，然後按一下&#x200B;**[!UICONTROL Career]**。 按一下&#x200B;**[!UICONTROL 搜索]**&#x200B;填充作業清單，然後按一下&#x200B;**[!UICONTROL 應用]**&#x200B;以查找作業。 在表單中填寫詳細資料並提交申請。
...
前往`https://[publishHost]:[publishPort]/content/we-finance/global/en/login.html?resource=/aem/inbox.html`並使用jacobs/password作為John Jacobs的使用者名稱／密碼登入。 開啟「候選人配置檔案複查」任務，並列出申請人。

## Gloria審查了申請並批准了面試申請人{#gloria-reviews-the-application-and-approves-the-applicant-for-an-interview}
...
前往`https://[publishHost]:[publishPort]/content/we-finance/global/en/login.html?resource=/aem/inbox.html`，使用jjacobs/password作為John Jacobs的使用者名稱／密碼登入。 開啟「候選人配置檔案複查」任務，並列出申請人。

前往`https://[publishHost]:[publishPort]/content/we-finance/global/en/login.html?resource=/aem/inbox.html`並使用grios/password作為Gloria Rios的使用者名稱／密碼登入。 開啟「候選人配置檔案複查」任務，然後按一下「計畫訪問」。

## John Doe安排訪談{#john-doe-schedules-an-interview}
...
## Sarah Rose收到訪問時間表{#sarah-rose-receives-the-email-with-interview-schedule}的電子郵件
...
## 面試後，招聘經理提名莎拉·羅絲為候選人{#after-the-interviews-the-hiring-manager-shortlists-sarah-rose}
...
![Johndoeinboxjohndoenedmoreinformation](assets/johndoeinbox.png) ![](assets/johndoeneedmoreinformation.png)

John Doe向Sarah Rose索取更多有關其教育與工作經驗的資訊

## Sarah Rose收到一封電子郵件，要求進一步的資訊{#sarah-rose-receives-an-email-requesting-further-information}
...
![additional information1](assets/additionalinformation1.png)

Sarah會按一下電子郵件中的連結，以開啟其他資訊表格

![additional information2](assets/additionalinformation2.png)

Sarah會根據John Doe的要求填入其他資訊，然後按一下「提交」

## John Doe會檢閱選取的候選設定檔，以取得{#john-doe-reviews-the-selected-candidate-profile-for-the-additional-information-provided}提供的其他資訊
...
## Sarah Rose收到並簽署連接信{#sarah-rose-receives-and-signs-the-joining-letter}
...
![sarahrosejoiningletsign2](assets/sarahrosejoininglettersign2.png)
