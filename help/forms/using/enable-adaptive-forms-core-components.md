...
若要在您的AEM 6.5 Forms環境中啟用最適化Forms核心元件，請在您的所有Author和Publish執行個體上設定和部署[AEM Archetype 41或更新版本](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html)專案（啟用表單選項）。
