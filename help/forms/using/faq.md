...
1. 為什麼條碼和簽名欄位不會出現在我的表單中？
   ...
   答案：條碼和簽名欄位與HTML或行動藍本無關。 這些欄位會顯示為非互動區域。 不過，AEM Forms Designer提供新的簽名塗鴉欄位，可供使用，而非簽名欄位。 您也可以新增條碼的[自訂Widget](../../forms/using/custom-widgets.md)並加以整合。
...
1. HTML5表格是否支援浮動欄位？
   ...
   1. 按一下&#x200B;**保存全部**。 現在，使用更新的轉換設定檔，HTML表格會啟用浮動欄位。
