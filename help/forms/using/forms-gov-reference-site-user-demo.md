...
### 持續最適化表單(Aya) {#aya-user-story-continued-adaptive-form}
...
### 返回AEM Inbox(George) {#george-user-story-back-to-aem-inbox}
...
### 電子郵件用戶端通知(Aya) {#aya-user-story-email-client}
...
### 電子郵件用戶端通知(Aya) {#aya-user-story-email-client-updated}
...
1. 然後，Camila選取AEM Forms **We.gov FDM** ，然後編輯 **We.gov Enrollment FDM**。

1. 然後，Camila會選取 **要測試的Contact** > **Read Service** （連絡>讀取服務）。
