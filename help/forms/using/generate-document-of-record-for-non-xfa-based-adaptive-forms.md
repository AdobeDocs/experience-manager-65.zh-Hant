...
* **如果隱藏，則從DoR中排除欄位：** 設定屬性將覆蓋「從記錄文檔中排除」欄位級別屬性的行為（如果不為true）。 如果在提交表單時隱藏欄位，則如果屬性設定為true，則這些欄位將從記錄文檔中排除，前提是未設定「從記錄文檔中排除」屬性。
...
1. 按一下面板並選擇 ![配置](assets/configure-icon.svg)。

1. 展開 **[!UICONTROL 記錄文檔]** 的子菜單。

1. 在 **[!UICONTROL 分頁]** 部分，點擊 ![資料夾](assets/folder-icon.svg) 的 **[!UICONTROL 位置]** 的子菜單。
...
1. 按一下面板以應用第二個母版頁並選擇 ![配置](assets/configure-icon.svg)。
1. 在 **[!UICONTROL 分頁]** 部分，點擊 ![資料夾](assets/folder-icon.svg) 的 **[!UICONTROL 位置]** 的子菜單。
1. 點擊 **[!UICONTROL 第頁]**，選擇第二個母版頁並點擊 **[!UICONTROL 選擇]**。
AEM Forms將第二母版頁應用於面板和所有後續面板，格式為自適應。
1. 在 **[!UICONTROL 分頁]** 部分，點擊 ![資料夾](assets/folder-icon.svg) 的 **[!UICONTROL 之後]** 的子菜單。
