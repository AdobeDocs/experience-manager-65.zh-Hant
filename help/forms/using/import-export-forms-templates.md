...
>[!NOTE]
>
>* 在AEM 6.4 Forms中，crx-repository的結構和路徑已變更。 如果您從舊版匯入資產至AEM 6.4 Forms，而表單對舊版結構有某些相依性，您必須手動匯出相依性。 如需資料庫結構和路徑變更的詳細資訊，請參閱「AEM 6.4中的 [資料庫重組」](/help/sites-deploying/repository-restructuring-in-aem65.md)。
>
...
1. Tap **Export Correspondence Management Assets**.
   ...
   (&quot;Export All Correportence Management Assets&quot;頁面出現，並顯示上次嘗試導出進程和下載上次成功導出軟體包的連結的資訊。
