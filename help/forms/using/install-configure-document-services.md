...
### 安裝Adobe Acrobat Pro DC {#install-adobe-acrobat-pro-dc}

如需PDF Generator支援的Acrobat產品和版本，請參閱AEM Forms on JEE支援平台一文中的[PDF Generator的考量事項](aem-forms-jee-supported-platforms.md#software-support-for-pdf-generator)。 本節中的程式說明&#x200B;**Adobe Acrobat Pro DC**&#x200B;的功能限制授權(FRL)。
...
如需詳細資訊，請參閱受保護模式上的[Adobe檔案](https://helpx.adobe.com/acrobat/kb/protected-mode-troubleshooting-reader.html)。
...
* 確保只安裝[支援的® Office （32位元）和Adobe Acrobat版本](aem-forms-jee-supported-platforms.md#software-support-for-pdf-generator)，並取消開啟對話方塊。
