...
本檔案適用於負責安裝、設定、管理或部署Workbench的管理員或開發人員。 此外也包含設定系統以支援升級版AEM Forms程式所需的資訊。 提供的資訊基於以下假設：閱讀本文檔的任何人都熟悉Microsoft® Windows®作業系統。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p><a href="https://adobe.com/go/learn_aemforms_introduction_65">AEM Forms檔案</a><br /> <br /> </p> </td>
  </tr>
  <tr>
...
請參閱Workbench支援平台的完整清單，網址為 [AEM Forms支援平台](https://adobe.com/go/learn_aemforms_supportedplatforms_65).
...
1. 您的電腦現在安裝了下列項目：
   ...
   * **AEM Forms SDK**:如需使用SDK的詳細資訊，請參閱 <a href="https://www.adobe.com/go/learn_aemforms_programming_65">使用AEM Forms進行程式設計</a>.
...
依預設，無論活動或閒置，Workbench都會在兩小時後逾時。 要編輯超時設定，請參閱 <a href="https://docs.adobe.com/content/help/en/experience-manager-65/forms/administrator-help/configure-user-management/configure-advanced-system-attributes.html">管理控制台說明</a>.
