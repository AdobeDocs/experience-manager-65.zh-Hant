...
![Analytics概觀](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>在兩種情況下 [舊版Analytics](/help/forms/using/configure-analytics-forms-documents.md) 和Launch Analytics功能同時啟用， **Launch Analytics** 會優先。
...
1. 點選欄位並選取 ![規則編輯器](/help/forms/using/assets/edit-rules-icon.svg) 來開啟規則編輯器頁面。
1. 在 [!UICONTROL 當] 區段。
