...
1. 若要檢視已儲存的「流程/任務搜尋」查詢或建立查詢，請按一下 **臨機查詢** 然後按一下 **程式/任務搜尋**.

   ![search_nodes](assets/search_nodes.png)

   此 **我的篩選器** 面板會顯示在樹狀檢視的右側。

   在 **我的篩選器** 面板中，您可以建立新的臨機操作查詢，然後按一下以執行先前儲存的查詢。

   ![my_filters_panel](assets/my_filters_panel.png)

1. 若要執行現有的查詢，只要按一下 **我的篩選器** 面板。
1. 若要建立查詢，請按一下 **新增** (+)。
   ...
   **定義篩選器的方式**
   ...
   1. 若要新增其他篩選器至查詢，請按一下 **新增(+)** 篩選器列的右側。

      若要從查詢中移除篩選器，請按一下 **刪除(-)** 篩選器列的右側。
...
* **儲存**：儲存篩選。 然後您就可以從以下位置檢視及執行篩選器： **我的篩選器** 面板。

### 我的篩選器面板中的選項 {#options-in-my-filters-panel}

使用中的選項 **我的篩選器** 面板至 **新增** ![lc_pr_add_filter](assets/lc_pr_add_filter.png)， **編輯** ![lc_pr_delete_filter](assets/lc_pr_delete_filter.png)，或 **刪除** ![lc_pr_edit_filter](assets/lc_pr_edit_filter.png)隨機查詢。
...
1. 查詢結果會顯示在 **報告** 面板 **程式報告** 視窗。
   ...
   在 **頁面** 文字方塊，輸入頁碼以直接前往該頁面。

1. 「程式搜尋」結果中會顯示下列欄位：

   * **處理序ID**：程式的ID。 此欄位有超連結。 如果按一下此欄位中的程式ID，您將被重新導向至 **[!UICONTROL 程式詳細資料]** 程式面板。
   * **發起人**：啟動流程例項的AEM Forms使用者
   * **建立時間**：程式執行個體開始的日期和時間
   * **完成時間**：程式執行個體完成的日期和時間
   ...
   * **任務ID**：任務的ID。 此欄位有超連結。 如果您按一下此欄位中的任務ID，您將被重新導向至 **[!UICONTROL 任務詳細資訊]** 任務面板。
   * **發起人**：啟動流程例項的AEM Forms使用者
   * **建立時間**：程式執行個體開始的日期和時間
   * **完成時間**：程式執行個體完成的日期和時間
   * **持續時間**：流程例項從開始到完成的持續時間
...
您使用 **程式詳細資料** 面板，以檢視特定流程的詳細資訊。

同樣地，您會使用 **任務詳細資訊** 面板，以檢視特定工作的詳細資訊。
...
1. 按一下 **返回流程/任務搜尋** 返回搜尋結果，系統會從該結果向下鑽研流&#39;b5&#39;7b/作業詳細資訊。

   ![back_to_search](assets/back_to_search.png)

   但是，如果透過輸入特定程式/作業ID找到程式/作業詳細資訊，則按一下「返回程式/作業搜尋」可帶您返回 **程式/任務搜尋**，不會顯示任何搜尋結果。
...
1. 在「處理序/工作識別碼」文字方塊中，輸入處理序/工作識別碼。
   ...
   中的欄位 **程式/任務詳細資訊** 查詢結果是AEM Forms流程/任務的特定欄位。
