...
# 進程報告快速入門{#getting-started-with-process-reporting}
...
1. 導航到&#x200B;**Home** > **Services** > **Applications and Services** >**Service Management**，並開啟&#x200B;**ProcessDataStorageProvider**&#x200B;服務。
...
有關預定義報告的詳細資訊，請參閱[Pre-defined Reporting in Process Reporting](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)。

**隨選查詢：** 此項目包含對程式和任務執行篩選式搜尋的選項。

有關臨機查詢的詳細資訊，請參閱「進程報告中的臨機查詢」](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)。[
