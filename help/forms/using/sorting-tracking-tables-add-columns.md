...
對於工作表中的下列自訂，您需要在原始程式碼中進行語意變更。 請參閱[自訂AEM Forms工作區簡介](/help/forms/using/introduction-customizing-html-workspace.md)，瞭解如何使用Workspace SDK進行語意變更，以及從變更的來源建立縮制的套件。
