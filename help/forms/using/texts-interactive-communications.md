...
* 允許代理程式編輯表單資料模型屬性時，在代理程式UI中 [準備和傳送互動式通訊](/help/forms/using/prepare-send-interactive-communication.md) 使用Agent UI，選取 **[D]** 該屬性的鎖定圖示，並確保其處於解鎖狀態。 屬性的預設狀態為鎖定，代理程式無法在Agent UI中編輯屬性。
