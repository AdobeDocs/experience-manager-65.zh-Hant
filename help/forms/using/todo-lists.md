...
* **表單**：顯示與工作關聯的表單。 表單可以是許多檔案型別，包括PDF、HTML、指南和SWF檔案。 此表單看起來像一般可列印的表單或網頁表單，或引導您透過一系列精靈樣式的面板來收集資訊。
...
1. 在「另存為草稿」對話方塊中，指定工作的唯一名稱，並選取&#x200B;**確定**。
...
*提醒*&#x200B;會通知您需要注意的工作。 提醒會在預定時間發生，然後定期發生，直到您完成相關任務為止。 當您收到提醒時，提醒圖示會出現在工作上。
