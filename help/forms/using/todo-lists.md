...
電子郵件訊息可能包含在AEM Forms工作區中開啟工作的連結、用於工作的表單附件，或透過電子郵件完成工作的動作。 如果表單包含在電子郵件訊息中，如果表單中有完成工作的按鈕，您可以開啟表單並完成工作。 如果完成任務的操作包含在電子郵件消息中，則可以通過按一下電子郵件中的操作或通過回復電子郵件來完成任務，其中鍵入的操作作為電子郵件正文的第一行。
...
如果您被授與其他使用者「待辦事項」清單的存取權，則在您獲得存取權之前，無法檢視使用者「待辦事項」清單中存在的任何工作。 您只能檢視在您獲得「待辦事項」清單存取權後，進入使用者「待辦事項」清單的工作。
