...
在「一般」標籤中，變更下載附件、離線模式、著陸畫面、自動儲存和同步設定。 您可以變更應 [用程式的](../../forms/using/home-screen.md) 「首頁」畫面。
...
* **著陸畫面**:若要設定應用程式的開[始位置](../../forms/using/home-screen.md)（首頁畫面）。
可用選項：
...
* **自動儲存頻率**:若要設定行動應用程式在本機 [儲存表單資料的頻率](../../forms/using/autosave-data-app.md) 。
* **同步頻率**:若要設定您的行動應用程 [式線上上模式下與](../../forms/using/sync-app.md) AEM Forms伺服器同步的頻率。
