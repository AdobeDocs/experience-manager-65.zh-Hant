...
條碼式Forms服務支援掃描的TIFF或PDF檔案所提供的下列&#x200B;**二維(2D)**&#x200B;符號：

* PDF417
* 資料矩陣
* QR碼

此服務也支援掃描的TIFF或PDF檔案所提供的下列&#x200B;**一維**&#x200B;符號：
...
Watched資料夾端點通常用於啟動使用條碼Forms服務的應用程式。 例如，檔案掃描器可以將條碼式表單的TIFF或PDF影像儲存在watched資料夾中。 觀察資料夾端點會將影像傳遞給服務以進行解碼。
...
* 此服務完全支援AcroForms和靜態表單，其中包含使用Adobe Reader或Acrobat儲存的2D條碼。 但若是1D條碼，請將表單平面化，或提供為掃描的PDF或TIFF檔案。
