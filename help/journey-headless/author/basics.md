...
在開始掌握內容片段之前，請您（非常）快速瞭解如何使用....但其實沒有什麼可以取代登入和嘗試使用系統的體驗。
...
您可以選取左上方的Adobe圖示，然後選取小型指南針圖示，以開啟「導覽」面板：

![導覽面板](/help/journey-headless/author/assets/headless-journey-author-navigation-01.png)

>[!NOTE]
>雖然內容片段是AEM **Sites**&#x200B;的功能，但是您可以在&#x200B;**Assets**&#x200B;主控台中找到它們。 這個技術細節不會影響您的操作，但了解它可能會有用。
...
**Assets**&#x200B;主控台有專用的&#x200B;**動作工具列**&#x200B;和&#x200B;**快速動作**，您可以在選取資源（例如資料夾或內容片段）之後使用。

快速動作適用於單一資源，請參閱下列範例中的&#x200B;**Basel**：
...
您可以在Assets主控台的&#x200B;**檔案**&#x200B;區段中建立一系列資料夾，以執行此操作。 選擇&#x200B;**建立**&#x200B;選項 (右上角)，然後選擇&#x200B;**資料夾**：
...
本章節的技術稍微進階一些。 如果您正要開始和嘗試一些事情，其實並不需要它，但當您有許多片段時，它最有用。 所以了解它是件好事 - 即使您還沒有使用它。
...
您可能會得到一個初始資料夾，您可以在其中建立資料夾。 這是因為一些設定細節必須套用 (通常由開發人員或系統管理員執行) 到根資料夾。 您可能對此不感興趣，但必要時可以檢查資料夾&#x200B;**屬性**&#x200B;中&#x200B;**雲端服務**&#x200B;的&#x200B;**組態**：
...
* **相關聯的內容**
  ...
  這個標題相當明顯，因為它是編輯器中的索引標籤。

  內容片段已在多個版本的 AEM 中使用。 最初，這些範本可在編寫頁面時用於「傳統」....，而且仍用於此情境中。 這可能涉及建立資產（例如影像）的關聯，雖然這些資產未內嵌在片段中，但在製作頁面時，作者仍需要使用這些資產。
