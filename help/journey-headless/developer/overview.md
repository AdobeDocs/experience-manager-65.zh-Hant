...
>[!TIP]
>
>若您偏好從事&#x200B;**學習**，且技術上有所傾向，請造訪AEM Headless教學課程，這些教學課程是依API和架構所組織，並可在本檔案結尾的[其他資源區段](#additional-resources)中取得。

## 客群 {#audience}

此歷程專為開發人員人物誌所設計，從開發人員的角度闡述了 AEM Headless 專案的要求、步驟和方法。 此歷程定義了為使專案成功開發人員必須與之互動的其他人物誌，但歷程是以開發人員的角度出發。
