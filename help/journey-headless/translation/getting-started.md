...
description: 了解如何組織無周邊內容以及 AEM 翻譯工具的運作原理。
...
在 AEM Headless 翻譯歷程的上一個文件「[了解無周邊內容以及如何在 AEM 中翻譯](learn-about.md)」中，您已了解 Headless CMS 的基本理論，現在您應該：
...
記下欄位 **屬性名稱** 適用於所有必須翻譯的欄位。 您稍後在歷程中將需要此資訊。 這些 **屬性名稱**&#x200B;需要來通知AEM您的內容哪些欄位必須翻譯。

>[!TIP]
>
>一般而言，內容架構師會為翻譯專家提供 **屬性名稱**&#x200B;翻譯所需的所有欄位的。 這些欄位名稱在歷程的後期需要。 前述步驟是為了讓翻譯專家能夠理解而提供的。
...
雖然建議您查閱文件[設定翻譯連接器](configure-connector.md)來繼續無周邊翻譯歷程的下個部分，以下也有一些其他選擇性資源，在深入探究本文件提到的一些概念，但不是繼續無周邊歷程的必要條件。
