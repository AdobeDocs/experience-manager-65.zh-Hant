...
>[!TIP]
>
>如果您不熟悉如何使用AEM等大型CMS，請考慮檢閱 [基本處理](/help/sites-authoring/basic-handling.md) 檔案，再繼續。 基本處理檔案不屬於歷程，因此，完成時請返回本頁面。
...
>[!TIP]
>
>一般而言，內容架構師會為翻譯專員提供 **屬性名稱**&#x200B;翻譯所需的所有欄位。 在歷程的稍後階段需要這些欄位名稱。 為了了解翻譯專家，提供了前面的步驟。
...
* [AEM基本處理](/help/sites-authoring/basic-handling.md)  — 了解AEM UI的基本知識，讓您舒適地導覽及執行基本工作，例如尋找您的內容。
* [識別要翻譯的內容](/help/sites-administering/tc-rules.md)  — 了解翻譯規則如何識別需要翻譯的內容。
* [配置翻譯整合框架](/help/sites-administering/tc-tic.md)  — 了解如何配置翻譯整合框架以與第三方翻譯服務整合。
* [管理翻譯專案](/help/sites-administering/tc-manage.md)  — 了解如何在AEM中建立和管理機器和人類翻譯專案。
