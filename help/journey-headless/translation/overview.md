...
此歷程中的資訊對所有角色都很有用，但有些資訊可能對特定角色來說是多餘的。 請密切注意[即將到來、涵蓋其他角色的歷程。](/help/journey-documentation/home.md#journeys)
...
| 5 | [翻譯內容](translate-content.md) | 使用翻譯整合和規則來翻譯Headless內容。 |
