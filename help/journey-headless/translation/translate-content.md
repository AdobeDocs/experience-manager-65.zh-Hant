...
在AEM Headless翻譯歷程的上一個檔案[設定翻譯規則](translation-rules.md)中，您已瞭解如何使用AEM的翻譯規則來識別您的翻譯內容。 您現在應該：
...
1. 按一下「**建立** > **資料夾**」，為您的專案建立資料夾。
   * 這是選擇性的，但有助於組織您的翻譯工作。
1. 在&#x200B;**建立資料夾**&#x200B;視窗中，為資料夾新增&#x200B;**標題**，然後按一下&#x200B;**建立**。
...
* **翻譯工作** — 這張卡片或這些卡片顯示的是實際翻譯工作的總覽，包括狀態、資產數量等。 通常，每種語言都有一個工作，工作名稱後面附加了 ISO-2 語言代碼。
...
若要開始翻譯工作，請返回翻譯專案概觀，然後按一下&#x200B;**翻譯工作**&#x200B;卡片頂端的>形箭號按鈕，並選取&#x200B;**開始**。
...
1. 按一下&#x200B;**翻譯工作**&#x200B;卡片底部的省略符號按鈕。
1. 看到工作未包含任何內容。按一下視窗頂端的&#x200B;**新增**&#x200B;按鈕，然後從下拉式清單中按一下&#x200B;**Assets/頁面**。
...
>[!TIP]
>
>路徑瀏覽器是功能強大的工具，可讓您搜尋、篩選和導覽您的內容。按一下&#x200B;**僅內容/篩選器**&#x200B;按鈕以切換側面板並顯示進階篩選器，例如&#x200B;**修改日期**&#x200B;或&#x200B;**翻譯狀態**。
>
...
[如先前所見，](#using-translation-project)機器翻譯的內容以&#x200B;**已核准**&#x200B;的狀態流回AEM，因為假設使用的是機器翻譯，不需要人為干預。 然而，仍然可以檢閱翻譯後的內容。
...
如果您透過&#x200B;**導覽** > **Assets** > **檔案**&#x200B;瀏覽至此資料夾，您將會看到翻譯的內容。
