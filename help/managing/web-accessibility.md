...
description: Adobe Experience Manager(AEM)和網頁無障礙指引簡介
...
從社會、經濟和法律層面來看，無論目標對象是否有任何不方便或限制，我們都有許多動機必須盡可能方便他們存取網頁內容。因此，使用Adobe Experience Manager(AEM)的網頁無障礙性，是良好網頁設計中日益重要的一環。
...
Adobe Experience Manager與[萬維網聯盟](#world-wide-web-consortium)提供的[准則](#wcag-accessibility-guidelines)合作。
...
* [設定RTF編輯器以製作無障礙](/help/sites-administering/rte-accessible-content.md)
網站指引說明管理員如何設定AEM以製作無障礙內容。

* [建立無障礙](/help/forms/using/creating-accessible-adaptive-forms.md)
適用性表單AdobeExperience Manager(AEM)包含許多增強不同功能使用者適用性表單可用性的功能。此解決方案也協助表單作者建立無障礙的最適化表單。
