...
+ 開發On-Demand Services App {#developing}
   ...
   + [內容服務](developing-content-services.md)
   + [內容傳遞](develop-content-as-a-service.md)
...
+ 開發Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [設定Adobe Target Cloud Service](aem-mobile-configuring-cloud-service.md)
...
+ 管理Adobe PhoneGap Enterprise {#administering-phonegap}
   ...
   + [設定您的Adobe PhoneGap Build Cloud Service](configure-phonegap-build-cloud.md)
   + [將反向連結篩選設定為允許空白](setting-referrer-filter-empty.md)
   + [設定您的Adobe Mobile Services Cloud Service](configure-adobe-mobile-cloud-service.md)
