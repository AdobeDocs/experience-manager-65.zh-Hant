...
description: 從為移動應AEM用建立和管理內容的支援中獲益。 瞭解並瞭解如何編寫、開發和管理On-Demand Services App和Adobe PhoneGap企業。
...
從為移動應AEM用建立和管理內容的支援中獲益。 瞭解並瞭解如何編寫、開發和管理On-Demand Services App和Adobe PhoneGap企業。
