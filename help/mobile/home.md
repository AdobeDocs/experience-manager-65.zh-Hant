...
description: 受益於AEM支援，為行動應用程式建立和管理內容。 取得On-Demand Services App和Adobe PhoneGap Enterprise的簡介，並了解如何編寫、開發及管理。
...
受益於AEM支援，為行動應用程式建立和管理內容。 取得On-Demand Services App和Adobe PhoneGap Enterprise的簡介，並了解如何編寫、開發及管理。
