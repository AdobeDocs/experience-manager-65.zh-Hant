...
* **名稱：**&#x200B;預設值是移除空格字元的Title屬性值。 該名稱在AEM中被用來指代應用程式，例如代表應用程式的存放庫節點。
* **描述：**&#x200B;應用程式的描述。
...
最新AEM應用程式範例套件包含更新版本的Geometrixx應用程式及應用程式範本。 或者，您可以安裝也提供範本的[StarterKit](https://github.com/Adobe-Marketing-Cloud-Apps/aem-phonegap-starter-kit)。
