...
* 在安裝Microsoft 6.5 Forms的電腦上，下載並安裝適用於Visual Studio 2015、2017、2019和2022[的](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170#visual-studio-2015-2017-2019-and-2022)64位元版AEM Visual C++可轉散發套件。
...
1. **[僅適用於Unix]：**&#x200B;預設會選取&#x200B;**啟動組態管理員**&#x200B;核取方塊。 按一下&#x200B;**[!UICONTROL 完成]**&#x200B;立即執行Configuration Manager，或稍後執行&#x200B;**組態管理員**，取消選取&#x200B;**啟動組態管理員**&#x200B;選項，然後再按一下&#x200B;**[!UICONTROL 完成]**。 您可以使用&#x200B;**目錄中的適當指令碼，稍後再啟動**&#x200B;組態管理員`[AEM_forms_root]/configurationManager/bin`。
...
* 使用封裝管理員[的](https://experienceleague.adobe.com/docs/experience-manager-65/administering/contentmanagement/package-manager.html?lang=zh-Hant)HTTP API。 使用`cmd=install&recursive=true`安裝巢狀套件。
  ...
  **驗證安裝**
  ...
  若要瞭解經過認證可搭配此版本使用的平台，請參閱[技術需求](/help/sites-deploying/technical-requirements.md)。
   ...
   1. 產品資訊頁(`/system/console/productinfo`)會在`Adobe Experience Manager (spversion)`已安裝產品[!UICONTROL .]下顯示更新的版本字串<!-- UPDATE FOR EACH NEW RELEASE -->
...
* 安裝AEM Forms **或更新版本的Service Pack之後，如果您收到**&#x200B;服務無法使用錯誤6.5.15.0，[請安裝servlet片段和套件](/help/forms/using/aem-service-pack-installation-solution.md)以修正錯誤。
