...
* 使用封裝管理員[的](https://experienceleague.adobe.com/docs/experience-manager-65/administering/contentmanagement/package-manager.html)HTTP API。 使用`cmd=install&recursive=true`安裝巢狀套件。
