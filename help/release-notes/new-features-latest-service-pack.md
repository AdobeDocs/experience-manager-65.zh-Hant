...
#### 各方面的效能改善(6.5.4.0){#performance-improvements}
...
#### [!DNL Adobe Experience Manager Assets](6.5.2.0){#visual-search}的可視搜索
...
#### 使CDN快取內容(6.5.6.0){#invalidate-cdn-cached-content}失效
...
#### 適用於Dynamic Media的智慧型影像{#smart-imaging}
...
#### Dynamic Media的視訊描述檔智慧型裁切(6.5.3.0){#smart-crop-video}
...
#### 佈局模式(6.5.7.0){#reset-option-layout-mode}中每個元件的「重置選項」的可用性
...
#### 在用戶端(6.5.6.0){#prefill-merge-data-at-client}預填最適化表單
...
#### 透過雙向SSL實作(6.5.6.0){#fdm-integration-rest-apis-two-way-ssl}的伺服器上，與RESTful API整合表單資料模型

[!DNL Experience Manager Forms] 表單資料模型現 [在可與已實作雙向SSL的伺服器上的RESTful API整合](../../help/forms/using/configure-data-sources.md)。

#### 新增Automated forms conversion服務(6.5.6.0){#sign-integration-acroform-afcs}中[!DNL Adobe Sign]文字標籤的支援
...
#### 增強轉譯的最適化表單頁面快取(6.5.6.0){#enhanced-caching-translated-adaptive-forms}
...
#### 協助工具改善(6.5.5.0){#accessibility-improvements}
...
#### X-509以憑證為基礎的驗證，適用於表單資料模型(6.5.5.0){#x509-based-authentication-soap}中以SOAP為基礎的Web服務
...
#### 其他重要改善(6.5.5.0){#other-improvements}
...
#### 在版面模式(6.5.4.0){#multi-column-adaptive-forms}中支援最適化表單和互動式通訊的多欄支援
...
#### Experience Manager收件箱自定義項(6.5.4.0){#aem-inbox}
...
#### HTML5表單(6.5.4.0){#rich-text-support}中的RTF支援
...
#### 共用並請求訪問Experience ManagerForms用戶(6.5.3.0){#share-request-access}的收件箱項
...
#### 配置Experience ManagerForms用戶(6.5.3.0){#configure-out-of-office}的收件箱項的離職設定
...
#### 使用批次API產生多種互動式通訊，以便Experience ManagerForms(6.5.3.0){#generate-multiple-ic}
...
## 自[!DNL Adobe Experience Manager] 6.5 SP7 {#key-releases-since-last-sp}以來的重要版本

2020年11月26日至2021年2月25日，除了Service Pack和Cumulative Fix Pack外，Adobe還發行了以下內容：

* [!DNL Adobe Experience Manager] 作為Cloud Service [2020.11.0](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/2020/release-notes-2020-11-0.html)、 [2020.12.0](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/2020/release-notes-2020-12-0.html)和 [2021.1.0](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=en#release-date)。
