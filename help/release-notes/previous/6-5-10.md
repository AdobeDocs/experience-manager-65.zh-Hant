...
* 您現在可以使用Automated Forms Conversion Service將法文、德文、西班牙文、義大利文和葡萄牙文的PDF forms[轉換為最適化表單](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/extending-the-default-meta-model.html?lang=zh-Hant#language-specific-meta-model)。
