...
* **Camera Raw支援**：有新的[!DNL Camera Raw]套件可用，可支援[!DNL Adobe Camera Raw] v10.4。 檢視[使用 [!DNL Camera Raw]](/help/assets/camera-raw.md)處理影像。
...
* 自訂servlet篩選套裝等修改網頁的連結時，無法轉譯網頁。 (NPR-36857) <!-- Note updated as per CQDOC-19203, April 07, 2022 -->
...
* 如果您正在將您的[!DNL Experience Manager]執行個體從6.5版本升級為6.5.10.0版本，您可以在`error.log`檔案中檢視`RRD4JReporter`例外狀況。 若要解決此問題，請重新啟動執行個體。
