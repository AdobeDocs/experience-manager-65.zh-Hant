...
[!DNL Experience Manager] 6.5.13.0包含自2019年4月6.5版首次發行以來所推出的新功能、客戶要求的重要增強功能，以及效能、穩定性和安全性改善專案。 在[!DNL Experience Manager] 6.5上[安裝此Service Pack](#install)。
...
* 「所有人」在`/content/usergenerated/etc/commerce/smartlists`上有jcr:write。 (NPR-35230)
...
* 當您使用[!DNL Experience Manager]工作流程傳送希伯來文字的電子郵件時，在使用者端收到的電子郵件會包含問號(??) 取代希伯來語言文字(NPR-38296)。
...
* 無法將® Word檔案匯入Forms Designer。 使用者遇到錯誤`Word (version XP or onwards) could not be found on the machine`。 (CQ-4342146)
