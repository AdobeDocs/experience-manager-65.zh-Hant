...
source-git-commit: 082e5deb7616c6ed580d15df5323a8ceef7cca08
workflow-type: tm+mt
...
[!DNL Experience Manager] 6.5.14.0包含自2019年4月6.5版首次發行以來所推出的新功能、客戶要求的重要增強功能、錯誤修正，以及效能、穩定性和安全性改善專案。 在[!DNL Experience Manager] 6.5上[安裝此Service Pack](#install)。<!-- UPDATE FOR EACH NEW RELEASE -->

部分主要功能和改進包括：

* **[AEM Forms Designer中的清單協助工具支援](https://helpx.adobe.com/tw/content/dam/help/en/experience-manager/6-5/forms/pdf/using-designer.pdf)**： AEM Forms Designer現在可讓作者透過協助工具索引標籤，將清單、清單專案和清單標籤角色指派給子表單，以建立可存取的清單結構。 此功能支援簡單、編號、專案符號和巢狀清單，並產生適當的`<L>`、`<LI>`、`<Lbl>`和`<Lbody>`標籤，以提供熒幕閱讀器相容性。 此增強功能可確保表單清單符合PDF/UA協助工具標準，進而改善輔助技術使用者的導覽和內容理解能力。
