...
* 從AEM 6.5移除Adobe Search&amp;Promote的程式碼和相依性，該程式碼和相依性已根據通知[於2022年9月](https://experienceleague.adobe.com/zh-hant/docs/discontinued/using/search-promote)日結束生命週期。 (NPR-41855)
