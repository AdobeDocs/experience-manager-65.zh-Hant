...
#### 無障礙功能 {#sites-accessibility-6522}
...
* 當使用者從AEM Forms Service Pack 17 (6.5.17.0)升級為AEM Forms Service Pack 21 (6.5.21.0)時，修改的最適化表單提交URL路徑無法運作。 (15894)
...
* 當使用者在AEM Forms Service Pack 19 (6.5.19.0)上列印表單時，某些表單在伺服器上無法正確轉譯，導致在列印過程中發生錯誤。 (14734)
...
* 在®WebSphere®Liberty Profile和Semeru Java 8.0上安裝AEM 6.5.21 （先前版本為AEM 6.5.19）後，無法開啟任何頁面。 錯誤記錄檔指出與需要不同套件組合的servlet版本相關的問題。 若要解決此問題，必須還原`org.apache.felix.http.servlet-api-1.2.0_fragment_full.jar`的相依性，因為它與問題有關。 (NPR-42116)
...
* [Experience Manager中包含的OSGi套件組合清單6.5.22.0](/help/release-notes/assets/65220-bundles.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager中包含的內容套件清單6.5.22.0](/help/release-notes/assets/65220-packages.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
