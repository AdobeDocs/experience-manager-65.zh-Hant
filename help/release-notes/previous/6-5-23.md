...
* 在AEM 6.5上的JSON結構描述中，系統會忽略透過`aem:afProperties`指派的自訂`sling:resourceType`。 在轉譯過程中忽略自訂資源類型。 (FORMS-19691)
...
* [Experience Manager 6.5.23.0中包含的OSGi套件組合清單](/help/release-notes/assets/65230-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.23.0中包含的內容套件清單](/help/release-notes/assets/65230-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
