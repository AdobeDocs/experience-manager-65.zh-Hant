...
* [Experience Manager 6.5.23.0中包含的OSGi套件組合清單](/help/release-notes/assets/65230-bundles.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.23.0中包含的內容套件清單](/help/release-notes/assets/65230-packages.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
