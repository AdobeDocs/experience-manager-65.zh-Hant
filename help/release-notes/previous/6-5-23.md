...
* 在AEM Forms6.5.23.0上，(PDFG)PS到PDF和HTML到PDF(WebKit)轉換失敗。 要解決此問題，請從[Adobe Experience Manager Forms修補程式](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/aem-forms-hotfix)&#x200B;(FORMS.-21721)下載並安裝修補程式

* 在AEM Forms6.5.23.0上，(PDFG)影像到PDF轉換失敗。 要解決此問題，請從[Adobe Experience Manager Forms修補程式](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/aem-forms-hotfix)&#x200B;(FORMS.-22029)下載並安裝修補程式
