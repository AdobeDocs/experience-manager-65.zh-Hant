...
* [Experience Manager 6.5.24.0中包含的OSGi套件組合清單](/help/release-notes/assets/65240-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.24.0中包含的內容套件清單](/help/release-notes/assets/65240-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
