...
* 支援自動錶單轉換服務[&#128279;](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=zh-hant)中的Adobe Sign文字標籤。
