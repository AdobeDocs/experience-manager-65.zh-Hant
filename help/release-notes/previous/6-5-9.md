...
>Adobe也向[!DNL Experience Manager]客戶提供[!DNL Azul Zulu] JDK的支援。
>您可以從[Adobe Software Distribution](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html)下載[!DNL Azul Zulu] JDK的相關版本。
...
* 當[!DNL Dynamic Media]選擇性地啟用並由[預設值](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html#troubleshoot-dm-config)停用時，自訂ViewerPresets和CSS不會復寫至[!DNL Dynamic Media] (NPR-36232)。
...
>僅限Experience Manager 6.5.9.0上的Dynamic Media *中的已知視訊播放問題*：
>
