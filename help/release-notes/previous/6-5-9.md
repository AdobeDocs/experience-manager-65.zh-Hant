...
>oracle Java™技術的使用權(由Adobe分送)將於2022年12月底到期。 建議[!DNL Experience Manager]客戶在此日期之前計畫和實作最新[!DNL Azul Zulu] JDK的使用量。 如需[!DNL Oracle Java™]技術與[!DNL Azul Zulu]技術使用方式的詳細資訊，請參閱相關的[常見問題集](https://experienceleague.adobe.com/docs/experience-manager-65/assets/Java_Policy_for_Adobe_Experience_Manager.pdf)。
