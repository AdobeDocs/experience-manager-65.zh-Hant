---
title: 的發行說明 [!DNL Adobe Experience Manager] 6.5.15.0
...
* AEM Forms JEE 6.5.15.0 Service Pack未正確安裝在JBoss Linux環境中。 檢查以下章節，驗證AEM Forms JEE 6.5.15.0 Service Pack的正確安裝 `PatchInstallerProcessing[1-9*].log` 檔案， `[AEM_Forms_JEE_DIR]/patch/AEMForms-6.5.0-0057/xml/RUP_BOM.xml not found! Assuming this component isn't in the installation. Skipping Processing`.此項目表示安裝AEM Forms JEE 6.5.15.0 Service Pack失敗。 若要修正安裝問題，請手動修正AEM Forms JEE 6.5.15.0 Service Pack [添加RUP_BOM.xml檔案](/help/forms/using/linux-jboss-installation-issue-on-sp15.md) 到XML目錄。
