...
* 在最適化表單的指南容器中設定重新導向URL時，內嵌簽署會停止運作。 (FORMS-10493)。 已針對此問題提供Hotfix。 若要下載及安裝Hotfix，請參閱 [](/help/release-notes/aem-forms-hotfix.md)
* 所有記錄檔案(DoR)範本都無法發佈。 只有以英文地區設定為基礎的DoR範本及其相關之Forms為基礎的DoR範本才會發佈。 (FORMS-10535)。 已針對此問題提供Hotfix。 若要下載及安裝Hotfix，請參閱 [](/help/release-notes/aem-forms-hotfix.md)
* AEM 6.5 Forms Service Pack 18中的手寫簽名元件無法使用快顯視窗預覽。 (FORMS-12073)

#### 互動式通訊

* 升級至AEM Service Pack 18後，無法編輯互動式通訊信件。 (FORMS-10578)。 已針對此問題提供Hotfix。 若要下載及安裝Hotfix，請參閱 [](/help/release-notes/aem-forms-hotfix.md)
