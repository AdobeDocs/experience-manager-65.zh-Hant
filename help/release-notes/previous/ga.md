...
Commerce integration framework的改良功能發行週期比AEM 6.4更快。使用Commerce integration framework[從](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/integrations/magento.html?lang=zh-Hant)AEM和Adobe Commerce整合瞭解更多資訊。
