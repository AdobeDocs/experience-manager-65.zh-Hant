...
source-git-commit: 28f8cbca33d8174d937da12d1854783cf75413c1
workflow-type: tm+mt
...
* 在「工具」 > 「Assets」 > 「Dynamic Media Publish設定」 > 「要求屬性」標籤中，輸入`Width(px)`和`Height(px)`在西班牙文、義大利文和葡萄牙文看起來不同。 這些位置彼此不對齊。 (ASSETS-31896)
...
* 從AEM 6.5移除程式碼和AdobeSearch&amp;Promote的相依性，根據通知](https://experienceleague.adobe.com/en/docs/discontinued/using/search-promote)，這些程式碼和相依性已於2022年9月[日結束生命週期。 (NPR-41855)
...
* SITES-17934 - 內容片段 - 大型片段樹有 DoS 保護，因此預覽失敗。請參閱有關預設GraphQL查詢執行器組態選項的[KB文章](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-23945)
...
* 當使用者從AEM 6.5 Forms Service Pack 18 (6.5.18.0)或AEM 6.5 Forms Service Pack 19 (6.5.19.0)更新為AEM 6.5 Forms Service Pack 20 (6.5.20.0)或AEM 6.5 Forms Service Pack 21 (6.5.21.0)時，使用者會遇到JSP編譯錯誤，這會阻止他們開啟或建立調適型表單，也會導致其他AEM介面(例如頁面編輯器、AEM Forms UI、AEMAEM工作流程編輯器和系統概覽UI)發生錯誤。 (FORMS-15256)
...
* [Experience Manager6.5.21.0](/help/release-notes/assets/65210-bundles.txt)中包含的OSGi套件組合清單<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager6.5.21.0](/help/release-notes/assets/65210-packages.txt)中包含的內容套件清單<!-- UPDATE FOR EACH NEW RELEASE -->
