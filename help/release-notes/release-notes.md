...
* 使用者在接收訊息`Dati Richiedente`時，在可攜式應用程式元件(PAC)中遇到標題`path object not tagged.`的背景顏色錯誤(LC-3922912)
...
* **FORMS-23979** HTML-PDF轉換(PDFG)可能會遇到間歇性逾時。 隨後發佈了SP24的Forms附加模組的更新版本，其中包括該修補程式。 如果遇到此問題，請將您的環境更新為[6.5.24.0的](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases#aem-65-forms-releases)最新發佈的Forms載入項。
