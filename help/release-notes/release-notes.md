...
* [XFA型PDF的階層式書籤](https://helpx.adobe.com/tw/content/dam/help/en/experience-manager/6-5/forms/pdf/using-designer.pdf)：輸出服務和AEM Forms Designer現在會在靜態互動和平坦的XFA型PDF中產生結構化的書籤階層。 書籤會依照在文字方塊的「協助工具」屬性中設定的標題層級(H1-H6)顯示，因此H2-H6專案會巢狀內嵌在正確的父項下，而非平行顯示。
...
* **GRANITE-63681**&#x200B;預設系統組態會封鎖必要的關鍵字和regex模式，而導致Form Data Model聯結器無法驗證。 若要解決此問題，請從[連結](/help/release-notes/aem-forms-hotfix.md)下載並安裝Hotfix。
...
* **FORMS-23875**&#x200B;在表單資料模型搜尋中，即使相關實體不存在，UI也會顯示HTML標籤。 若要解決此問題，請從[連結](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/featurepack/bb-expressionmanager-pkg-10.0.48.zip)下載並安裝Hotfix。
