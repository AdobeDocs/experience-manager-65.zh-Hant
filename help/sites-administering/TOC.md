...
+ 整合 {#integration}
   ...
   + [將體驗片段導出到Adobe Target](experience-fragments-target.md)
...
+ 最佳作法 {#bestpractices}
   ...
   + [MSM最佳實踐](https://experienceleague.adobe.com/docs/experience-manager-65/administering/introduction/msm-best-practices.html)
