...
繼續之前，請確定您的憑證可讓您透過下列其中一種方式登入Adobe Analytics：
...
>
>例如，架構已設定為使用&#x200B;*diiweretail*&#x200B;報表套裝，而作者是選取的伺服器執行個體。 當頁面與框架一起發佈時，仍會呼叫Adobe Analytics。 但是，這些呼叫不包含RSID。 只有來自作者執行個體的呼叫包含RSID。
