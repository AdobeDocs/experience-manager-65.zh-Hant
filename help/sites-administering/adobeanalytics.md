...
>[!NOTE]
>
>另請參閱操作說明文章：[使用DTM](https://helpx.adobe.com/experience-manager/using/integrate-digital-marketing-solutions.html)將AEM與Adobe Target和Adobe Analytics整合。

## 更多資訊 {#further-information}

請參閱：

* [擴充Adobe Analytics整合功](/help/sites-developing/extending-analytics.md) 能，以取得有關開發收集使用者資料的元件和自訂Adobe Analytics架構的資訊。
* 知識庫文章[Adobe Analytics整合——疑難排解問題](https://helpx.adobe.com/experience-manager/kb/sitecatalystintegrationtroubleshooting.html)，以取得Adobe Analytics整合疑難排解的相關資訊。
