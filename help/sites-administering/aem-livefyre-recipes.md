...
* **什麼：** [Livefyre.js](https://docs.adobe.com/content/help/en/livefyre/implementation/c-livefyre_js.html) 是核心程式庫，為網站上的應用程式和驗證提供技術支援。 它定義了全球 *window.Livefyre* 物件和單一公用方法， *Livefyre.require*，可載入其他Livefyre JavaScript程式庫，協助內嵌Livefyre應用程式並與協力廠商使用者驗證平台整合。
...
* 若要建立自訂的體驗和資料視覺效果，您可以使用 [Bootstrap和串流API](https://docs.adobe.com/content/help/en/livefyre/implementation/advanced-topics/bootstrap-stream-api.html).
...
* [身分整合](https://docs.adobe.com/content/help/en/livefyre/implementation/identity-integration/t-about-identity-integration.html) 適用於第三方驗證平台
...
若為需要驗證的Livefyre應用程式，請參閱 [身分整合](https://docs.adobe.com/content/help/en/livefyre/implementation/identity-integration/t-about-identity-integration.html) 適用於第三方驗證平台。
...
* **方法：**
   ...
   * 使用建立集合/應用程式 [CollectionMeta代號](https://docs.adobe.com/content/help/en/livefyre/implementation/getting-started/implementation-process/c-collectionmeta-tokent.html).
   * 整合 [評論應用程式](https://docs.adobe.com/content/help/en/livefyre/implementation/app-integrations/comments/c-comments-integration.html) 內嵌程式碼結構移入網站。
...
1. [設定串流並新增規則以組織UGC至Livefyre資產資料庫資料夾](https://docs.adobe.com/content/help/en/livefyre/using/streams/c-streams.html).
...
1. [使用Livefyre Studio的已組織UGC請求權限](https://docs.adobe.com/content/help/en/livefyre/using/rights-requests/c-how-requesting-rights-works.html).
...
* **方法：**
   ...
   * 建立審核 [CollectionMeta代號](https://docs.adobe.com/content/help/en/livefyre/implementation/app-integrations/c-reviews-integration.html) 指定要在「審閱集合」中儲存的元資料。
   * 整合 [評論應用程式](https://docs.adobe.com/content/help/en/livefyre/implementation/app-integrations/c-reviews-integration.html) 使用 *Livefyre.js* 內嵌程式碼結構
