...
1. 在編寫實例中，選擇「 **AEM**> **Tools** > Deployment **** ReplicationAgents **> Replication Agents********** onAuthorLogo，然後點選Default Agent」。
...
如需 [一般指示](/help/sites-developing/externalizer.md) ，請參閱Configure the externalizer。 若是Adobe Campaign整合，請務必在Adobe Campaign主控台可 `https://<host>:<port>/system/console/configMgr/com.day.cq.commons.impl.ExternalizerImpl` 存取的伺服器 `localhost:4503` 上設定發佈伺服器，但不要指向。
