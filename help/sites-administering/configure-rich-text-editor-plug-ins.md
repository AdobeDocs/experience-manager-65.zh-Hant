...
* 以純文字形式貼上剪貼簿內容。 在AEM元件中插入之前，它會從複製的內容中移除所有樣式和格式元素。 使用下列`plaintext`設定。
...
您可以進一步設定paste-as-Microsoft-Word (`paste-wordhtml`)模式，以明確定義從其他程式（例如Microsoft® Word）在AEM中貼上時允許的樣式。
