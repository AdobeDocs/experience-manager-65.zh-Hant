...
# DHTML查看器壽命結束 {#dhtml-viewer-end-of-life}

自2014年1月31日起，DHTML查看器平台正式停止使用。

查看 [Dynamic Media觀眾參考指南](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html) 支援的最新查看器。
