...
通過分析標AEM準API與Adobe Analytics整合需要使用Adobe Developer控制台配置Adobe IMS(Identity Management系統)。
...
從「Adobe Developer項目」控制台，您可以看到所有整合項目的清單：

* [https://developer.adobe.com/console/projects](https://developer.adobe.com/console/projects)

選擇特定項目條目以顯示有關配置的詳細資訊。 這些類別包括：
...
1. 在這裡，你可以 [為Adobe Developer控制台整合項目儲存的詳細資訊](#details-stored-for-the-ims-integration-project):
