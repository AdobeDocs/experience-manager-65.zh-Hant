...
>* [核心元件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html) 現在推薦使用基礎元件。
>


## 即時拷貝源和藍圖配置 {#live-copy-sources-and-blueprint-configurations}

請記住，可以使用 [常規頁面](/help/sites-administering/msm-livecopy.md#creating-a-live-copy-of-a-page) 或 [藍圖配置](/help/sites-administering/msm-livecopy.md#creating-a-live-copy-of-a-site-from-a-blueprint-configuration)。 兩者都是有效的使用案例。
