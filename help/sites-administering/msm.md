...
* `/content/we-retail/language-masters/en`下的內容複製到`/content/we-retail/us/en/`、`/content/we-retail/gb/en`、`/content/we-retail/ca/en`和`/content/we-retail/au/en`節點下。 這些是即時副本。
