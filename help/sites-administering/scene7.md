...
若要檢視是否 **[!UICONTROL 安全預覽]** 啟用，導覽至Experience Manager頁面上的Dynamic Media Classic元件。 選取&#x200B;**[!UICONTROL 編輯]**。資產的URL中會列出安全預覽伺服器。 在Experience Manager中發佈後，檔案參考中的伺服器網域會從預覽URL更新為生產URL。
