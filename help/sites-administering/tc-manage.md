...
1. 選取您要新增之分支的最上層專案，然後按一下或點選核取記號圖示。 您可以選取多個專案。
...
1. 選取您要新增的標籤，然後按一下或點選核取記號圖示。 您可以選取多個專案。
...
若要檢視作業中每個檔案的狀態，請按一下或點選圖磚底部的省略符號。
...
1. 在翻譯工作圖磚上，按一下或點選命令功能表，然後按一下或點選到期日。

   ![chlimage_1-262](assets/chlimage_1-262.png)

1. 在對話方塊中，按一下或點選日曆圖示，然後選取要作為到期日的日期和時間，然後按一下「儲存」。
...
1. 在翻譯工作圖磚上，按一下或點選命令功能表，然後按一下或點選「請求範圍」。

   ![chlimage_1-264](assets/chlimage_1-264.png)

1. 當工作狀態變更為SCOPE_COMPLETED時，在「翻譯工作」方塊上按一下或點選命令功能表，然後按一下或點選「顯示範圍」。
...
1. 在「專案」主控台中，開啟翻譯專案。
1. 在翻譯工作圖磚上，按一下或點選命令功能表，然後按一下或點選「開始」。
...
1. 在「專案」主控台中，開啟翻譯專案。
1. 在「翻譯工作」方塊上，按一下或點選命令功能表，然後按一下或點選「取消」。
1. 在確認取消翻譯的「動作」對話方塊中，按一下或點選「確定」。
