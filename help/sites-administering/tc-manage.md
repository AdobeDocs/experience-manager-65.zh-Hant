...
1. 按一下或點選「建立和翻譯」，然後配置翻譯作業：
   ...
   * 使用「語言」下拉式清單來選取您要翻譯的語言副本。 視需要選擇其他語言。 清單中顯示的語言與您已建立的[語言根對應。](/help/sites-administering/tc-prep.md#creating-a-language-root)
...
「翻譯摘要」表徵圖包含為翻譯項目配置的屬性。 除了一般[項目資訊](/help/sites-authoring/projects.md#project-info)外，「翻譯」頁籤還包含特定於翻譯的屬性：
...
取消翻譯作業以停止翻譯過程並阻止翻譯供應商執行任何進一步的翻譯。 當作業狀態為`Committed For Translation`或`Translation In Progress`時，可以取消作業。
