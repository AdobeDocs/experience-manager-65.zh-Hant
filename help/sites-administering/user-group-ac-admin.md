...
>[!NOTE]
>
>CRX實作 [JSR-283定義的存取控制](https://developer.adobe.com/experience-manager/reference-materials/spec/jcr/2.0/16_Access_Control_Management.html).
>
...
按一下GroupID （可用時）開啟 [群組管理](#group-administration) 代表該群組。
...
1. 定義您的存取控制原則並按一下 **確定** 以儲存。 您的新原則為：
