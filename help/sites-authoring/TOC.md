...
+ 網站和頁面功能 {#siteandpage}
   ...
   + [互動式版面](responsive-layout.md)
   + [內容分析](content-insights.md)
   + [建立可存取的內容（WCAG 2.0符合性）](creating-accessible-content.md)
   + [支架](scaffolding.md)
...
+ 個性化 {#personalization}
   ...
   + [使用ContextHub資料預覽頁面](ch-previewing.md)
   + [使用定位模式製作目標內容](content-targeting-touch.md)
   + [在多個網站中使用目標內容](multisite-support-targeted-content.md)
   + [目標內容的多網站管理結構](technical-multisite-targeted.md)
   + [管理活動](activitylib.md)
   + [管理觀眾](managing-audiences.md)
   + [建立和管理選件](offerlib.md)
   + [瞭解區段](segmentation-overview.md)
