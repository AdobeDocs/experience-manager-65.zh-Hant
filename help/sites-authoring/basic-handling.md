...
<table>
 <tbody>
  ...
  <tr>
   <td>專案</td>
   <td><a href="/help/sites-authoring/touch-ui-managing-projects.md">專案主控台可讓您直接存取您的專案</a>。 專案是虛擬儀表板。 它們可用來建立團隊，然後讓該團隊存取資源、工作流程和工作，讓人們能夠達成共同目標。<br /> </td>
  </tr>
  <tr>
   <td>畫面</td>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>案頭：<br /> Mouseover，然後使用勾號快速動作</li>
