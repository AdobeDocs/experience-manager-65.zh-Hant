...
除非您檢視所有投影片或勾選&#x200B;**不要再顯示此專案**&#x200B;選項，否則概觀會在您下次存取主控台時重新啟動。
...
* 階層連結
  ...
  階層連結會顯示在邊欄中央，且一律顯示目前所選專案的說明，階層連結可讓您在特定主控台內導覽。 在Sites主控台中，您可以導覽網站的各個層級。
...
* [檢視](/help/sites-authoring/basic-handling.md#viewingandselectingyourresourcescardlistcolumn)
  ...
  檢檢視示位於AEM工具列的最右側。 它也會指出目前檢視，其外觀會變更。 例如，在預設的&#x200B;**欄檢視**&#x200B;檢視中，它顯示：
