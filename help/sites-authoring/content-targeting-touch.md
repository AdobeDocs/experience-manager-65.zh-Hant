...
1. 在 **目標定位** engine下拉式功能表，選取您的目標定位引擎。
   ...
   * 如果您選取 **ContextHub AEM**，其餘欄位會變暗且無法使用。 按一下&#x200B;**建立**。
...
1. 若要顯示引導您完成鎖定目標程式的控制項，請按一下 **開始定位**.

   ![chlimage_1-11](assets/chlimage_1-11.png)

   >[!NOTE]
   >
   >若要變更您正在使用的活動，請按一下 **返回**.
...
1. 若要新增體驗，請按一下 **+** **新增體驗鎖定目標** 會顯示在中現有體驗下方 **受眾** 窗格。
...
1. 從資料庫中選取選件，然後按一下勾號圖示。
   ...
   * 按一下 **瀏覽** 以導覽至其他資料夾。 導覽窗格隨即開啟，按一下箭頭可向下展開資料夾。 按一下 **瀏覽** 以關閉導覽窗格。

   ![chlimage_1-24](assets/chlimage_1-24.png)

   * 按一下 **篩選** 依關鍵字或標籤篩選選件。 您可以輸入關鍵字，然後從下拉式選單中選取標籤。 按一下 **篩選** 以關閉篩選窗格。
...
1. 如果您想要進一步控制成功量度的計數方式，請按一下 **進階設定** 以存取這些。
1. 按一下「**儲存**」。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>按一下 <strong>新增欄位</strong> 以設定其他內容引數（與Target框架中可用的相同）。 套用新增至元件的內容引數 <i>僅限</i> 至元件，而非至其他元件，如果您直接將內容引數新增至架構，就會發生這種情況。</td>
  </tr>
  <tr>
   <td><strong>靜態引數</strong></td>
   <td>按一下 <strong>新增欄位</strong> 以設定其他靜態引數（與Target框架中可用的引數相同）。 套用新增至元件的靜態引數 <i>僅限</i> 至元件，而非至其他元件（如果您直接將靜態引數新增至架構，就會發生這種情況）。 靜態引數並非來自內容（內容中樞的使用者端內容）。</td>
  </tr>
 </tbody>
</table>
