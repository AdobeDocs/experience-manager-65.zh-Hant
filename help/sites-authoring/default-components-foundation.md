...
>[!CAUTION]
>
>此基礎元件已過時。 Adobe建議使用 [核心元件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=zh-Hant) 而非。
...
手動或使用選取器指定路徑。 留空將使用目前頁面作為父頁面。
      ...
      * **固定清單的選項**
         ...
         * **頁面**
選取頁面清單。 使用 `+` 以新增更多專案，並按「向上/向下」按鈕以調整順序。
...
>[!CAUTION]
>
>此基礎元件已過時。 Adobe建議使用 [核心元件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html) 而非。
...
[內容片段](/help/sites-authoring/content-fragments.md) 會建立和管理為不受頁面影響的資產。 然後，您就可以在編寫內容頁面時使用這些片段及其變數。
...
>[!CAUTION]
>
>基礎元件已過時。 Adobe建議使用 [核心元件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html) 而非。
