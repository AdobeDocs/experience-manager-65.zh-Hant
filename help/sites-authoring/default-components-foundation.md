...
>
>Adobe建議利用更現代、更可擴展的 [核心元件](https://docs.adobe.com/content/help/zh-Hant/experience-manager-core-components/using/introduction.html) 的子AEM菜單。 這些是 [We.Retail示例內容](/help/sites-developing/we-retail.md) 也可以 [獨立安裝及用於開發](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/get-started/using.html) 由您的管理員進行。
>
...
有些可通過元件瀏覽器立即獲得，其他可通過使用 [設計模式](/help/sites-authoring/default-components-designmode.md) （如果頁面基於靜態模板）或 [編輯模板](/help/sites-authoring/templates.md) （如果頁面基於可編輯模板）。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [影像核心元件](https://docs.adobe.com/content/help/zh-Hant/experience-manager-core-components/using/components/image.translate.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [旋轉木馬核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/carousel.html) 的雙曲餘切值。
...
請注意，無論您選擇哪種方法，您清單中包括的頁面都應該已經有一個與頁面關聯的影像，但是該影像將顯示在旋轉傳送器中。 如果該頁面的「頁面屬性」下沒有給定頁面的影像，則應在開始前將影像與頁面相關聯，否則，旋轉傳送將顯示空白（或大多為空白）頁面。 請參閱 [編輯頁面屬性](/help/sites-authoring/editing-page-properties.md)。
根據您選擇的項目，將出現以下新面板：
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [內容片段核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/content-fragment-component.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [影像核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/image.html) 的雙曲餘切值。
...
此元件提供網格段系統，允許您在 [響應網格](/help/sites-authoring/responsive-layout.md)。 這允許您根據目標設備的寬度來定義不同的內容佈局，包括電話、平板電腦和案頭。

![chlimage_1-93](assets/chlimage_1-93.png)

>[!NOTE]
>
>此元件已與 [HTML模板語言(HTL)](https://docs.adobe.com/content/help/zh-Hant/experience-manager-htl/using/overview.html)。

### 清單 {#list}

>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [列出核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/list.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [快速搜索核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/quick-search.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [導航](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/navigation.html)。 [語言導航](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/language-navigation.html), [Breadcrumb核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/breadcrumb.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [旋轉木馬核心元件](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/carousel.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [文本核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/text.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [影像](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/image.html) 和 [文本核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/text.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [標題核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/list.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>已棄用元件中的Foundation元件。 Adobe建議利用 [核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [窗體容器核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/forms/form-container.html) 的雙曲餘切值。
...
>[!NOTE]
>
>基礎元件窗體元件僅支援使用其他基礎元件窗體元件（按鈕、文本、隱藏等）。 使用 [核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) 不支援基礎元件窗體中的窗體元件（反之亦然）。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [窗體文本核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/forms/form-text.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [表單選項核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/forms/form-options.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [窗體隱藏核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/forms/form-hidden.html) 的雙曲餘切值。
...
>[!CAUTION]
>
>此Foundation元件已棄用。 Adobe建議利用 [表單按鈕核心元件](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/forms/form-button.html) 的雙曲餘切值。
