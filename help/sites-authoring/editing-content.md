...
對於特定元件型別，您可以將資產直接從資產瀏覽器拖放至元件，以更新內容：
...
1. 將段落拖曳到新位置。 AEM會指出可放置段落的位置。 將其拖曳至所需位置。
...
鎖定後，主控台檢視資訊會更新，而編輯鎖定符號時會顯示於工具列中。
...
>[!NOTE]
>
>檔案和影像的變更記錄至少會持續10小時。 然而，在這段時間之後，無法保證變更會迴轉。 您的管理員可以變更十小時的預設時間。
