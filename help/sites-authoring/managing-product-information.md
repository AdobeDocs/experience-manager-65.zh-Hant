...
>[!NOTE]
>
>有關為特定類型的用戶分配用戶角色和工作流的資訊，請參閱[項目用戶角色。](/help/sites-authoring/projects.md#user-roles-in-a-project)

## 探索產品像片拍攝工作流程{#exploring-product-photo-shoot-workflows}

Creative Project提供各種專案範本，以符合不同的專案需求。 **產品像片拍攝專案**&#x200B;範本現已推出。 此範本包含像片拍攝工作流程，可讓您開始並管理產品像片拍攝要求。 它也包含一系列工作，讓您透過適當的審查與核准程式，取得產品的數位影像。
...
1. 在&#x200B;**Projects**&#x200B;控制台中，點選／按一下&#x200B;**Create**，然後從清單中選擇&#x200B;**Create Project**。
...
1. 點選／按一下&#x200B;**Create**。 會出現確認訊息，通知專案已建立。
1. 點選／按一下&#x200B;**Done**&#x200B;以返回至&#x200B;**Projects**&#x200B;主控台。 或者，點選／按一下&#x200B;**Open**&#x200B;以檢視像片專案中的資產。
...
使用「產品像片拍攝（商務整合）」工作流程，將影像資產與AEM中的產品對應。 此工作流程利用「商務整合」將已核准的影像連結至位於&#x200B;*/etc/commerce*&#x200B;的現有產品資料。
...
1. 導覽至&#x200B;**工具** > **工作流程**，然後點選&#x200B;**模型**&#x200B;方塊以開啟&#x200B;**工作流程模型**&#x200B;頁面。
1. 選擇「**產品像片拍攝**」工作流程，然後點選工具列中的「編輯&#x200B;**編輯**」圖示，以編輯模式開啟它。

   ![chlimage_1-138](assets/chlimage_1-138a.png)

1. 在&#x200B;**產品像片拍攝工作流程**&#x200B;頁面中，開啟專案工作。 例如，開啟&#x200B;**上傳鏡頭清單**&#x200B;工作。

   ![chlimage_1-139](assets/chlimage_1-139a.png)

1. 按一下&#x200B;**Task**&#x200B;頁籤以配置以下內容：
...
1. 按一下&#x200B;**確定**&#x200B;保存配置設定。
   ...
   * 移至生產環境
   ...
   執行類似的程式，以在&#x200B;**產品像片拍攝（商務整合）工作流程**&#x200B;中設定工作。

本節說明如何將產品資訊管理與您的創意專案整合。

## 啟動項目工作流{#starting-a-project-workflow}

1. 導覽至「產品像片拍攝」專案，然後點選／按一下「工作流程」卡上的「新增作品」圖示。********
1. 選擇&#x200B;**產品像片拍攝（商務整合）**&#x200B;工作流程卡，以啟動產品像片拍攝（商務整合）工作流程。 如果/etc/commerce下方未提供產品資訊，請選取&#x200B;**產品像片拍攝**&#x200B;工作流程，然後啟動「產品像片拍攝」工作流程。

   ![chlimage_1-140](assets/chlimage_1-140a.png)

1. 點選／按一下&#x200B;**Next**&#x200B;以啟動專案中的工作流程。
1. 在下一頁輸入工作流詳細資訊。

   ![chlimage_1-141](assets/chlimage_1-141a.png)

   按一下&#x200B;**Submit**&#x200B;以開始像片拍攝工作流程。 隨即顯示像片拍攝專案的專案詳細資訊頁面。
...
**建立拍攝清單**&#x200B;工作可讓專案擁有者選擇需要影像的產品。 根據用戶選擇的選項，生成包含基本產品資訊的CSV檔案。

1. 在項目資料夾中，點選／按一下[任務卡](#tracking-project-progress)中的橢圓以查看工作流中的任務項。

   ![chlimage_1-143](assets/chlimage_1-143a.png)

1. 選擇&#x200B;**建立快照清單**&#x200B;任務，然後從工具欄中點選／按一下&#x200B;**開啟**&#x200B;表徵圖。

   ![chlimage_1-144](assets/chlimage_1-144a.png)

1. 查看任務詳細資訊，然後點選／按一下&#x200B;**建立快照清單**&#x200B;按鈕。
...
1. 點選／按一下「新增至Shotlist **」圖示，以建立包含所有此類產品清單的CSV檔案。**&#x200B;訊息會確認已針對選取的產品建立拍攝清單。 按一下&#x200B;**關閉**&#x200B;以完成工作流。
1. 建立快照清單後，將顯示&#x200B;**查看快照清單**&#x200B;連結。 若要新增更多產品至鏡頭清單，請點選／按一下「新增至鏡頭清單」**。**&#x200B;在這種情況下，資料會附加至最初建立的快照清單。
...
1. 新增產品後，點選／按一下「建立快照清單**工作詳細資訊」頁面上的「完成&#x200B;****」圖示，將工作標示為已完成。 您可以新增選用的註解。
   ...
   * 會建立「像片拍攝」檔案夾，儲存攝影師提供的影像。 「像片拍攝」檔案夾包含「拍攝清單」中每個產品項目的子檔案夾。
   ...
   對於「產品像片拍攝」（不含商務整合）工作流程，「上傳像片清單」是第一項工作。 點選／按一下「上傳鏡頭清單」**以上傳** shotlist.csv **檔案。** CSV檔案應包含產品ID。 其他欄位則為選用。 您可使用它們將資產對應至產品。
...
使用上一程式專案卡下方的&#x200B;**檢視鏡頭清單**&#x200B;連結，下載範例CSV檔案。 檢閱範例檔案，瞭解CSV檔案的一般內容。

產品清單或CSV檔案可包含欄位，例如&#x200B;**類別、產品、Id、說明**&#x200B;和&#x200B;**路徑**。 **Id**&#x200B;欄位是必填欄位，並包含產品ID。 其他欄位則為選用。

產品可屬於特定類別。 產品類別可以列在&#x200B;**Category**&#x200B;欄下方的CSV中。 **Product**&#x200B;欄位包含產品名稱。 在&#x200B;**說明**&#x200B;欄位中，輸入攝影師的產品說明或指示。

>[!NOTE]
>
>要上傳的影像名稱應以「**&lt;ProductId>_」**&#x200B;開頭，其中&#x200B;*shotlist.csv*&#x200B;檔案中的&#x200B;**Id**&#x200B;欄位引用產品ID。 例如，對於拍攝清單中具有&#x200B;**Id 397122**&#x200B;的產品，您可以上傳名稱為&#x200B;**397122_highcontrast.jpg**、**397122_lowlight.png**&#x200B;的檔案，依此類推。

1. 在項目資料夾中，點選／按一下[任務卡](#tracking-project-progress)中的橢圓以查看工作流中的任務清單。
1. 選擇&#x200B;**上傳鏡頭清單**&#x200B;任務，然後點選／按一下工具列上的&#x200B;**開啟**&#x200B;圖示。

   ![chlimage_1-150](assets/chlimage_1-150a.png)

1. 檢閱工作詳細資訊，然後點選／按一下「上傳鏡頭清單」按鈕。****

   ![chlimage_1-151](assets/chlimage_1-151a.png)

1. 點選／按一下「上傳鏡頭清單」按鈕，以上傳檔案名稱為shotlist.csv的CSV檔案。 ****&#x200B;工作流程會將此檔案辨識為用來擷取下一工作產品資料的來源。
1. 上傳包含適當格式產品資訊的CSV檔案。 上傳CSV檔案後，**檢視已上傳的資產**&#x200B;連結會顯示在資訊卡下方。
...
如果您是編輯器，則可以上傳在&#x200B;**shotlist.csv**&#x200B;檔案中列出的產品快照，此檔案會在上一項工作中建立或上傳。

要上傳的影像名稱應以&#x200B;**&quot;&lt;productId>_&quot;**&#x200B;開頭，其中&#x200B;**shotlist.csv**&#x200B;檔案中的&#x200B;**Id**&#x200B;欄位引用產品ID。 例如，對於拍攝清單中ID為&#x200B;**397122**&#x200B;的產品，您可以上傳名稱為&#x200B;**397122_highcontrast.jpg**、**397122_lowlight.png**&#x200B;的檔案，依此類推……

您可以直接上傳影像，或上傳包含影像的ZIP檔案。 根據影像的名稱，影像會放在&#x200B;**Photo Shoot**&#x200B;檔案夾中的個別產品檔案夾中。

1. 在項目資料夾下，點選／按一下[任務卡](#tracking-project-progress)中的橢圓以查看工作流中的任務項。
1. 選擇&#x200B;**上傳像片拍攝**&#x200B;任務，然後點選／按一下工具列中的&#x200B;**開啟**&#x200B;圖示。
...
1. 在項目資料夾下，點選／按一下[任務卡](#tracking-project-progress)中的橢圓以查看工作流中的任務項。
1. 選擇&#x200B;**潤飾像片拍攝**&#x200B;工作，然後點選／按一下工具列中的&#x200B;**開啟**&#x200B;圖示。

   ![chlimage_1-154](assets/chlimage_1-154a.png)

1. 點選／按一下&#x200B;**潤飾像片拍攝**&#x200B;頁面中的&#x200B;**檢視已上傳的資產**&#x200B;連結，以瀏覽已上傳的影像。
...
1. 在項目資料夾下，點選／按一下[任務卡](#tracking-project-progress)中的橢圓以查看工作流中的任務項。
1. 選擇&#x200B;**檢閱與核准**&#x200B;工作，然後點選／按一下工具列中的&#x200B;**開啟**&#x200B;圖示。

   ![chlimage_1-157](assets/chlimage_1-157a.png)

1. 在&#x200B;**檢閱與核准**&#x200B;頁面中，將審閱工作指派給角色，例如「審閱者」，然後點選／按一下**檢閱**以開始檢閱已上傳的產品影像。
...
Creative Project會將已核准的資產與參考的產品建立關聯。 資產中繼資料會更新為產品參考和基本資訊，這些資訊會顯示在「AEM資產中繼資料」區段的資產屬性下方的「產品資料」標籤中。****
...
1. 在項目資料夾下，點選／按一下[任務卡](#tracking-project-progress)中的橢圓以查看工作流中的任務項。
1. 選擇&#x200B;**移至Production**&#x200B;任務，然後點選／按一下工具列中的&#x200B;**Open**&#x200B;圖示。

   ![chlimage_1-160](assets/chlimage_1-160a.png)

1. 若要在將像片拍攝移至生產就緒檔案夾之前檢視已核准的資產，請按一下&#x200B;**移至生產就緒檔案夾中專案縮圖下方的**&#x200B;檢視已核准資產&#x200B;**連結。**
...
1. 在&#x200B;**移至**&#x200B;欄位中輸入生產就緒資料夾的路徑。
   ...
   點選／按一下「移至Production **」。**&#x200B;關閉確認訊息。資產會移至上述路徑，並根據資料夾階層，為每個產品的已核准資產自動建立回轉集。

1. 點選／按一下工具列上的&#x200B;**Complete**&#x200B;圖示。 當最後一個步驟標示為完成時，工作流程便會完成。

## 檢視DAM資產中繼資料{#viewing-dam-asset-metadata}

在您核准後，資產會連結至對應的產品。 已核准資產的[屬性頁面](/help/assets/manage-assets.md#editing-properties)現在有額外的&#x200B;**產品資料**（連結產品資訊）標籤。 此標籤會顯示連結資產的產品詳細資訊、SKU編號和其他產品相關的詳細資訊。 點選／按一下&#x200B;**Edit**&#x200B;圖示以更新資產屬性。 產品相關資訊仍為唯讀。
...
1. 按一下／點選AEM標誌，然後導覽至「工具&#x200B;**** > **Workflow** > **Models**」以開啟「工作流程模型」頁面。
1. 選擇&#x200B;**產品像片拍攝（商務整合）**&#x200B;工作流程或&#x200B;**產品像片拍攝**&#x200B;工作流程，並從工具列按一下／點選&#x200B;**編輯**，以編輯模式開啟工作流程。
1. 在側腳中開啟&#x200B;**Projects**&#x200B;任務，並將&#x200B;**建立基於角色的項目任務**&#x200B;步驟拖動到工作流。

   ![chlimage_1-163](assets/chlimage_1-163a.png)

1. 開啟&#x200B;**基於角色的任務**&#x200B;步驟。
1. 在&#x200B;**Task**&#x200B;頁籤中，為將顯示在&#x200B;**Task**&#x200B;清單中的任務提供名稱。 您也可以將任務指派給角色、設定預設優先順序、提供說明，以及指定任務到期的時間。

   ![chlimage_1-164](assets/chlimage_1-164a.png)

1. 在&#x200B;**路由**&#x200B;頁籤中，指定任務的操作。 若要新增多個動作，請點選／按一下「**新增項目**」連結。

   ![chlimage_1-165](assets/chlimage_1-165a.png)

1. 添加選項後，按一下&#x200B;**OK**&#x200B;將更改添加到步驟。

   >[!NOTE]
   點選／按一下&#x200B;**OK**&#x200B;不會儲存工作流程中的變更。 若要儲存工作流程中的變更，請點選／按一下「儲存&#x200B;**」。**

1. 從側腳開啟&#x200B;**Workflow**&#x200B;任務，並添加&#x200B;**Goto**&#x200B;任務。
1. 開啟&#x200B;**Goto**&#x200B;任務，並點選／按一下&#x200B;**Process**&#x200B;頁籤。
...
>[!NOTE]
有關工作流步驟中指令碼的詳細資訊，請參閱[定義OR Split的規則](/help/sites-developing/workflows-models.md)。
...
1. [移至生產任務](#move-to-production-task)完成後，現在會出現一個新的項目所有者接受任務，該任務已分配給所有者。
...
>[!NOTE]
啟動伺服器時，項目任務清單servlet會快取`/libs/cq/core/content/projects/tasktypes`下定義的任務類型和URL之間的映射。 然後，您可以將自訂工作類型置於`/apps/cq/core/content/projects/tasktypes`下，以執行一般覆蓋並新增自訂工作類型。
