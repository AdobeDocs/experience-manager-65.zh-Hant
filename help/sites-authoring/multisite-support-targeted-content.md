...
seo-description: 如果您需要管理目標內容，例如網站間的活動、體驗和優惠，您可以運用AEM針對目標內容的內建多網站支援
...
>[!NOTE]
>
>使用多網站支援來處理目標內容是一項進階功能。 若要使用此功能，您應熟悉[Multi Site Manager](/help/sites-administering/msm.md)和[Adobe Target與AEM的整合](/help/sites-administering/target.md)。
...
網站或即時副本連結，連結至包含該網站或即時副本上必須提供之活動的區域。 依預設，網站或即時副本連結會連結至主版區域，但您也可以連結主版區域以外的其他區域。
...
您可以根據使用案例，以多種方式設定目標內容的多網站支援。 本節將說明在理論上如何搭配一個品牌運作。 此外，在[範例中：定位內容根據地理位置](#example-targeting-content-based-on-geography)，您可以看到在多個網站中定位內容的實際應用程式。
...
>[!NOTE]
>
>如需此功能的詳細資訊，請參閱[如何針對目標內容進行多網站管理](/help/sites-authoring/technical-multisite-targeted.md)。
...
重新整理索引標籤後，加拿大網站會變更為新影像，而我們不會採取任何動作。 因為它和美國有共同的主區域。 在大不列顛和澳大利亞的網站中，影像不會改變。

![chlimage_1-274](assets/chlimage_1-274.png)

行銷人員想要將這些變更推展至歐洲地區，而[則點選或按一下「推廣頁面」，即時版本](/help/sites-administering/msm-livecopy.md)。 ****&#x200B;重新整理索引標籤後，大不列顛網站會有新的影像，因為歐洲區會繼承主區域（在推出後）。
...
1. 在&#x200B;**轉出配置**&#x200B;下拉菜單中，選擇適當的配置。
   ...
   有關每個選項的說明，請參見[安裝的轉出配置](/help/sites-administering/msm-sync.md#installed-rollout-configurations)。

   如需即時副本的詳細資訊，請參閱[建立和同步即時副本](/help/sites-administering/msm-livecopy.md)。
