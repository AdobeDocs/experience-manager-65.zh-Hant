...
1. 從中選擇區域 **區域參考** 下拉式功能表，然後點選或按一下 **儲存**.
...
1. 導覽至您要分離或暫停繼承的頁面，然後點選或按一下 **目標定位** 在「模式」下拉式功能表中。
...
1. 導覽至您要從主版分離即時副本的頁面，然後點選或按一下 **目標定位** 在「模式」下拉式功能表中。
1. 如果您的頁面連結至即時副本區域，您會看到繼承狀態。 點選或按一下 **開始定位**.
1. 從工 **具列的下拉式選單中選取「分離即時副本** 」。AEM會確認您要分離即時副本。
1. 點選或按一下 **分離** 將即時副本與活動中斷連結。 分離後，有關繼承的下拉式功能表不再顯示。 活動現在是本機活動。
...
1. 導覽至您要還原繼承的頁面，然後點選或按一下 **目標定位** 在「模式」下拉式功能表中。
1. 點選或按一下 **開始定位**.
1. 從工 **具列的下拉式選單選取「繼續即時副本** 」。

   ![chlimage_1-288](assets/chlimage_1-288.png)

1. 點選或按一下 **繼續** 以確認您要繼續即時副本繼承。 如果您恢復繼承，對目前活動所做的任何修改都會遺失。
