...
使用「優惠方案」主控台建立您可以 [用於活動體驗](/help/sites-authoring/content-targeting-touch.md). 在選件主控台中建立選件，可在多個體驗需要相同選件時節省時間：
...
使用「選件」主控台建立品牌時，該品牌也會出現在 [活動主控台](/help/sites-authoring/activitylib.md) 您可以在其中新增和管理品牌的活動。

1. 在導覽主控台中，按一下 **個人化** > **選件**.
...
1. 選取 **選件頁面** 範本，然後按一下 **下一個**.
1. 輸入優惠方案的標題，並選擇性地選取或輸入一或多個標籤以與優惠方案建立關聯，然後按一下 **建立**.
1. 在確認對話方塊中，若要開啟選件進行編輯，請按一下 **開啟頁面**.
