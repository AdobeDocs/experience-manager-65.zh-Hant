...
# 使用Rich Text Editor製作內容{#use-rich-text-editor-to-author-content}
...
只要點選或按一下，選取文字型元件，就會顯示[元件工具列](/help/sites-authoring/editing-content.md#edit-configure-copy-cut-delete-paste)與任何元件一樣。

![screen_shot_2018-03-21at163054](assets/screen_shot_2018-03-21at163054.png)

點選／按一下按鈕或以慢速雙點／點選的方式初始選取元件，將會開啟就地編輯功能，此功能具有其專屬的工具列。 您可以在這裡編輯內容，並變更基本的格式設定。
...
對於文字型元件，從工具列![](do-not-localize/screen_shot_2018-03-21at163236.png)點選全螢幕模式會開啟Rich Text編輯器，並隱藏其餘的頁面內容。
