...
區段定義於 [設定分段](/help/sites-administering/campaign-segmentation.md). 它們可用來控管特定目標對象看到的實際內容。
...
>[!NOTE]
>
>另請參閱 [細分](/help/sites-administering/campaign-segmentation.md) 以進一步瞭解Adobe Experience Manager中的區段。
