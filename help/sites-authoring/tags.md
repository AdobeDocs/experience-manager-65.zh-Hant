...
1. **有條理的標籤** -能夠建立標籤和子標籤，因此可以表達整個分類系統，涵蓋詞語、子詞語及其關係。這允許建立與正式內容階層平行的第二（或第三）內容階層。
1. **可控標籤** -可借由套用權限至標籤和／或名稱空間來控制標籤建立和應用程式。
...
1. **簡單複雜** -只需按一下按鈕，就能建立標籤。之後，可新增標題、說明和無限制的標籤，為標籤提供更多語義。
