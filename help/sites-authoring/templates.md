...
1. 對於這兩種方法，都會顯示縮圖的預覽。
   ...
   如果不滿意，請按一下 **清除** 上傳另一個影像或重新產生縮圖。

1. 當您對縮圖感到滿意時，請按一下 **儲存並關閉**.
...
* **原則與屬性（一般）**
  ...
  *主要*
  ...
  如果設定允許多個組態，請按一下 **新增** 按鈕以新增其他設定。

  ![chlimage_1-141](assets/chlimage_1-141.png)

  若要移除組態，請按一下 **刪除** 按鈕位於設定的右側。
...
* **原則與屬性（配置容器）**
  ...
  *預設元件*
  ...
  按一下 **新增對應** 新增全新的元件和MIME型別對應。

  在清單中選取元件並按一下 **新增型別** 將其他MIME型別新增至已對應的元件。 按一下「 **刪除** 」圖示以移除MIME類型。
