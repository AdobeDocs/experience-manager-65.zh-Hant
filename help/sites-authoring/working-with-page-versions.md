...
* 此 **還原** 上方的選項 [動作工具列](/help/sites-authoring/basic-handling.md#actions-toolbar)
...
1. 選取 **還原**，然後 **還原版本** 從頂端 [動作工具列](/help/sites-authoring/basic-handling.md#actions-toolbar).
...
1. 選取 **還原**，然後 **還原樹狀結構** 從頂端 [動作工具列](/help/sites-authoring/basic-handling.md#actions-toolbar). 隨即顯示樹狀結構的最新版本：
...
1. 選取 **預覽**. 頁面會顯示在新的標籤中。
   ...
   >
   >* 如果預覽發生問題，請檢查 [時間表](/help/sites-authoring/basic-handling.md#timeline) ，以檢視頁面是否已移動。
...
1. 選取 **與目前專案比較**. 此 [頁面差異](/help/sites-authoring/page-diff.md) 開啟以顯示差異。
...
>[!TIP]
>
>[時間扭曲也可以與啟動搭配使用，以預覽未來情況](/help/sites-authoring/launches.md) 執行AEM 6.5.10.0或更新版本時。
...
* **時間扭曲根據已發佈的頁面運作**  — 只有在您先前已發佈頁面時，時間扭曲功能才能完全運作。 如果沒有，時間扭曲會在作者環境中顯示目前頁面。
