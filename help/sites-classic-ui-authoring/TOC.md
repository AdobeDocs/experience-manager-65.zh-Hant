...
audience: end-user
user-guide-title: 《 AEM 6.5經典UI創作使用手冊》
user-guide-description: 本指南介紹在經典用戶界AEM面中創作的概念。
feature: Authoring
role: User
...
# 《 AEM 6.5經典UI創作使用手冊》 {#classic-ui}

+ [經典UI創作指南概述](home.md)
+ 經典UI創作簡介 {#introduction}
   + [作者的第一步](classic-page-author-first-steps.md)
   + [在傳統用戶介面中創作](classicui.md)
   + [使用作者環境](author-env.md)
   + [基本處理](author-env-basic-handling.md)
   + [設定帳戶環境](author-env-user-props.md)
   + [選擇UI](author-env-select-ui.md)
   + [搜尋](author-env-search.md)
   + [您的收件匣](author-env-inbox.md)
   + [控制台的鍵盤快捷鍵](author-env-keyboard-shortcuts.md)
+ 製作 {#authoring}
   + [創作頁面](classic-page-author.md)
   + [創作 — 環境和工具](classic-page-author-env-tools.md)
   ...
   + [編輯頁面時的注釋](classic-page-author-annotations.md)
   + [創作時AEM故障排除](classic-page-author-troubleshooting.md)
   + [建立可存取的內容 (符合 WCAG 2.0)](classic-page-author-accessible-content.md)
   + [為Mobile設備創作頁面](classic-feature-mobile.md)
   + [頁面創作元件](classic-page-author-edit-mode.md)
   + [編輯頁面時的鍵盤快捷鍵](classic-page-author-keyboard-shortcuts.md)
+ 站點和頁面功能 {#siteandpage}
   + [帶內容片段的頁面創作](classic-page-author-content-fragments.md)
   ...
   + [在設計模式下配置元件](classic-page-author-design-mode.md)
   + [將Search&amp;Promote功能添加到頁面](classic-feature-search-promote.md)
...
+ 個性化 {#personalization}
   ...
   + [市場活動管理](classic-personalization-campaigns.md)
   + [著陸頁面](classic-personalization-campaigns-landingpage.md)
   + [目標產品](classic-personalization-campaigns-target-offers.md)
   + [電子郵件營銷](classic-personalization-campaigns-email.md)
   + [跟蹤已跳轉的電子郵件](classic-personalization-campaigns-email-tracking-bounces.md)
   + [預告和策略](classic-personalization-campaigns-teasers-strategy.md)
   + [設定您的活動](classic-personalization-campaigns-setting-up-your.md)
   + [向電子郵件服務提供商發佈電子郵件](classic-personalization-campaigns-email-newsletters.md)
   + [使用市場營銷活動經理](classic-personalization-campaigns-mktg-manager.md)
   + [建立有效的新聞簡報登錄頁](classic-personalization-campaigns-email-landingpage.md)
...
+ Adobe Campaign {#campaign}
   ...
   + [瞄準你的Adobe Campaign](classic-personalization-ac-target.md)
   + [建立Adobe CampaignForms AEM](classic-personalization-ac-forms.md)
+ 在標準UI中創作資產 {#assets}
   + [使用資產](classicui-assets.md)
   + [交付Dynamic Media資產](dynamic-media-assets-delivering.md)
   + [將Dynamic Media資產添加到頁面](dynamic-media-assets-adding-to-page.md)
   + [將Scene7功能添加到頁面](manage-assets-classic-s7.md)
   + [影片](manage-assets-classic-s7-video.md)
   + [使用 Dynamic Media](dynamic-media-assets.md)
   + [資產測試的命名約定](asset-naming-conventions.md)
