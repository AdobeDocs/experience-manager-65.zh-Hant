...
如果您在建立新頁面時只提供頁面 **Title** ,AEM會從此字串衍生頁面 **Name**[ ，並根據AEM和JCR所強加的慣例來驗證名稱。](/help/sites-developing/naming-conventions.md)在這兩個UI中 **標題** 系統將接受包含無效字元的欄位，但衍生的名稱會取代無效字元。 例如：
...
1. 此 **建立頁面** 對話方塊可讓您：
   ...
   * 提供 **名稱**；這可用來產生URI。 如果未指定，則會從標題衍生名稱。
      ...
      * 如果您提供頁面 **名稱** 建立新頁面時，AEM會 [根據慣例驗證名稱](/help/sites-developing/naming-conventions.md) 由AEM和JCR佔用。
...
1. 按一下 **建立** 以建立頁面。 您會返回 **網站** 主控台，您可在此檢視新頁面的專案。
   ...
   >[!NOTE]
   >
   >您也可以在編輯現有頁面時建立頁面。 使用**建立子頁面**來源 **頁面** 索引標籤中的「 」會直接在正在編輯的頁面下方建立新頁面。
...
1. 此 **建立資料夾** 對話方塊將會開啟。 您可在此輸入 **名稱** 和 **標題**：
