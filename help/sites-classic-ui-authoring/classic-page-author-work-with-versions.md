...
1. 使用日期和時間選擇器指定您想要的日期/時間，然後按一下 **前往**.
   ...
   >[!NOTE]
   >
   >您無法編輯頁面的舊版本。 它僅供檢視。 如果您想要還原較舊的版本，您必須使用手動還原 [還原](/help/sites-classic-ui-authoring/classic-page-author-work-with-versions.md#restoring-a-page-version-from-sidekick).
...
* **時間扭曲為唯讀**  — 您無法編輯頁面的舊版本。 它僅供檢視。 如果您想要還原較舊的版本，您必須使用手動還原 [還原](#main-pars-title-1).
