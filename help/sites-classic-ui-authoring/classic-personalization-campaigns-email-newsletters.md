...
>[!NOTE]
>
>您必須先設定服務提供者，才能建立和發佈電子郵件。 另請參閱 [設定ExactTarget](/help/sites-administering/exacttarget.md) 和 [設定Silverpop Engage](/help/sites-administering/silverpop.md) 以取得詳細資訊。
...
1. 輸入標題、名稱，然後選取 **Geometrixx電子報** 範本。
1. 按一下&#x200B;**建立**。
1. 開啟已建立的電子郵件。
...
>[!NOTE]
>
>此 **選項** 只有在已將ExactTarget設定套用至電子郵件時，才會填入下拉式功能表。 另請參閱 [將電子郵件服務組態套用至電子郵件設定](#applying-e-mail-service-configuration-to-e-mail-settings) 以取得詳細資訊。
...
>
>* 需要兩種電子郵件工具： **郵寄地址（必要）** 和 **設定檔中心（必要）**. 將電子郵件發佈至ExactTarget時，這兩個電子郵件工具會預設新增至每封郵件的底部。
>

### 新增文字和個人化工具至您的電子郵件 {#adding-text-and-personalization-tool-to-your-e-mail}

您可以在電子郵件中新增個人化欄位，方法是 **文字與個人化** 頁面元件：
...
1. 新增元件 **文字與個人化** 從sidekick取得。 此元件是Newsletter群組的一部分。 在編輯模式中開啟此元件。

   ![chlimage_1-110](assets/chlimage_1-110a.png)

1. 從下拉式選單中選取必要個人化欄位並按一下，以將必要的個人化欄位新增至文字 **插入**.
1. 按一下 **確定** 完成。
...
1. 建立電子郵件服務設定。
1. 開啟您的電子郵件/電子報。
1. 按一下「 」以開啟電子郵件/電子報設定 **設定** 或按一下 **中的頁面屬性** 副手。
1. 按一下 **新增服務** 在 **Cloud Service** 標籤。 您會看到服務清單。 選取您需要的設定 —  **ExactTarget** 或 **Silverpop**  — 從下拉式清單中。
...
1. 點擊&#x200B;**發佈**。如此將可開啟 **將Newsletter發佈到電子郵件服務提供者** 視窗。
...
此 **更新** 「發佈」對話方塊上的按鈕可讓您更新已發佈至電子郵件服務提供者的電子報。 如果電子報尚未發佈，而且 **更新** 已按下按鈕，a **Newsletter未發佈** 訊息便會顯示。

若要更新已發佈的電子郵件：

1. 開啟先前已發佈至電子郵件服務提供者（您要在變更電子郵件/電子報後重新發佈）的電子郵件/電子報。
1. 點擊&#x200B;**發佈**。此 **將Newsletter發佈到電子郵件服務提供者** 視窗隨即顯示。 按一下&#x200B;**更新**。

   若要檢查電子郵件/電子報是否已在ExactTarget上更新，請按一下 **檢視發佈的電子郵件**. 這會帶您前往ExactTarget中已發佈的電子郵件。
