---
title: 使用工作流程
description: 工AEM作流允許您自動執行頁面或資產上執行的一系列步驟。 例如，在發佈時，編輯人員必須檢閱內容，網站管理員才能啟動頁面。自動執行此示例的工作流將在每個參與者需要執行其所需工作時通知他們。
...
工AEM作流允許您自動執行頁面或資產上執行的一系列步驟。 例如，在發佈時，編輯人員必須檢閱內容，網站管理員才能啟動頁面。自動進行此範例的工作流程會在各項工作必須執行時通知執行該工作的參與者：
