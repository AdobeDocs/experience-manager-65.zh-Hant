...
>[!NOTE]
>
>如果您使用Dynamic Media，如果[將Dynamic Media Classic整合至Adobe Experience Manager](/help/sites-administering/scene7.md)，則無法同時使用可用的自動上傳。 請參閱[啟用Dynamic Media](/help/assets/config-dynamic.md#enabling-dynamic-media)。 Dynamic Media預設為停用。
