...
+ 升級至AEM 6.5 {#upgrading}
   ...
   + [AEM 6.5的向後相容性](backward-compatibility.md)
...
+ 存放庫重組 {#restructuring}
   + [AEM 6.5中的存放庫重新調整架構](repository-restructuring.md)
   + [AEM 6.5中的常見存放庫重新調整架構](all-repository-restructuring-in-aem-6-5.md)
   + [AEM 6.5中的Sites存放庫重新調整](sites-repository-restructuring-in-aem-6-5.md)
   + [AEM 6.5中的資產存放庫重新調整](assets-repository-restructuring-in-aem-6-5.md)
   + [Dynamic Media 6.5中的存放庫重新調整架構](dynamicmedia-repository-restructuring-in-aem-6-5.md)
   + [Forms 6.5中的存放庫重新調整架構](forms-repository-restructuring-in-aem-6-5.md)
   + [AEM 6.5中的電子商務存放庫重新調整](ecommerce-repository-restructuring-in-aem-6-5.md)
   + [AEM Communities 6.5的存放庫重新調整架構](communities-repository-restructuring-in-aem-6-5.md)
+ 最佳作法 {#practices}
