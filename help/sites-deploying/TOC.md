...
user-guide-description: 進一步瞭解 Adobe Experience Manager 6.5 的安裝、部署和架構，包括我們的 Adobe Managed Services 雲端部署。
...
+ 儲存庫重組 {#restructuring}
   ...
   + [AEM 6.5中的Assets Repository Restructing](assets-repository-restructuring-in-aem-6-5.md)
   + [AEM 6.5中的動態媒體資料庫重組](dynamicmedia-repository-restructuring-in-aem-6-5.md)
