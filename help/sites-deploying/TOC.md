...
+ 平台簡AEM介 {#introduction}
   ...
   + [6.5中AEM的儲存元素](storage-elements-in-aem-6.md)
...
+ 部署AEM {#deploying}
   ...
   + [RDBMS在AEM6.5中的支援](rdbms-support-in-aem.md)
...
+ 存放庫重組 {#restructuring}
   ...
   + [6.5版中的通AEM用儲存庫重組](all-repository-restructuring-in-aem-6-5.md)
   + [6.5中的站AEM點儲存庫重組](sites-repository-restructuring-in-aem-6-5.md)
   + [6.5中的資AEM產庫重組](assets-repository-restructuring-in-aem-6-5.md)
   + [Dynamic Media6AEM.5版](dynamicmedia-repository-restructuring-in-aem-6-5.md)
   + [Forms6AEM.5版](forms-repository-restructuring-in-aem-6-5.md)
   + [6.5中的電子商AEM務儲存庫重組](ecommerce-repository-restructuring-in-aem-6-5.md)
   + [6.5中AEM Communities的資料庫重組](communities-repository-restructuring-in-aem-6-5.md)
+ 最佳作法 {#practices}
