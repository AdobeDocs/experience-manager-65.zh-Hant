...
如果您想使用類似 [盧克](https://code.google.com/archive/p/luke/)，必須使用Oak控制台從 `NodeStore` 檔案系統目錄。 有關如何執行此操作的說明，請閱讀 [Lucene文檔](https://jackrabbit.apache.org/oak/docs/query/lucene.html)。
...
>[!NOTE]
>
>而採用整合的Solr搜索方法則允許將索引卸載到Solr伺服器。 如果通過基於爬網程式的方法使用Solr伺服器的更高級功能，則需要進行其他配置工作。
