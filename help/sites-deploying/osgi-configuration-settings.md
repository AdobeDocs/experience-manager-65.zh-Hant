...
>[!NOTE]
>
>OSGi設定差異工具，屬於 [AEM工具](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17488.html?lang=en)，可用來列出預設的OSGi設定。
...
* **追蹤指令碼已啟用** 若要啟用( `true`)或停用( `false`)在頁面上納入追蹤指令碼。 預設值為 `false`。
