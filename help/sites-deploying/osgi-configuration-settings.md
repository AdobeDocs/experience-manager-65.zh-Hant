...
**Apache Sling GET Servlet**&#x200B;設定轉譯的某些層面：
...
* **安裝資料夾名稱regexp**&#x200B;和&#x200B;**安裝資料夾的最大階層深度** — 指定搜尋存放庫資料夾的位置和深度，以尋找要安裝的資源。 當使用萬用字元時（如在。&#42;/install中），會搜尋所有適當的相符專案，例如`/libs/sling/install`和`/libs/cq/core/install`。
