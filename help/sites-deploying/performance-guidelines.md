...
為獲得良好的效能，您應遵循以下提供的設定准則。 如需如何變更設定的說明， [檢視此頁面](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/configuring-performance.html?lang=zh-Hant).
