...
下面詳述的測試案例用於TarMK、MongoMk和TarMK與MongoMk章節的基準章節。 要查看哪個方案用於特定基準測試，請閱讀[技術規格](/help/sites-deploying/performance-guidelines.md#tarmk-performance-benchmark)表中的「方案」欄位。
...
### TarMK最低體系結構准則{#tarmk-minimum-architecture-guidelines}
...
為獲得良好效能，您應遵循下列設定方針。 有關如何更改設定的說明，請[參閱本頁](https://helpx.adobe.com/experience-manager/kb/performance-tuning-tips.html)。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>有關可用參數的詳細資訊，請參閱<a href="https://jackrabbit.apache.org/oak/docs/query/lucene.html">本頁</a>。</td>
  </tr>
  <tr>
   <td>資料儲存= S3資料儲存</td>
...
有關TarMK的詳細資訊，請參閱[部署方案](/help/sites-deploying/recommended-deploys.md#deployment-scenarios)和[Mongo Storage](/help/sites-deploying/storage-elements-in-aem-6.md#mongo-storage)。

### MongoMK最低體系結構准則{#mongomk-minimum-architecture-guidelines}
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>二零四八年</p> <p>35(25)</p> <p>20(10)</p> <p>30(5)</p> <p>10(3)</p> <p>4(4)</p> <p>。/cache,size=2048,binary=0,-compact,-compress</p> </td>
...
有關TarMK與MongoMK的詳細資訊，請參閱[建議部署](/help/sites-deploying/recommended-deploys.md#microkernels-which-one-to-use)。
...
* 提供故障切換機制——有關詳細資訊，請參見[ Cold Standby](/help/sites-deploying/tarmk-cold-standby.md)
...
如需詳細資訊，請參閱[建議部署](/help/sites-deploying/recommended-deploys.md)頁面。
