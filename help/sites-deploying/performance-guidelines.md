...
>[!NOTE]
>
>Adobe建議您選擇使用AdobeManaged Services在Azure或Amazon Web Services (AWS)上部署AEM的選項。 客戶受益於擁有在這些雲端運算環境中部署和操作AEM的經驗和技能的團隊。 請參閱有關AdobeManaged Services[&#128279;](https://business.adobe.com/tw/products/experience-manager/managed-services.html?aemClk=t)的其他檔案。
>
