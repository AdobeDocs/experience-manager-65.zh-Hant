...
>* IIS
>
>在`disp_iis.ini`中，設定：>（如需完整詳細資訊，請參閱[使用® Internet Information Server安裝Dispatcher](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/getting-started/dispatcher-install.html#microsoft-internet-information-server)）
>
