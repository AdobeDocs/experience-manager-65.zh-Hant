...
>[!CAUTION]
>
>區段節點存放區的PID已從舊版AEM 6中的org.apache.jackrabbit.oak.**plugins**.segment.SegmentNodeStoreService變更為AEM 6.3中的org.apache.jackrabbit.oak.segment.SegmentNodeStoreService。 請確定已進行必要的設定調整，以便反映變更。
