...
強制關閉會導致AEM在重新啟動後最多暫停非同步索引30分鐘，且通常需要另外15分鐘才能完成第一個重新索引通過，總共約45分鐘(連結回 [初始偵測](/help/sites-deploying/troubleshooting-oak-indexes.md#initial-detection) 45分鐘的時間範圍)。 如果您懷疑在強制關閉後索引暫停：
