...
* [AEM 6.5中的存放庫重新架構](/help/sites-deploying/repository-restructuring.md)
...
>[!NOTE]
>
>為了改善升級的可靠性，AEM已進行完整的存放庫重組。 如需如何配合新結構的詳細資訊，請參閱[AEM中的存放庫重組。](/help/sites-deploying/repository-restructuring.md)
