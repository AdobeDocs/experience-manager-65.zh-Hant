...
* [GraphQL API](/help/assets/content-fragments/graphql-api-content-fragments.md) 允許您建立存取和傳遞內容片段的要求。
   * 若要使用，[需要在 AEM 中定義和啟用端點](/help/assets/content-fragments/graphql-api-content-fragments.md#enabling-graphql-endpoint)，如果需要，[安裝 GraphiQL 介面](/help/assets/content-fragments/graphql-api-content-fragments.md#installing-graphiql-interface)。
...
* **[GraphQL API](/help/assets/content-fragments/graphql-api-content-fragments.md)** - 詳細說明如何以無周邊方式傳遞內容片段
