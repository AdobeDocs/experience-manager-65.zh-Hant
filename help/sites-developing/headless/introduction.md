...
| [開始使用AEM Headless實作教學課程](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/multi-step/overview.html?lang=zh-Hant) | **如果您偏好實作方法並且熟悉AEM**，本教學課程將直接探討如何建立簡單的Headless專案。 | 教學課程 | 開發人員 | 2 小時 |
