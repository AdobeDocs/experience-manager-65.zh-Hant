...
Adobe Experience Manager (AEM)提供數種API來開發應用程式和擴充AEM。 下列清單提供AEM所支援API的檔案：
...
* [UI測試架構JavaScript API參考資料](https://www.adobe.io/experience-manager/reference-materials/6-5/test-api/index.html)
* [編輯器核心JavaScript API參考資料](https://www.adobe.io/experience-manager/reference-materials/6-5/jsdoc/ui-touch/editor-core/index.html)
...
* 核心元件(JSON)
   ...
   * 請參閱 [開發使用手冊中的元件區段](/help/sites-developing/getting-started.md) 以取得詳細資訊

* **資產**：Assets HTTP API允許對資產執行建立 — 讀取 — 更新 — 刪除(CRUD)作業，包括二進位、中繼資料、轉譯和註解。 另請參閱 [AEM ASSETS HTTP API](/help/assets/mac-api-assets.md)
