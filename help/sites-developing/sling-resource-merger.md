...
>[!CAUTION]
>
>Sling Resource Merger及相關方法只能搭配[Granite](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/granite-ui/api/index.html)使用。 這也表示這僅適用於標準、觸控式UI;尤其是，以此方式定義的覆寫僅適用於元件的觸控式對話方塊。
>
