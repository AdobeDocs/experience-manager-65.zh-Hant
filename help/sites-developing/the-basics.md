...
Dispatcher是Adobe的快取和/或負載平衡工具。 如需進一步資訊，請參閱 [Dispatcher](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/dispatcher.html?lang=zh-Hant).
