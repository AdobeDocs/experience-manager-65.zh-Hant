---
title: AEM核心概念
description: 概述Adobe Experience Manager (AEM)如何建構的核心概念，以及如何在此基礎上進行開發，包括瞭解JCR、Sling、OSGi、Dispatcher、工作流程和MSM。
...
>[!NOTE]
>
>在瞭解Adobe Experience Manager (AEM)的核心概念之前，Adobe建議完成[開發AEM Sites快速入門](/help/sites-developing/getting-started.md)檔案中的WKND教學課程。 內容包括AEM開發流程概述以及核心概念簡介。
...
使用AEM時，生產環境通常包含兩種不同型別的執行個體： [作者和Publish執行個體](/help/sites-deploying/deploy.md#author-and-publish-installs)。
