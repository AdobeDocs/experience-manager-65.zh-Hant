...
「Tough Day 2」是一項應用程式，可讓您強調測試AEM例項的限制。 可透過預設測試套裝立即執行，或依您的測試需求設定。 你可以看 [這個錄音](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-toughday2-stress-testing-benchmarking-tool.html) 以呈現應用程式。
