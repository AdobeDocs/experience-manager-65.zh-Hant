...
您可以在此 [處使用標籤](/help/assets/content-fragments/content-fragments.md) （左側面板）編輯和管理片段：

<!--![](do-not-localize/cf-45-aa.png) ![](do-not-localize/cf-45-a.png) ASSET does not exist-->

* **[包括Markdown](/help/assets/content-fragments/content-fragments-variations.md)**的變[數](/help/assets/content-fragments/content-fragments-markdown.md)
