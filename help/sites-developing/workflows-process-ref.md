...
提AEM供幾個流程步驟，可用於建立工作流模型。 您也可以針對內建步驟未涵蓋的工作新增自訂流程步驟（請參閱[建立工作流程模型](/help/sites-developing/workflows-models.md)）。
...
>
>* 使用Web控制台(`/system/console/configMgr`找到&#x200B;**Adobe花崗岩工作流配置服務**
   >
   >
* 啟用&#x200B;**工作流進程舊模式**
>
